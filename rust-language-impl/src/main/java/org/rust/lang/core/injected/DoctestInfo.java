...
public class DoctestInfo {
    ...
    private DoctestInfo(int docIndent, int fenceIndent, @Nonnull List<Content> contents, @Nonnull String text) {
    ...
    @Nullable
    public static DoctestInfo fromCodeFence(@Nonnull RsDocCodeFence codeFence) {
    ...
    public static boolean hasUnbalancedCodeFencesBefore(@Nonnull RsDocCodeFence context) {
        ...
        for (PsiElement docElement : org.rust.lang.core.psi.ext.impl.RsDocAndAttributeOwnerUtil.docElements((org.rust.lang.core.psi.ext.RsDocAndAttributeOwner) docOwner, true)) {
    ...
    private static abstract class Content {
        static class DocData extends Content {
            ...
            DocData(@Nonnull PsiElement psi) {
                myPsi = psi;
            }
        }
        ...
        static class EmptyLine extends Content {
            ...
            EmptyLine(@Nonnull TextRange range) {
                myRange = range;
            }
        }
    }
