...
public class RustParserUtil extends GeneratedParserUtilBase {
    ...
    private static final Key<consulo.util.collection.Stack<Integer>> FLAG_STACK = Key.create("RustParserUtil.FLAG_STACK");

    private static int getFlags(@Nonnull PsiBuilder b) {
        Integer flags = b.getUserData(FLAGS);
        return flags != null ? flags : DEFAULT_FLAGS;
    }

    private static void setFlags(@Nonnull PsiBuilder b, int value) {
        b.putUserData(FLAGS, value);
    }

    @Nonnull
    private static consulo.util.collection.Stack<Integer> getFlagStack(@Nonnull PsiBuilder b) {
        consulo.util.collection.Stack<Integer> stack = b.getUserData(FLAG_STACK);
        return stack != null ? stack : new consulo.util.collection.Stack<>(0);
    }

    private static void setFlagStack(@Nonnull PsiBuilder b, @Nonnull consulo.util.collection.Stack<Integer> stack) {
        b.putUserData(FLAG_STACK, stack);
    }

    private static void pushFlag(@Nonnull PsiBuilder b, int flag, boolean mode) {
        consulo.util.collection.Stack<Integer> stack = getFlagStack(b);
        stack.push(getFlags(b));
        setFlagStack(b, stack);
        setFlags(b, BitUtil.set(getFlags(b), flag, mode));
    }

    private static void pushFlags(@Nonnull PsiBuilder b, int[] flags, boolean[] values) {
        consulo.util.collection.Stack<Integer> stack = getFlagStack(b);
        stack.push(getFlags(b));
        setFlagStack(b, stack);
    ...
    private static void popFlag(@Nonnull PsiBuilder b) {
    ...
    private static int setPathMod(int flags, @Nonnull PathParsingMode mode) {
        int flag;
        switch (mode) {
    ...
    private static int setMacroBraces(int flags, @Nonnull MacroBraces mode) {
        int flag;
        switch (mode) {
    ...
    @SuppressWarnings("unused")
    public static boolean checkStructAllowed(@Nonnull PsiBuilder b, int level) {
        return BitUtil.isSet(getFlags(b), STRUCT_ALLOWED);
    }

    @SuppressWarnings("unused")
    public static boolean checkTypeQualAllowed(@Nonnull PsiBuilder b, int level) {
        return BitUtil.isSet(getFlags(b), TYPE_QUAL_ALLOWED);
    }

    @SuppressWarnings("unused")
    public static boolean checkBraceAllowed(@Nonnull PsiBuilder b, int level) {
        return ((consulo.language.ast.IElementType) b.getTokenType()) != LBRACE || checkStructAllowed(b, level);
    }

    @SuppressWarnings("unused")
    public static boolean checkGtAllowed(@Nonnull PsiBuilder b, int level) {
        return !BitUtil.isSet(getFlags(b), RESTRICTED_CONST_EXPR_MODE);
    }

    @SuppressWarnings("unused")
    public static boolean checkLetExprAllowed(@Nonnull PsiBuilder b, int level) {
        return BitUtil.isSet(getFlags(b), CONDITION_MODE);
    }

    @SuppressWarnings("unused")
    public static boolean withRestrictedConstExprMode(@Nonnull PsiBuilder b, int level, @Nonnull RestrictedConstExprMode mode, @Nonnull Parser parser) {
    ...
    @SuppressWarnings("unused")
    public static boolean withConditionMode(@Nonnull PsiBuilder b, int level, @Nonnull ConditionMode mode, @Nonnull Parser parser) {
        int oldFlags = getFlags(b);
    ...
    @SuppressWarnings("unused")
    public static boolean enterBlockExpr(@Nonnull PsiBuilder b, int level, @Nonnull Parser parser) {
        int oldFlags = getFlags(b);
    ...
    @SuppressWarnings("unused")
    public static boolean setStmtMode(@Nonnull PsiBuilder b, int level, @Nonnull StmtMode mode) {
        pushFlag(b, STMT_EXPR_MODE, mode == StmtMode.ON);
        return true;
    }

    @SuppressWarnings("unused")
    public static boolean setLambdaExprMode(@Nonnull PsiBuilder b, int level) {
        pushFlags(b, new int[]{STMT_EXPR_MODE, CONDITION_MODE}, new boolean[]{false, false});
        return true;
    }

    @SuppressWarnings("unused")
    public static boolean resetFlags(@Nonnull PsiBuilder b, int level) {
        popFlag(b);
        return true;
    }
    ...
    public static boolean exprMode(
        @Nonnull PsiBuilder b,
        int level,
        @Nonnull StructLiteralsMode structLiterals,
        @Nonnull StmtMode stmtMode,
    ...
    @SuppressWarnings("unused")
    public static boolean isCompleteBlockExpr(@Nonnull PsiBuilder b, int level) {
        return isBlock(b, level) && BitUtil.isSet(getFlags(b), STMT_EXPR_MODE);
    }

    @SuppressWarnings("unused")
    public static boolean isIncompleteBlockExpr(@Nonnull PsiBuilder b, int level) {
        return !isCompleteBlockExpr(b, level);
    }

    @SuppressWarnings("unused")
    public static boolean isBlock(@Nonnull PsiBuilder b, int level) {
        LighterASTNode m = b.getLatestDoneMarker();
        if (m == null) return false;
        return RS_BLOCK_LIKE_EXPRESSIONS.contains(((consulo.language.ast.IElementType) m.getTokenType())) || isBracedMacro(m, b);
    }

    @SuppressWarnings("unused")
    public static boolean pathMode(@Nonnull PsiBuilder b, int level, @Nonnull PathParsingMode mode, @Nonnull TypeQualsMode typeQualsMode, @Nonnull Parser parser) {
        int oldFlags = getFlags(b);
    ...
    @SuppressWarnings("unused")
    public static boolean isPathMode(@Nonnull PsiBuilder b, int level, @Nonnull PathParsingMode mode) {
     ...
     */
    @SuppressWarnings("unused")
    public static boolean parseFloatLiteral(@Nonnull PsiBuilder b, int level) {
    ...
    @SuppressWarnings("unused")
    public static boolean parsePathIdent(@Nonnull PsiBuilder b, int level) {
        IElementType tokenType = b.getTokenType();
        boolean result;
    ...
    @SuppressWarnings("unused")
    public static boolean unpairedToken(@Nonnull PsiBuilder b, int level) {
        IElementType tokenType = b.getTokenType();
    ...
    @SuppressWarnings("unused")
    public static boolean macroSemicolon(@Nonnull PsiBuilder b, int level) {
        LighterASTNode m = b.getLatestDoneMarker();
        if (m == null) return false;
        b.getTokenText();
    ...
    @SuppressWarnings("unused")
    public static boolean macroIdentifier(@Nonnull PsiBuilder b, int level) {
        IElementType tokenType = b.getTokenType();
    ...
    public static boolean pathOrTraitType(
        @Nonnull PsiBuilder b,
        int level,
        @Nonnull Parser pathP,
        @Nonnull Parser implicitTraitTypeP,
        @Nonnull Parser traitTypeUpperP
    ) {
    ...
    public static boolean typeReferenceOrAssocTypeBinding(
        ...
        int level,
        @Nonnull Parser pathP,
        @Nonnull Parser assocTypeBindingUpperP,
        @Nonnull Parser typeReferenceP,
        @Nonnull Parser traitTypeUpperP
    ) {
        if (((consulo.language.ast.IElementType) b.getTokenType()) == DYN || (((consulo.language.ast.IElementType) b.getTokenType()) == IDENTIFIER && "dyn".equals(b.getTokenText()) && b.lookAhead(1) != EXCL)) {
    ...
    private interface SpecialMacroParser {
        boolean parse(@Nonnull PsiBuilder b, int level);
    }
    ...
    private static void putSpecialMacro(@Nonnull SpecialMacroParser parser, boolean isExpr, @Nonnull String... keys) {
    ...
    public static boolean isSpecialMacro(@Nonnull String name) {
        return SPECIAL_MACRO_PARSERS.containsKey(name);
    }

    @SuppressWarnings("unused")
    public static boolean parseMacroCall(@Nonnull PsiBuilder b, int level, @Nonnull MacroCallParsingMode mode) {
    ...
    @Nullable
    private static String getMacroName(@Nonnull PsiBuilder b, int nameTokenIndex) {
        if (nameTokenIndex >= 0) {
    ...
    @SuppressWarnings("unused")
    public static boolean gtgteqImpl(@Nonnull PsiBuilder b, int level) { return collapse(b, GTGTEQ, GT, GT, EQ); }
    @SuppressWarnings("unused")
    public static boolean gtgtImpl(@Nonnull PsiBuilder b, int level) { return collapse(b, GTGT, GT, GT); }
    @SuppressWarnings("unused")
    public static boolean gteqImpl(@Nonnull PsiBuilder b, int level) { return collapse(b, GTEQ, GT, EQ); }
    @SuppressWarnings("unused")
    public static boolean ltlteqImpl(@Nonnull PsiBuilder b, int level) { return collapse(b, LTLTEQ, LT, LT, EQ); }
    @SuppressWarnings("unused")
    public static boolean ltltImpl(@Nonnull PsiBuilder b, int level) { return collapse(b, LTLT, LT, LT); }
    @SuppressWarnings("unused")
    public static boolean lteqImpl(@Nonnull PsiBuilder b, int level) { return collapse(b, LTEQ, LT, EQ); }
    @SuppressWarnings("unused")
    public static boolean ororImpl(@Nonnull PsiBuilder b, int level) { return collapse(b, OROR, OR, OR); }
    @SuppressWarnings("unused")
    public static boolean andandImpl(@Nonnull PsiBuilder b, int level) { return collapse(b, ANDAND, AND, AND); }
    ...
    @SuppressWarnings("unused")
    public static boolean defaultKeyword(@Nonnull PsiBuilder b, int level) { return contextualKeyword(b, "default", DEFAULT, null); }
    @SuppressWarnings("unused")
    public static boolean unionKeyword(@Nonnull PsiBuilder b, int level) { return contextualKeyword(b, "union", UNION, null); }
    @SuppressWarnings("unused")
    public static boolean autoKeyword(@Nonnull PsiBuilder b, int level) { return contextualKeyword(b, "auto", AUTO, null); }
    @SuppressWarnings("unused")
    public static boolean dynKeyword(@Nonnull PsiBuilder b, int level) { return contextualKeyword(b, "dyn", DYN, null); }
    @SuppressWarnings("unused")
    public static boolean asyncKeyword(@Nonnull PsiBuilder b, int level) { return contextualKeyword(b, "async", ASYNC, null); }

    @SuppressWarnings("unused")
    public static boolean asyncBlockKeyword(@Nonnull PsiBuilder b, int level) {
        return contextualKeyword(b, "async", ASYNC, it -> ASYNC_NEXT_ELEMENTS.contains(it));
    }

    @SuppressWarnings("unused")
    public static boolean tryKeyword(@Nonnull PsiBuilder b, int level) {
        return contextualKeyword(b, "try", TRY, it -> TRY_NEXT_ELEMENTS.contains(it));
    }

    @SuppressWarnings("unused")
    public static boolean rawKeyword(@Nonnull PsiBuilder b, int level) {
        return contextualKeywordWithRollback(b, "raw", RAW);
    }

    @SuppressWarnings("unused")
    public static boolean parseSecondPlusInIncrement(@Nonnull PsiBuilder b, int level) {
        return noWhiteSpaceBefore(b, PLUS);
    }

    @SuppressWarnings("unused")
    public static boolean parseSecondMinusInDecrement(@Nonnull PsiBuilder b, int level) {
        return noWhiteSpaceBefore(b, MINUS);
    }

    private static boolean noWhiteSpaceBefore(@Nonnull PsiBuilder b, @Nonnull IElementType token) {
        if (((consulo.language.ast.IElementType) b.getTokenType()) == token && b.rawLookup(-1) == token) {
            b.advanceLexer();
            return true;
        }
        return false;
    ...
    private static boolean collapse(@Nonnull PsiBuilder b, @Nonnull IElementType tokenType, @Nonnull IElementType... parts) {
     ...
     */
    @Nullable
    public static Object[] collapsedTokenType(@Nonnull PsiBuilder b) {
        IElementType tokenType = b.getTokenType();
        if (tokenType == GT) {
    ...
    private static boolean contextualKeyword(
        ...
        if (((consulo.language.ast.IElementType) b.getTokenType()) == elementType
            || (((consulo.language.ast.IElementType) b.getTokenType()) == IDENTIFIER && keyword.equals(b.getTokenText()) && nextElementPredicate.test(b.lookAhead(1)))) {
    ...
    private static boolean contextualKeywordWithRollback(@Nonnull PsiBuilder b, @Nonnull String keyword, @Nonnull IElementType elementType) {
        if (((consulo.language.ast.IElementType) b.getTokenType()) == IDENTIFIER && keyword.equals(b.getTokenText())) {
            PsiBuilder.Marker marker = b.mark();
            b.advanceLexer();
    ...
    @SuppressWarnings("unused")
    public static boolean parseMacroArgumentLazy(@Nonnull PsiBuilder builder, int level) {
        return parseTokenTreeLazy(builder, level, MACRO_ARGUMENT);
    }

    @SuppressWarnings("unused")
    public static boolean parseMacroBodyLazy(@Nonnull PsiBuilder builder, int level) {
        return parseTokenTreeLazy(builder, level, MACRO_BODY);
    }

    @SuppressWarnings("unused")
    public static boolean parseTokenTreeLazy(@Nonnull PsiBuilder builder, int level, @Nonnull IElementType tokenTypeToCollapse) {
        ...
        // Consulo's PsiBuilderUtil has no parseBlockLazy — fall back to eager parsing
        PsiBuilder.Marker marker = builder.mark();
        builder.advanceLexer();
        int depth = 1;
        while (depth > 0 && !builder.eof()) {
            IElementType tok = builder.getTokenType();
            if (tok == firstToken) depth++;
            else if (tok == rightBrace) depth--;
            builder.advanceLexer();
        }
    ...
    public static boolean hasProperTokenTreeBraceBalance(@Nonnull CharSequence text, @Nonnull Lexer lexer) {
        lexer.start(text);
    ...
    @SuppressWarnings("unused")
    public static boolean parseAnyBraces(@Nonnull PsiBuilder b, int level, @Nonnull Parser param) {
    ...
    @SuppressWarnings("unused")
    public static boolean parseSimplePat(@Nonnull PsiBuilder builder) {
        return RustParser.SimplePat(builder, 0);
    }

    @Nullable
    private static Frame ancestorOfTypeOrSelf(@Nullable Frame frame, @Nonnull IElementType elementType) {
