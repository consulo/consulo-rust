...
public class RsConstantStub extends RsAttrProcMacroOwnerStubBase<RsConstant> implements RsNamedStub {
    ...
    static final int IS_CONST_MASK;
    static {
    ...
    public RsConstantStub(@Nullable StubElement parent, @Nonnull IStubElementType elementType,
    ...
    public static final RsStubElementType<RsConstantStub, RsConstant> Type =
        new RsStubElementType<RsConstantStub, RsConstant>("CONSTANT") {
            @Nonnull @Override public RsConstantStub deserialize(@Nonnull StubInputStream ds, StubElement p) throws IOException {
            ...
            @Override public void serialize(@Nonnull RsConstantStub s, @Nonnull StubOutputStream ds) throws IOException {
                ds.writeName(s.name); ds.writeByte(s.flags); RsProcMacroStubInfo.serialize(s.procMacroInfo, ds);
            }
            @Nonnull @Override public RsConstant createPsi(@Nonnull RsConstantStub s) { return new RsConstantImpl(s, this); }
            @Nonnull @Override public RsConstantStub createStub(@Nonnull RsConstant psi, @Nullable StubElement p) {
            ...
            @Override public void indexStub(@Nonnull RsConstantStub s, @Nonnull IndexSink sink) { StubIndexing.indexConstant(sink, s); }
        };
}
