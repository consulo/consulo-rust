...
public final class RsAttrProcMacroOwnerUtil {
    ...
    /**
     * Type alias for {@link org.rust.lang.core.psi.impl.ProcMacroAttribute}.
     */
    public static abstract class ProcMacroAttribute<T extends RsMetaItemPsiOrStub>
        extends org.rust.lang.core.psi.impl.ProcMacroAttribute<T> {
    }
     ...
     */
    @Nullable
    public static org.rust.lang.core.psi.impl.ProcMacroAttribute<RsMetaItem> getProcMacroAttribute(
        @Nonnull RsAttrProcMacroOwner owner) {
        return org.rust.lang.core.psi.impl.ProcMacroAttribute.getProcMacroAttribute(owner);
    }
     ...
     */
    @Nullable
    public static org.rust.lang.core.psi.impl.ProcMacroAttribute<RsMetaItem> getProcMacroAttributeWithDerives(
        @Nonnull RsAttrProcMacroOwner owner) {
        return org.rust.lang.core.psi.impl.ProcMacroAttribute.getProcMacroAttribute(
            owner,
