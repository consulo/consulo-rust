 ...
 * {@code org.rust.cargo.api.model.CargoProjectsService} in Rust analysis code
 ...
 *
 * {@link Crate} is usually a wrapper around {@code org.rust.cargo.api.workspace.CargoWorkspace.Target}.
 *
 * <h3>Duplicated packages</h3>
 *
 * Multiple {@code org.rust.cargo.api.model.CargoProject}'s can refer to the <i>same</i> package, but
...
public interface CrateGraphService {
    ...
    @Nullable
    Crate findCrateByRootMod(@Nonnull VirtualFile rootModFile);

    @Nonnull
    static CrateGraphService crateGraph(@Nonnull Project project) {
