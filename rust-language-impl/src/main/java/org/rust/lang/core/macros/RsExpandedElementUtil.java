...
public final class RsExpandedElementUtil {
    ...
    private static List<PsiElement> findExpansionElementsNonRecursive(@Nonnull PsiElement element) {
        ...
        if (call instanceof RsMetaItem) {
            ...
            for (PsiElement ancestor : ancestors) {
                ...
                if (ancestor instanceof RsMetaItem && org.rust.lang.core.psi.ext.impl.RsMetaItemUtil.isRootMetaItem((RsMetaItem) ancestor) && "cfg".equals(((RsMetaItem) ancestor).getName())) {
                    return null;
                }
            }
        }
    ...
    public static MacroExpansion parseExpandedTextWithContext(
        ...
        return parseExpandedTextWithContext(context, new org.rust.lang.core.psi.impl.RsPsiFactory(project), text);
    }
    ...
    public static MacroExpansion parseExpandedTextWithContext(
        @Nonnull MacroExpansionContext context,
        @Nonnull org.rust.lang.core.psi.impl.RsPsiFactory factory,
        @Nonnull CharSequence text
    ) {
