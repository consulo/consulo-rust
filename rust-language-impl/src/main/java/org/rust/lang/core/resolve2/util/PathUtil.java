...
public final class PathUtil {
    ...
    public interface RsLeafUseSpeckConsumer {
        void consume(@Nonnull String[] usePath, @Nullable String alias, boolean isStarImport, int offsetInExpansion);
    }

    public static void forEachLeafSpeck(@Nonnull RsUseItemStub useItem, @Nonnull RsLeafUseSpeckConsumer consumer) {
    ...
    private static void forEachLeafSpeck(
        @Nonnull RsUseSpeckStub useSpeck,
        @Nonnull RsLeafUseSpeckConsumer consumer,
        @Nonnull ArrayList<String> segments,
        boolean isRootSpeck,
    ...
    private static boolean addPathSegments(@Nonnull RsPathStub path, @Nonnull ArrayList<String> segments) {
    ...
    @Nullable
    public static String[] getPathWithAdjustedDollarCrate(@Nonnull RsPathStub path) {
        ArrayList<String> segments = new ArrayList<>();
    ...
    @Nullable
    public static String[] getRestrictedPath(@Nonnull RsVisStub vis) {
