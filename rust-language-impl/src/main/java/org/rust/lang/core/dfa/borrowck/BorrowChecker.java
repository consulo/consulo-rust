...
import org.rust.lang.core.psi.ext.impl.RsInferenceContextOwnerUtil;
...
public class BorrowChecker {
    ...
    public static class BorrowCheckContext {
        ...
        @Nullable
        public static BorrowCheckContext buildFor(@Nonnull RsInferenceContextOwner owner) {
        ...
        @Nullable
        private AnalysisData buildAnalysisData(@Nonnull BorrowCheckContext bccx) {
        ...
        public void reportUseOfMovedValue(@Nonnull LoanPath loanPath, @Nonnull Move move) {
        ...
        public void reportMoveError(@Nonnull Cmt from) {
    ...
    public static class AnalysisData {
        ...
        public AnalysisData(@Nonnull FlowedMoveData moveData) {
    ...
    public static class BorrowCheckResult {
        ...
        public BorrowCheckResult(
            @Nonnull List<UseOfMovedValueError> usesOfMovedValue,
            @Nonnull List<UseOfUninitializedVariable> usesOfUninitializedVariable,
            @Nonnull List<MoveError> moveErrors
        ) {
    ...
    public static class UseOfMovedValueError {
        ...
        public UseOfMovedValueError(@Nonnull RsElement use, @Nonnull Move move) {
            this.use = use;
            this.move = move;
        }
    ...
    public static class UseOfUninitializedVariable {
        ...
        public UseOfUninitializedVariable(@Nonnull RsElement use) {
            this.use = use;
        }
    ...
    public static class MoveError {
        ...
        public MoveError(@Nonnull Cmt from) {
            this.from = from;
        }
