...
public final class RsModUtil {
     ...
     */
    public static boolean hasChildFiles(@Nonnull RsMod mod) {
        return getHasChildModules(mod);
    }

    @Nonnull
    public static List<RsMod> getChildModules(@Nonnull RsMod mod) {
        List<RsMod> result = new ArrayList<>();
        for (RsItemElement item : RsItemsOwnerUtil.getExpandedItemsExceptImplsAndUses(mod)) {
    ...
    @Nullable
    public static RsMod getChildModule(@Nonnull RsItemsOwner owner, @Nonnull String name) {
    ...
    @Nullable
    public static RsMod commonParentMod(@Nonnull RsMod mod1, @Nonnull RsMod mod2) {
    ...
    public static boolean isCrateRoot(@Nonnull RsMod mod) {
    ...
    @Nullable
    public static String getModName(@Nonnull RsModItem modItem) {
        return modItem.getModName();
    }

    @Nullable
    public static PsiDirectory getOwnedDirectory(@Nonnull RsMod mod) {
        return mod.getOwnedDirectory(false);
    }

    @Nullable
    public static PsiDirectory getOwnedDirectory(@Nonnull RsMod mod, boolean createIfNotExists) {
    ...
    @Nullable
    public static CargoWorkspace getCargoWorkspace(@Nonnull RsMod mod) {
        return RsElementUtil.getCargoWorkspace(mod);
    }

    @Nonnull
    public static List<RsItemElement> getExpandedItemsExceptImplsAndUses(@Nonnull RsMod mod) {
        return RsItemsOwnerUtil.getExpandedItemsExceptImplsAndUses(mod);
    }

    public static boolean processExpandedItemsExceptImplsAndUses(@Nonnull RsMod mod, @Nonnull Function<RsItemElement, Boolean> processor) {
        for (RsItemElement item : RsItemsOwnerUtil.getExpandedItemsExceptImplsAndUses(mod)) {
    ...
    @Nullable
    public static PsiElement getFirstItem(@Nonnull RsMod mod) {
     ...
     */
    @Nullable
    public static String qualifiedNameRelativeTo(@Nonnull RsQualifiedNamedElement element, @Nonnull RsMod context) {
    ...
    @Nullable
    public static org.rust.cargo.api.model.CargoProject getCargoProject(@Nonnull RsMod mod) {
        return CargoProjectsService.getInstance(mod.getProject())
            .findProjectForFile(mod.getContainingFile().getVirtualFile());
    }

    @Nullable
    public static CargoWorkspace.Target getContainingCargoTarget(@Nonnull RsMod mod) {
    ...
    @Nonnull
    public static List<RsItemElement> exportedItems(@Nonnull RsMod mod, @Nullable RsMod context) {
