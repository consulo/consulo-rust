...
public final class MirPlace {
    ...
    public MirPlace(@Nonnull MirLocal local) {
        this(local, Collections.emptyList());
    }

    public MirPlace(@Nonnull MirLocal local, @Nonnull List<MirProjectionElem<Ty>> projections) {
        this.local = local;
    ...
    @Nonnull
    public MirPlace makeField(int fieldIndex, @Nonnull Ty ty) {
    ...
    @Nonnull
    public static MirPlaceTy tyFrom(@Nonnull MirLocal local, @Nonnull List<MirProjectionElem<Ty>> projections) {
