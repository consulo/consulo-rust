...
public abstract class Expectation {
    ...
    public static final class ExpectHasType extends Expectation {
        ...
        public ExpectHasType(@Nonnull Ty ty) {
            myTy = ty;
        }
    ...
    public static final class ExpectCastableToType extends Expectation {
        ...
        public ExpectCastableToType(@Nonnull Ty ty) {
            myTy = ty;
        }
    ...
    public static final class ExpectRvalueLikeUnsized extends Expectation {
        ...
        public ExpectRvalueLikeUnsized(@Nonnull Ty ty) {
            myTy = ty;
        }
    ...
    @Nonnull
    private Expectation resolve(@Nonnull RsInferenceContext ctx) {
    ...
    @Nullable
    public Ty tyAsNullable(@Nonnull RsInferenceContext ctx) {
    ...
    @Nullable
    public Ty onlyHasTy(@Nonnull RsInferenceContext ctx) {
        if (this instanceof ExpectHasType) {
    ...
    @Nonnull
    public static Expectation rvalueHint(@Nonnull Ty ty) {
