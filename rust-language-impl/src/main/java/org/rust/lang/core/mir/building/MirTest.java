...
public abstract class MirTest {
    ...
    protected MirTest(@Nonnull MirSpan span) {
        this.span = span;
    }
    ...
    public static final class Switch extends MirTest {
        ...
        public Switch(@Nonnull MirSpan span, @Nonnull RsEnumItem item, @Nonnull BitSet variants) {
            super(span);
            this.item = item;
    ...
    public static final class SwitchInt extends MirTest {
        public SwitchInt(@Nonnull MirSpan span) {
            super(span);
        }
    ...
    public static final class Eq extends MirTest {
        public Eq(@Nonnull MirSpan span) {
            super(span);
        }
    ...
    public static final class Range extends MirTest {
        public Range(@Nonnull MirSpan span) {
            super(span);
        }
    ...
    public static final class Len extends MirTest {
        public Len(@Nonnull MirSpan span) {
            super(span);
        }
    ...
    @Nonnull
    public static MirTest test(@Nonnull MirMatchPair matchPair) {
