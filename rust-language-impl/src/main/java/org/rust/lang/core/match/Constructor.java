...
public abstract class Constructor {
    ...
    public static final class Single extends Constructor {
        ...
        @Override
        public boolean coveredByRange(@Nonnull ConstExpr.Value<?> from, @Nonnull ConstExpr.Value<?> to, boolean included) {
            return true;
        }
    ...
    public static final class Variant extends Constructor {
        ...
        public Variant(@Nonnull RsEnumVariant variant) {
    ...
    public static final class ConstantValue extends Constructor {
        ...
        public ConstantValue(@Nonnull ConstExpr.Value<?> value) {
            this.value = value;
        }
    ...
    public static final class ConstantRange extends Constructor {
        ...
        public ConstantRange(@Nonnull ConstExpr.Value<?> start, @Nonnull ConstExpr.Value<?> end, boolean includeEnd) {
            this.start = start;
            this.end = end;
            this.includeEnd = includeEnd;
        }

        public ConstantRange(@Nonnull ConstExpr.Value<?> start, @Nonnull ConstExpr.Value<?> end) {
    ...
    public int arity(@Nonnull Ty type) {
    ...
    @Nonnull
    public List<Ty> subTypes(@Nonnull Ty type) {
        if (type instanceof TyTuple) {
    ...
    public static boolean isInhabited(@Nonnull Ty ty) {
        return allConstructorsLazy(ty).iterator().hasNext();
    }

    @Nonnull
    public static List<Constructor> allConstructors(@Nonnull Ty ty) {
    ...
    @Nonnull
    private static Iterable<Constructor> allConstructorsLazy(@Nonnull Ty ty) {
    ...
    static int compareValues(@Nonnull ConstExpr.Value<?> a, @Nonnull ConstExpr.Value<?> b) {
