...
public class LoanPath {
    ...
    public LoanPath(@Nonnull LoanPathKind kind, @Nonnull Ty ty, @Nonnull RsElement element) {
        this.kind = kind;
        this.ty = ty;
    ...
    @Nonnull
    public Scope killScope(@Nonnull BorrowCheckContext bccx) {
    ...
    @Nullable
    public static LoanPath computeFor(@Nonnull Cmt cmt) {
