...
public final class RsLiteralKindUtil {
    ...
    @Nonnull
    public static LiteralOffsets offsetsForNumber(@Nonnull ASTNode node) {
    ...
    @Nonnull
    public static LiteralOffsets offsetsForText(@Nonnull ASTNode node) {
    ...
    @Nonnull
    private static LiteralOffsets offsetsForRawText(@Nonnull ASTNode node) {
        String text = node.getText();
        int textLength = node.getTextLength();
    ...
    private static int locatePrefix(@Nonnull ASTNode node) {
        String text = node.getText();
