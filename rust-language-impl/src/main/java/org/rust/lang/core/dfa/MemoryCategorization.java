...
public final class MemoryCategorization {
    ...
    public static abstract class Categorization {
        ...
        public static class Rvalue extends Categorization {
            ...
            public Rvalue(@Nonnull Region region) {
                this.region = region;
            }
        ...
        public static class Local extends Categorization {
            ...
            public Local(@Nonnull RsElement declaration) {
        ...
        public static class Deref extends Categorization {
            ...
            public Deref(@Nonnull Cmt cmt, @Nonnull PointerKind pointerKind) {
                this.cmt = cmt;
        ...
        public static abstract class Interior extends Categorization {
            ...
            public static class Field extends Interior {
                ...
                public Field(@Nonnull Cmt cmt, @Nullable String name) {
                    this.cmt = cmt;
                    this.name = name;
                }
            ...
            public static class Pattern extends Interior {
                ...
                public Pattern(@Nonnull Cmt cmt) {
                    this.cmt = cmt;
                }
        ...
        public static class Downcast extends Categorization {
            ...
            public Downcast(@Nonnull Cmt cmt, @Nonnull RsElement element) {
                this.cmt = cmt;
    ...
    public static abstract class BorrowKind {
        ...
        @Nonnull
        public static BorrowKind from(@Nonnull Mutability mutability) {
            return mutability == Mutability.IMMUTABLE ? ImmutableBorrow : MutableBorrow;
        }

        public static boolean isCompatible(@Nonnull BorrowKind first, @Nonnull BorrowKind second) {
    ...
    public static abstract class PointerKind {
        ...
        public static class BorrowedPointer extends PointerKind {
            ...
            public BorrowedPointer(@Nonnull BorrowKind borrowKind, @Nonnull Region region) {
        ...
        public static class UnsafePointer extends PointerKind {
            ...
            public UnsafePointer(@Nonnull Mutability mutability) {
    ...
    public static abstract class ImmutabilityBlame {
        ...
        public static class LocalDeref extends ImmutabilityBlame {
            ...
            public LocalDeref(@Nonnull RsElement element) {
                this.element = element;
            }
        }
        ...
        public static class ImmutableLocal extends ImmutabilityBlame {
            ...
            public ImmutableLocal(@Nonnull RsElement element) {
                this.element = element;
            }
        }
    }
    ...
    public static abstract class Aliasability {
        ...
        public static class FreelyAliasable extends Aliasability {
            ...
            public FreelyAliasable(@Nonnull AliasableReason reason) {
                this.reason = reason;
            }
        }
    ...
    public enum MutabilityCategory {
        ...
        @Nonnull
        public static MutabilityCategory from(@Nonnull Mutability mutability) {
            return mutability == Mutability.IMMUTABLE ? Immutable : Declared;
        }

        @Nonnull
        public static MutabilityCategory from(@Nonnull BorrowKind borrowKind) {
            return borrowKind == BorrowKind.ImmutableBorrow ? Immutable : Declared;
        }

        @Nonnull
        public static MutabilityCategory from(@Nonnull MutabilityCategory baseMut, @Nonnull PointerKind pointerKind) {
    ...
    public static class Cmt {
        ...
        public Cmt(@Nonnull RsElement element, @Nullable Categorization category,
                    @Nonnull MutabilityCategory mutabilityCategory, @Nonnull Ty ty) {
            this.element = element;
        ...
        public Cmt(@Nonnull RsElement element, @Nonnull Ty ty) {
    ...
    public static class MemoryCategorizationContext {
        ...
        public MemoryCategorizationContext(@Nonnull ImplLookup lookup, @Nonnull RsInferenceData inference) {
            this.lookup = lookup;
            this.inference = inference;
        }

        @Nonnull
        public Cmt processExpr(@Nonnull RsExpr expr) {
        ...
        @Nonnull
        private Cmt processExprAdjustedWith(@Nonnull RsExpr expr, @Nonnull Iterator<Adjustment> adjustments) {
        ...
        @Nonnull
        private Cmt processExprUnadjusted(@Nonnull RsExpr expr) {
        ...
        @Nonnull
        private Cmt processUnaryExpr(@Nonnull RsUnaryExpr unaryExpr) {
        ...
        @Nonnull
        private Cmt processDotExpr(@Nonnull RsDotExpr dotExpr) {
        ...
        @Nonnull
        private Cmt processIndexExpr(@Nonnull RsIndexExpr indexExpr) {
        ...
        @Nonnull
        private Cmt processOverloadedPlace(@Nonnull RsExpr expr, @Nonnull RsExpr base) {
        ...
        @Nonnull
        private Cmt processPathExpr(@Nonnull RsPathExpr pathExpr) {
        ...
        @Nonnull
        private Cmt processParenExpr(@Nonnull RsParenExpr parenExpr) {
            RsExpr wrapped = parenExpr.getExpr();
            return wrapped != null ? processExpr(wrapped) : processRvalue(parenExpr);
        }

        @Nonnull
        private Cmt processDeref(@Nonnull RsExpr expr, @Nonnull Cmt baseCmt) {
            Ty baseType = baseCmt.ty;
            consulo.util.lang.Pair<Ty, Mutability> result = org.rust.lang.core.types.ty.TyUtil.builtinDeref(baseType, lookup.getItems());
        ...
        @Nonnull
        private Cmt processRvalue(@Nonnull RsExpr expr) {
            return processRvalue(expr, inference.getExprType(expr));
        }

        @Nonnull
        private Cmt processRvalue(@Nonnull RsExpr expr, @Nonnull Ty ty) {
            return new Cmt(expr, new Categorization.Rvalue(ReStatic.INSTANCE), MutabilityCategory.Declared, ty);
        }

        @Nonnull
        public Cmt processRvalue(@Nonnull RsElement element, @Nonnull Region tempScope, @Nonnull Ty ty) {
            return new Cmt(element, new Categorization.Rvalue(tempScope), MutabilityCategory.Declared, ty);
        }

        public void walkPat(@Nonnull Cmt cmt, @Nonnull RsPat pat, @Nonnull WalkPatCallback callback) {
        ...
        private void processTuplePats(@Nonnull Cmt cmt, @Nonnull RsPat pat, @Nonnull List<RsPat> pats, @Nonnull WalkPatCallback callback) {
            int index = 0;
        ...
        @Nonnull
        private Cmt cmtOfField(@Nonnull RsElement element, @Nonnull Cmt baseCmt, @Nullable String fieldName, @Nonnull Ty fieldType) {
            return new Cmt(element, new Categorization.Interior.Field(baseCmt, fieldName), baseCmt.mutabilityCategory.inherit(), fieldType);
        }

        @Nonnull
        private Cmt cmtOfSliceElement(@Nonnull RsElement element, @Nonnull Cmt baseCmt) {
    ...
    public interface WalkPatCallback {
        void accept(@Nonnull Cmt cmt, @Nonnull RsPat pat, @Nonnull RsPatBinding binding);
    }
}
