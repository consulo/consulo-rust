...
public final class RsExprExtUtil {
    ...
    @Nullable
    public static RsConstContextKind classifyConstContext(@Nonnull RsExpr expr) {
    ...
    public static void processBreakExprs(@Nonnull RsLabeledExpression labeledExpr,
                                         @Nonnull Consumer<RsBreakExpr> processor) {
    ...
    private static void processBreakExprsInternal(@Nonnull PsiElement element,
                                                  @Nullable String label,
                                                  boolean matchOnlyByLabel,
                                                  @Nonnull Consumer<RsBreakExpr> sink) {
        PsiElementUtil.forEachChild(element, child -> {
