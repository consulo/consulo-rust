...
public interface MirVisitor {
    ...
    default void visitBody(@Nonnull MirBody body) {
    ...
    default void visitBasicBlock(@Nonnull MirBasicBlock block) {
    ...
    default void visitSourceScope(@Nonnull MirSourceScope scope) {
    ...
    default void visitLocalDecl(@Nonnull MirLocal local) {
    ...
    default void visitVarDebugInfo(@Nonnull MirBody body, @Nonnull MirVarDebugInfo varDebugInfo) {
    ...
    default void visitPlace(@Nonnull MirPlace place, @Nonnull MirPlaceContext context, @Nonnull MirLocation location) {
    ...
    default void visitProjection(@Nonnull MirPlace place, @Nonnull MirPlaceContext context, @Nonnull MirLocation location) {
    ...
    default void visitProjectionElem(@Nonnull MirProjectionElem<Ty> elem, @Nonnull MirLocation location) {
    ...
    default void visitLocal(@Nonnull MirLocal local, @Nonnull MirPlaceContext context, @Nonnull MirLocation location) {
    }

    default void visitConstant(@Nonnull MirConstant constant, @Nonnull MirLocation location) {
        visitSpan(constant.getSpan());
        // TODO: process constant.literal
    }

    default void visitSpan(@Nonnull MirSpan span) {
    }

    default void visitStatement(@Nonnull MirStatement statement, @Nonnull MirLocation location) {
    ...
    default void visitAssign(@Nonnull MirPlace place, @Nonnull MirRvalue rvalue, @Nonnull MirLocation location) {
        visitPlace(place, MirPlaceContext.MutatingUse.Store.INSTANCE, location);
        visitRvalue(rvalue, location);
    }

    default void visitRvalue(@Nonnull MirRvalue rvalue, @Nonnull MirLocation location) {
    ...
    default void visitTerminator(@Nonnull MirTerminator<MirBasicBlock> terminator, @Nonnull MirLocation location) {
    ...
    default void visitOperand(@Nonnull MirOperand operand, @Nonnull MirLocation location) {
    ...
    default void visitAssertMessage(@Nonnull MirAssertKind msg, @Nonnull MirLocation location) {
    ...
    default void visitSourceInfo(@Nonnull MirSourceInfo source) {
        visitSpan(source.getSpan());
        visitSourceScope(source.getScope());
    }

    default void visitTy(@Nonnull Ty ty, @Nonnull TyContext context) {
    }

    default void visitTyConst(@Nonnull Const aConst, @Nonnull MirLocation location) {
    }
}
