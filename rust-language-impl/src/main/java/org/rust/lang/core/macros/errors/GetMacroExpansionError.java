...
public abstract class GetMacroExpansionError {
    ...
    public static final GetMacroExpansionError MacroExpansionIsDisabled = new GetMacroExpansionError() {
        @Override public @Nonnull String toUserViewableMessage() { return RsBundle.message("macro.expansion.error.MacroExpansionIsDisabled.message"); }
    ...
    public static final GetMacroExpansionError MacroExpansionEngineIsNotReady = new GetMacroExpansionError() {
        @Override public @Nonnull String toUserViewableMessage() { return RsBundle.message("macro.expansion.error.MacroExpansionEngineIsNotReady.message"); }
    ...
    public static final GetMacroExpansionError IncludingFileNotFound = new GetMacroExpansionError() {
        @Override public @Nonnull String toUserViewableMessage() { return RsBundle.message("macro.expansion.error.IncludingFileNotFound.message"); }
    ...
    public static final GetMacroExpansionError FileIncludedIntoMultiplePlaces = new GetMacroExpansionError() {
        @Override public @Nonnull String toUserViewableMessage() { return RsBundle.message("macro.expansion.error.FileIncludedIntoMultiplePlaces.message"); }
    ...
    public static final GetMacroExpansionError OldEngineStd = new GetMacroExpansionError() {
        @Override public @Nonnull String toUserViewableMessage() { return RsBundle.message("macro.expansion.error.OldEngineStd.message"); }
    ...
    public static final GetMacroExpansionError MemExpAttrMacro = new GetMacroExpansionError() {
        @Override public @Nonnull String toUserViewableMessage() { return RsBundle.message("macro.expansion.error.MemExpAttrMacro.message"); }
    ...
    public static final GetMacroExpansionError ModDataNotFound = new GetMacroExpansionError() {
        @Override public @Nonnull String toUserViewableMessage() { return RsBundle.message("macro.expansion.error.ModDataNotFound.message"); }
    ...
    public static final GetMacroExpansionError InconsistentExpansionExpandedFrom = new GetMacroExpansionError() {
        @Override public @Nonnull String toUserViewableMessage() { return RsBundle.message("macro.expansion.error.InconsistentExpansionExpandedFrom.message"); }
    ...
    public static final GetMacroExpansionError TooDeepExpansion = new GetMacroExpansionError() {
        @Override public @Nonnull String toUserViewableMessage() { return RsBundle.message("macro.expansion.error.TooDeepExpansion.message"); }
    ...
    public static final GetMacroExpansionError NoMacroIndex = new GetMacroExpansionError() {
        @Override public @Nonnull String toUserViewableMessage() { return RsBundle.message("macro.expansion.error.NoMacroIndex.message"); }
    ...
    public static final GetMacroExpansionError ExpansionNameNotFound = new GetMacroExpansionError() {
        @Override public @Nonnull String toUserViewableMessage() { return RsBundle.message("macro.expansion.error.ExpansionNameNotFound.message"); }
    ...
    public static final GetMacroExpansionError ExpansionFileNotFound = new GetMacroExpansionError() {
        @Override public @Nonnull String toUserViewableMessage() { return RsBundle.message("macro.expansion.error.ExpansionFileNotFound.message"); }
    ...
    public static final GetMacroExpansionError InconsistentExpansionCacheAndVfs = new GetMacroExpansionError() {
        @Override public @Nonnull String toUserViewableMessage() { return RsBundle.message("macro.expansion.error.InconsistentExpansionCacheAndVfs.message"); }
    ...
    public static final GetMacroExpansionError VirtualFileFoundButPsiIsNull = new GetMacroExpansionError() {
        @Override public @Nonnull String toUserViewableMessage() { return RsBundle.message("macro.expansion.error.VirtualFileFoundButPsiIsNull.message"); }
    ...
    public static final GetMacroExpansionError VirtualFileFoundButPsiIsUnknown = new GetMacroExpansionError() {
        @Override public @Nonnull String toUserViewableMessage() { return RsBundle.message("macro.expansion.error.VirtualFileFoundButPsiIsUnknown.message"); }
    ...
    public static final GetMacroExpansionError TooLargeExpansion = new GetMacroExpansionError() {
        @Override public @Nonnull String toUserViewableMessage() { return RsBundle.message("macro.expansion.error.TooLargeExpansion.message"); }
    ...
    public static final GetMacroExpansionError CfgDisabled = new GetMacroExpansionError() {
        @Override public @Nonnull String toUserViewableMessage() { return RsBundle.message("macro.expansion.error.CfgDisabled.message"); }
    ...
    public static final GetMacroExpansionError Skipped = new GetMacroExpansionError() {
        @Override public @Nonnull String toUserViewableMessage() { return RsBundle.message("macro.expansion.error.Skipped.message"); }
    ...
    public static final GetMacroExpansionError Unresolved = new GetMacroExpansionError() {
        @Override public @Nonnull String toUserViewableMessage() { return RsBundle.message("macro.expansion.error.Unresolved.message"); }
    ...
    public static final GetMacroExpansionError NoProcMacroArtifact = new GetMacroExpansionError() {
        @Override public @Nonnull String toUserViewableMessage() { return RsBundle.message("macro.expansion.error.NoProcMacroArtifact.message"); }
    ...
    public static final GetMacroExpansionError MacroCallSyntax = new GetMacroExpansionError() {
        @Override public @Nonnull String toUserViewableMessage() { return RsBundle.message("macro.expansion.error.MacroCallSyntax.message"); }
    ...
    public static final GetMacroExpansionError MacroDefSyntax = new GetMacroExpansionError() {
        @Override public @Nonnull String toUserViewableMessage() { return RsBundle.message("macro.expansion.error.MacroDefSyntax.message"); }
    ...
    public static final class MemExpParsingError extends GetMacroExpansionError {
        ...
        public MemExpParsingError(@Nonnull CharSequence expansionText, @Nonnull MacroExpansionContext context) {
    ...
    public static final class ExpansionError extends GetMacroExpansionError {
        ...
        public ExpansionError(@Nonnull MacroExpansionError error) {
            myError = error;
        }
