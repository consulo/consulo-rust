...
public final class RegionScopeTreeUtil {
     ...
     */
    @Nonnull
    public static ScopeTree getRegionScopeTree(@Nonnull RsInferenceContextOwner owner) {
        ...
        if (owner instanceof RsFunction) {
            ...
            if (plist != null) {
                ...
                RsBlock fnBody = org.rust.lang.core.psi.ext.impl.RsFunctionUtil.getBlock(fn);
    ...
    private static final class Visitor {
        @Nonnull private final ScopeTree tree;
        private Scope current;
        private int depth;

        Visitor(@Nonnull ScopeTree tree) {
            this.tree = tree;
        }

        void pushCurrent(@Nonnull Scope scope) {
            current = scope;
            depth++;
        }
        ...
        void visitBlock(@Nonnull RsBlock block) {
        ...
        void visitStmt(@Nonnull RsStmt stmt) {
        ...
        void visitExpr(@Nonnull RsExpr expr) {
        ...
        void bindPatterns(@Nonnull PsiElement pat, @Nonnull Scope scope) {
