...
public final class FormatImpl {
    ...
    @Nullable
    public static ParseContext parseParameters(@Nonnull RsLitExpr formatStr) {
    ...
    @Nonnull
    public static List<ErrorAnnotation> checkSyntaxErrors(@Nonnull ParseContext ctx) {
    ...
    public static void highlightParametersOutside(@Nonnull ParseContext ctx, @Nonnull AnnotationHolder holder) {
    ...
    public static void highlightParametersInside(@Nonnull ParseContext ctx, @Nonnull AnnotationHolder holder) {
    ...
    @Nonnull
    public static List<FormatParameter> buildParameters(@Nonnull ParseContext ctx) {
    ...
    @Nonnull
    public static List<ErrorAnnotation> checkParameters(@Nonnull FormatContext ctx) {
    ...
    @Nonnull
    public static List<ErrorAnnotation> checkArguments(@Nonnull FormatContext ctx) {
        List<ErrorAnnotation> errors = new ArrayList<>();
        for (int i = 0; i < ctx.getArguments().size(); i++) {
            ...
            for (consulo.util.lang.Pair<FormatParameter, ParameterLookup.Positional> pair : ctx.getPositionalParameters()) {
            ...
            if (name == null) {
                ...
                for (consulo.util.lang.Pair<FormatParameter, ParameterLookup.Named> pair : ctx.getNamedParameters()) {
    ...
    @Nullable
    public static int[] getFormatMacroCtxPositionOnly(@Nonnull RsMacroCall call, @Nonnull RsMacro def) {
    ...
    @Nonnull
    private static ParameterLookup buildLookup(@Nonnull String value) {
        try {
    ...
    @Nullable
    private static String getNamedGroup(@Nonnull java.util.regex.MatchResult match, @Nonnull String name) {
