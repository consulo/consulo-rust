...
public class RsCachedImplItem {
    ...
    public RsCachedImplItem(@Nonnull RsImplItem impl) {
        this.impl = impl;
    ...
    @Nonnull
    public static RsCachedImplItem forImpl(@Nonnull RsImplItem impl) {
    ...
    public static <T> CachedValueProvider.Result<T> toCachedResult(
        @Nonnull RsElement psi,
        @Nullable Crate containingCrate,
        @Nonnull T cachedImpl
    ) {
