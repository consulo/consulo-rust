...
public class SimpleItemLight extends ItemLight {
    ...
    @Nullable
    private final org.rust.lang.core.psi.impl.RsProcMacroKind procMacroKind;
    ...
    public SimpleItemLight(
        ...
        @Nonnull Set<Namespace> namespaces,
        boolean isTrait,
        @Nullable org.rust.lang.core.psi.impl.RsProcMacroKind procMacroKind
    ) {
    ...
    @Nullable
    public org.rust.lang.core.psi.impl.RsProcMacroKind getProcMacroKind() {
