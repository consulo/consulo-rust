...
public class KnownItems {
    ...
    public KnownItems(@Nonnull KnownItemsLookup lookup) {
        this.lookup = lookup;
    }

    @Nullable
    public RsNamedElement findLangItemRaw(@Nonnull String langAttribute, @Nonnull String crateName) {
        return lookup.findLangItem(langAttribute, crateName);
    }

    @Nullable
    public RsNamedElement findItemRaw(@Nonnull String path, boolean isStd) {
        return lookup.findItem(path, isStd);
    }

    @Nullable
    @SuppressWarnings("unchecked")
    public <T extends RsNamedElement> T findLangItem(@Nonnull String langAttribute, @Nonnull String crateName, @Nonnull Class<T> clazz) {
    ...
    @Nullable
    @SuppressWarnings("unchecked")
    public <T extends RsNamedElement> T findItem(@Nonnull String path, boolean isStd, @Nonnull Class<T> clazz) {
    ...
    @Nonnull
    public static KnownItems getKnownItems(@Nonnull CargoProject cargoProject) {
    ...
    @Nonnull
    public static KnownItems knownItems(@Nonnull RsElement element) {
    ...
    public interface KnownItemsLookup {
        @Nullable
        RsNamedElement findLangItem(@Nonnull String langAttribute, @Nonnull String crateName);

        @Nullable
        RsNamedElement findItem(@Nonnull String path, boolean isStd);
    }
    ...
    private static class DummyKnownItemsLookup implements KnownItemsLookup {
        ...
        @Nullable
        @Override
        public RsNamedElement findLangItem(@Nonnull String langAttribute, @Nonnull String crateName) {
            return null;
        }

        @Nullable
        @Override
        public RsNamedElement findItem(@Nonnull String path, boolean isStd) {
            return null;
        }
    }
    ...
    private static class RealKnownItemsLookup implements KnownItemsLookup {
        ...
        RealKnownItemsLookup(@Nonnull Project project, @Nonnull CargoWorkspace workspace) {
