...
public final class RsFunctionUtil {
    ...
    public static boolean isMain(@Nonnull RsFunction fn) {
        ...
        org.rust.cargo.api.workspace.CargoWorkspace.Target target = RsElementExtUtil.getContainingCargoTarget(fn);
        if (target == null) return false;
        org.rust.cargo.api.workspace.CargoWorkspace.TargetKind kind = target.getKind();
