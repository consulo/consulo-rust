...
import org.rust.lang.core.psi.ext.impl.RsModificationTrackerOwnerUtil;
...
public final class RsResolveCache implements Disposable {
    ...
    private ConcurrentMap<PsiElement, Object> getCacheFor(@Nonnull PsiElement element, @Nonnull ResolveCacheDependency dep) {
        switch (dep) {
            ...
            case LOCAL_AND_RUST_STRUCTURE: {
                RsModificationTrackerOwner owner = org.rust.lang.core.psi.ext.impl.RsModificationTrackerOwnerUtil.findModificationTrackerOwner(element, false);
                if (owner != null) {
    ...
    public static RsResolveCache getInstance(@Nonnull Project project) {
        return project.getInstance(RsResolveCache.class);
    }
