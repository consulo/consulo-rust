...
import org.rust.cargo.api.settings.RustAdvancedSettings;
import org.rust.lang.core.psi.impl.HardcodedProcMacroProperties;
import org.rust.lang.core.psi.ext.RsMod;
import org.rust.lang.core.psi.ext.impl.RsModExtUtil;
...
public class CrateDefMap {
    ...
    public int getRecursionLimit() {
        return Math.min(recursionLimitRaw, org.rust.cargo.api.settings.RustAdvancedSettings.getMaximumRecursionLimit());
    }
    ...
    public ModData getModData(@Nonnull org.rust.lang.core.psi.ext.RsMod mod) {
        ...
        org.rust.lang.core.psi.ext.RsMod parentMod = org.rust.lang.core.psi.ext.impl.RsModExtUtil.getSuper(mod);
        if (parentMod == null) return null;
        ModData parentModData = getModData(parentMod);
        if (parentModData == null) return null;
        return parentModData.getChildModules().get(org.rust.lang.core.psi.ext.impl.RsModUtil.getModName(mod));
    }
    ...
    private MacroDefInfo doGetMacroInfo(@Nonnull VisItem macroDef) {
        ...
        if (procMacroKind != null) {
            KnownProcMacroKind knownKind = (KnownProcMacroKind) (Object) org.rust.lang.core.psi.impl.HardcodedProcMacroProperties.getHardcodeProcMacroProperties(metaData.getName(), macroDef.getName());
