...
public final class FacadeBuildDefMap {
    ...
    public static CrateDefMap buildDefMap(
        @Nonnull Crate crate,
        @Nonnull Map<Crate, CrateDefMap> allDependenciesDefMaps,
    ...
    private static CrateDefMap buildDefMapContainingExplicitItems(
        ...
        if (crate.getOrigin() == org.rust.cargo.api.workspace.PackageOrigin.WORKSPACE) {
        ...
        consulo.virtualFileSystem.VirtualFile rootVirtualFile = isNormalCrate ? crateRoot.getVirtualFile() : null;
    ...
    private static boolean shouldAutoInjectDependency(
        @Nonnull Crate crate,
        @Nonnull Crate.Dependency dependency,
        @Nonnull RsFile.Attributes stdlibAttributes
    ) {
    ...
    private static void injectPrelude(@Nonnull CrateDefMap defMap) {
    ...
    @Nullable
    private static Import createExternCrateStdImport(@Nonnull CrateDefMap defMap) {
    ...
    private static class DependenciesDefMaps {
        @Nonnull final Map<String, CrateDefMap> directDependencies;
        @Nonnull final Map<Integer, CrateDefMap> allDependencies;
        @Nonnull final Map<String, CrateDefMap> initialExternPrelude;

        DependenciesDefMaps(
            @Nonnull Map<String, CrateDefMap> directDependencies,
            @Nonnull Map<Integer, CrateDefMap> allDependencies,
