...
public class RsProcMacroStubInfo {
    ...
    public RsProcMacroStubInfo(@Nonnull String stubbedText, @Nullable HashCode stubbedTextHash, int endOfAttrsOffset, int startOffset) {
    ...
    public static void serialize(@Nullable RsProcMacroStubInfo info, @Nonnull StubOutputStream dataStream) throws IOException {
        if (info == null) {
    ...
    @Nullable
    public static RsProcMacroStubInfo deserialize(@Nonnull StubInputStream dataStream) throws IOException {
