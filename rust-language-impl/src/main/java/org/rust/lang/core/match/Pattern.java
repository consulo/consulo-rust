...
public final class Pattern {
    ...
    public Pattern(@Nonnull Ty ty, @Nonnull PatternKind kind) {
        this.ty = ty;
        this.kind = kind;
    }
    ...
    @Nonnull
    public static Pattern wild(@Nonnull Ty ty) {
    ...
    @Nonnull
    private static String initializerForFieldsOwner(@Nonnull RsFieldsOwner owner, @Nonnull List<Pattern> subPatterns, @Nullable RsElement ctx) {
