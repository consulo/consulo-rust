...
public abstract class LoanPathElement {
    ...
    public static class Deref extends LoanPathElement {
        ...
        public Deref(@Nonnull MemoryCategorization.PointerKind kind) {
            this.kind = kind;
        }
    ...
    public static abstract class Interior extends LoanPathElement {
        ...
        @Nonnull
        public static Interior fromCategory(@Nonnull MemoryCategorization.Categorization.Interior category, @Nullable RsElement element) {
