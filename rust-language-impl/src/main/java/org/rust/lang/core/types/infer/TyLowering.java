...
public class TyLowering {
    ...
    private TyLowering(@Nonnull Map<RsPath, List<RsPathResolveResult<RsElement>>> resolvedNestedPaths) {
        myResolvedNestedPaths = new HashMap<>(resolvedNestedPaths);
    }

    @Nonnull
    private Ty lowerTy(@Nonnull RsTypeReference type, @Nullable Region defaultTraitObjectRegion) {
    ...
    @Nonnull
    private Ty lowerPathType(@Nonnull RsPathType type, @Nullable Region defaultTraitObjectRegion) {
    ...
    @Nonnull
    private Ty lowerRefLikeType(@Nonnull RsRefLikeType type, @Nullable Region defaultTraitObjectRegion) {
    ...
    @Nonnull
    private Ty lowerArrayType(@Nonnull RsArrayType type) {
    ...
    @Nonnull
    private Ty lowerFnPointerType(@Nonnull RsFnPointerType type) {
    ...
    @Nonnull
    private Ty lowerTraitType(@Nonnull RsTraitType type, @Nullable Region defaultTraitObjectRegion) {
    ...
    @Nonnull
    private List<RsPathResolveResult<RsElement>> rawMultiResolvePath(@Nonnull RsPath path) {
    ...
    private <T extends RsElement> BoundElement<T> instantiatePathGenerics(
        ...
        @Nonnull PathExprResolver resolver,
        boolean withAssoc
    ) {
    ...
    @Nonnull
    public static Ty lowerTypeReference(@Nonnull RsTypeReference type) {
    ...
    public static <T extends RsElement> BoundElement<T> lowerPathGenerics(
        ...
        @Nonnull Substitution subst,
        @Nonnull PathExprResolver resolver,
        @Nonnull Map<RsPath, List<RsPathResolveResult<RsElement>>> resolvedNestedPaths
    ) {
    ...
    private static <T extends TypeFoldable<T>> T substituteWithTraitObjectRegion(
        @Nonnull Object ty,
        @Nonnull Substitution subst,
        @Nonnull Region defaultTraitObjectRegion
    ) {
        ...
        Object result = foldable.foldWith(new TypeFolder() {
            ...
            @Nullable
            private Ty handleTraitObject(@Nonnull TyTypeParameter paramTy) {
    ...
    private static boolean containsElement(@Nonnull Iterable<PsiElement> iterable, @Nonnull PsiElement element) {
