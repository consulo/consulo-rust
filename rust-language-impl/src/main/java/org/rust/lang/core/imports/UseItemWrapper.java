...
public class UseItemWrapper implements Comparable<UseItemWrapper> {
    ...
    public UseItemWrapper(@Nonnull RsUseItem useItem) {
    ...
    @Override
    public int compareTo(@Nonnull UseItemWrapper other) {
    ...
    @Nullable
    private static String getPathTextLower(@Nonnull RsUseSpeck useSpeck) {
