...
public class RsStructItemStub extends RsAttrProcMacroOwnerStubBase<RsStructItem> implements RsNamedStub {
    ...
    static final int IS_UNION_MASK;
    static {
    ...
    public RsStructItemStub(@Nullable StubElement parent, @Nonnull IStubElementType elementType,
    ...
    public static final RsStubElementType<RsStructItemStub, RsStructItem> Type =
        new RsStubElementType<RsStructItemStub, RsStructItem>("STRUCT_ITEM") {
            @Nonnull @Override
            public RsStructItemStub deserialize(@Nonnull StubInputStream dataStream, StubElement parentStub) throws IOException {
            ...
            @Override
            public void serialize(@Nonnull RsStructItemStub stub, @Nonnull StubOutputStream dataStream) throws IOException {
            ...
            @Nonnull @Override
            public RsStructItem createPsi(@Nonnull RsStructItemStub stub) { return new RsStructItemImpl(stub, this); }

            @Nonnull @Override
            public RsStructItemStub createStub(@Nonnull RsStructItem psi, @Nullable StubElement parentStub) {
            ...
            @Override
            public void indexStub(@Nonnull RsStructItemStub stub, @Nonnull IndexSink sink) {
