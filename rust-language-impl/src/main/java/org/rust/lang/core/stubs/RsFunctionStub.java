...
public class RsFunctionStub extends RsAttrProcMacroOwnerStubBase<RsFunction> implements RsNamedStub {
    ...
    static final int ABSTRACT_MASK;
    static final int CONST_MASK;
    static final int UNSAFE_MASK;
    static final int EXTERN_MASK;
    static final int VARIADIC_MASK;
    static final int ASYNC_MASK;
    static final int HAS_SELF_PARAMETER_MASK;
    static final int PREFERRED_BRACES;
    ...
    public RsFunctionStub(@Nullable StubElement parent, @Nonnull IStubElementType elementType,
    ...
    @Nonnull public MacroBraces getPreferredBraces() { return MacroBraces.values()[(flags >>> PREFERRED_BRACES) & 3]; }
    ...
    public static final RsStubElementType<RsFunctionStub, RsFunction> Type =
        new RsStubElementType<RsFunctionStub, RsFunction>("FUNCTION") {
            ...
            @Override public void serialize(@Nonnull RsFunctionStub stub, @Nonnull StubOutputStream dataStream) throws IOException {
            ...
            @Nonnull @Override public RsFunction createPsi(@Nonnull RsFunctionStub stub) { return new RsFunctionImpl(stub, this); }
            @Nonnull @Override public RsFunctionStub createStub(@Nonnull RsFunction psi, @Nullable StubElement parentStub) {
            ...
            @Override public void indexStub(@Nonnull RsFunctionStub stub, @Nonnull IndexSink sink) { StubIndexing.indexFunction(sink, stub); }
        };
}
