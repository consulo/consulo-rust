...
public class MovePath implements WithIndex {
    ...
    public MovePath(int index, @Nonnull MirPlace place, @Nullable MovePath parent) {
        this.index = index;
        this.place = place;
        this.parent = parent;
    }
    ...
    @Nullable
    public MovePath findInMovePathOrItsDescendants(@Nonnull Predicate<MovePath> predicate) {
        if (predicate.test(this)) return this;
        return findDescendant(predicate);
    }

    @Nullable
    private MovePath findDescendant(@Nonnull Predicate<MovePath> predicate) {
