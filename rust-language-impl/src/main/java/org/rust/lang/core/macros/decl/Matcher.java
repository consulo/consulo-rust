...
import org.rust.lang.core.psi.ext.impl.RsMacroBindingUtil;
...
public abstract class Matcher {
    ...
    public static final class Optional extends Matcher {
        ...
        public Optional(@Nonnull Matcher matcher) {
            myMatcher = matcher;
        }
    ...
    public static final class Choice extends Matcher {
        ...
        public Choice(@Nonnull List<Matcher> matchers) {
            myMatchers = matchers;
        }
    ...
    public static final class Sequence extends Matcher {
        ...
        public Sequence(@Nonnull List<Matcher> matchers) {
            myMatchers = matchers;
        }
    ...
    public static final class Repeat extends Matcher {
        ...
        public Repeat(@Nonnull List<Matcher> matchers, @Nullable ASTNode separator) {
            myMatchers = matchers;
    ...
    @Nullable
    public static Matcher buildFor(@Nonnull RsMacroDefinitionBase macro) {
    ...
    private static void addNewMatcher(@Nonnull ASTNode node, @Nonnull List<Matcher> matchers)
        throws InvalidPatternException {
        if (node.getElementType() == RsElementTypes.MACRO_BINDING) {
            RsMacroBinding psi = (RsMacroBinding) node.getPsi();
            String specifier = org.rust.lang.core.psi.ext.impl.RsMacroBindingUtil.getFragmentSpecifier(psi);
