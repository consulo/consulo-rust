...
/**
 * Groups of Rust element types.
 *
 * <p>Every set here is derived from {@link RsElementTypes}, so this class is initialized on first
 * use, once that table is complete. Nothing that takes part in building the table may read these
 * fields from its own static initializer.
 */
public final class RsTokenSets {

    private RsTokenSets() {
    }

    public static final TokenSet RS_KEYWORDS = RsTokenType.tokenSetOf(
    ...
    public static final TokenSet RS_OPERATORS = RsTokenType.tokenSetOf(
    ...
    public static final TokenSet RS_BINARY_OPS = RsTokenType.tokenSetOf(
    ...
    public static final TokenSet RS_INNER_DOC_COMMENTS = RsTokenType.tokenSetOf(
        RsTokenType.INNER_BLOCK_DOC_COMMENT, RsTokenType.INNER_EOL_DOC_COMMENT
    );

    public static final TokenSet RS_OUTER_DOC_COMMENTS = RsTokenType.tokenSetOf(
        RsTokenType.OUTER_BLOCK_DOC_COMMENT, RsTokenType.OUTER_EOL_DOC_COMMENT
    );

    public static final TokenSet RS_DOC_COMMENTS = TokenSet.orSet(RS_INNER_DOC_COMMENTS, RS_OUTER_DOC_COMMENTS);

    public static final TokenSet RS_REGULAR_COMMENTS = RsTokenType.tokenSetOf(
        RsTokenType.BLOCK_COMMENT, RsTokenType.EOL_COMMENT
    );

    public static final TokenSet RS_COMMENTS = TokenSet.orSet(RS_REGULAR_COMMENTS, RS_DOC_COMMENTS);

    public static final TokenSet RS_BLOCK_COMMENTS = RsTokenType.tokenSetOf(
        RsTokenType.BLOCK_COMMENT, RsTokenType.INNER_BLOCK_DOC_COMMENT, RsTokenType.OUTER_BLOCK_DOC_COMMENT
    );

    public static final TokenSet RS_STRING_LITERALS = RsTokenType.tokenSetOf(
        RsElementTypes.STRING_LITERAL, RsElementTypes.BYTE_STRING_LITERAL
    );

    public static final TokenSet RS_RAW_LITERALS = RsTokenType.tokenSetOf(
        RsElementTypes.RAW_STRING_LITERAL, RsElementTypes.RAW_BYTE_STRING_LITERAL, RsElementTypes.RAW_CSTRING_LITERAL
    );

    public static final TokenSet RS_BYTE_STRING_LITERALS = RsTokenType.tokenSetOf(
        RsElementTypes.BYTE_STRING_LITERAL, RsElementTypes.RAW_BYTE_STRING_LITERAL
    );

    public static final TokenSet RS_CSTRING_LITERALS = RsTokenType.tokenSetOf(
        RsElementTypes.CSTRING_LITERAL, RsElementTypes.RAW_CSTRING_LITERAL
    );

    public static final TokenSet RS_ALL_STRING_LITERALS = RsTokenType.tokenSetOf(
        RsElementTypes.STRING_LITERAL, RsElementTypes.BYTE_STRING_LITERAL, RsElementTypes.CSTRING_LITERAL,
        RsElementTypes.RAW_STRING_LITERAL, RsElementTypes.RAW_BYTE_STRING_LITERAL, RsElementTypes.RAW_CSTRING_LITERAL
    );

    public static final TokenSet RS_LITERALS = RsTokenType.tokenSetOf(
        RsElementTypes.STRING_LITERAL, RsElementTypes.BYTE_STRING_LITERAL, RsElementTypes.CSTRING_LITERAL,
        RsElementTypes.RAW_STRING_LITERAL, RsElementTypes.RAW_BYTE_STRING_LITERAL, RsElementTypes.RAW_CSTRING_LITERAL,
    ...
    public static final TokenSet RS_CONTEXTUAL_KEYWORDS = RsTokenType.tokenSetOf(
        RsElementTypes.DEFAULT, RsElementTypes.UNION, RsElementTypes.AUTO, RsElementTypes.DYN, RsElementTypes.RAW
    );

    public static final TokenSet RS_EDITION_2018_KEYWORDS = RsTokenType.tokenSetOf(
        RsElementTypes.ASYNC, RsElementTypes.TRY
    );

    public static final TokenSet RS_LIST_OPEN_SYMBOLS = RsTokenType.tokenSetOf(RsElementTypes.LPAREN, RsElementTypes.LT);
    public static final TokenSet RS_LIST_CLOSE_SYMBOLS = RsTokenType.tokenSetOf(RsElementTypes.RPAREN, RsElementTypes.GT);

    public static final TokenSet RS_BLOCK_LIKE_EXPRESSIONS = RsTokenType.tokenSetOf(
    ...
    public static final TokenSet RS_ITEMS = RsTokenType.tokenSetOf(
    ...
    public static final TokenSet RS_TYPES = RsTokenType.tokenSetOf(
    ...
    public static final TokenSet RS_MOD_OR_FILE = RsTokenType.tokenSetOf(RsElementTypes.MOD_ITEM, RsFileStub.Type);
    ...
    public static final TokenSet RS_IDENTIFIER_TOKENS = TokenSet.orSet(
        RsTokenType.tokenSetOf(RsElementTypes.IDENTIFIER, RsElementTypes.BOOL_LITERAL),
        RS_KEYWORDS
    );
}
