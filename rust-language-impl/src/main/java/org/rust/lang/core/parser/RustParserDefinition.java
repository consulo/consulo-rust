...
import static org.rust.lang.core.psi.impl.RsTokenSets.RS_ALL_STRING_LITERALS;
...
public class RustParserDefinition implements ParserDefinition {
    ...
    public PsiFile createFile(@Nonnull FileViewProvider viewProvider) {
        ...
        for (RsFileCreationExtension extension : Application.get().getExtensionList(RsFileCreationExtension.class)) {
            PsiFile file = extension.createFile(viewProvider, injectionHost);
            if (file != null) {
                return file;
            }
        }
