...
public abstract class MetaVarValue {
    ...
    public static final class Fragment extends MetaVarValue {
        ...
        public Fragment(@Nonnull String value, @Nullable FragmentKind kind, @Nullable IElementType elementType, int offsetInCallBody) {
            myValue = value;
            myKind = kind;
    ...
    public static final class Group extends MetaVarValue {
        ...
        public Group(@Nonnull List<MetaVarValue> nested) {
            myNested = nested;
        }
