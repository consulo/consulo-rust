...
public class RsPsiFactory {
    ...
    public RsRefLikeType createReferenceType(@Nonnull String innerTypeText, @Nonnull Mutability mutability) {
        return (RsRefLikeType) org.rust.lang.core.psi.ext.impl.RsTypeReferenceUtil.skipParens(createType("&" + (mutability.isMut() ? "mut " : "") + innerTypeText));
    }
    ...
    private RsImplItem createImplTemplate(
        ...
        if (typeParameterList != null) {
            List<? extends RsElement> params = org.rust.lang.core.psi.ext.impl.RsTypeParameterListUtil.getGenericParameters(typeParameterList);
    ...
    public RsConstant createConstant(@Nonnull String name, @Nonnull RsExpr expr) {
        Ty exprType = org.rust.lang.core.psi.ext.impl.RsExprUtil.getType(expr);
