...
public class RsFile extends RsFileBase implements RsMod {
    ...
    public RsFile(@Nonnull FileViewProvider fileViewProvider) {
    ...
    private CachedData doGetCachedData() {
        ...
        CargoProject cargoProject = CargoProjectsService.getInstance(getProject()).findProjectForFile(virtualFile);
    ...
    public void inheritCachedDataFrom(@Nonnull RsFile other, boolean isInMemoryMacroExpansion) {
    ...
    public void forceSetStubTree(@Nonnull PsiFileStub<?> stub) {
    ...
    public enum Attributes {
        ...
        public boolean canUseStdlibCrate(@Nonnull String crateName) {
            switch (this) {
                case NONE:
                    return true;
                case NO_STD:
    ...
    @Nullable
    private static FileInclusionPoint pickSingleInclusionPoint(@Nonnull List<FileInclusionPoint> points) {
    ...
    @Nullable
    private static RsFile getInjectedFromIfDoctestInjection(@Nonnull VirtualFile file, @Nonnull Project project) {
    ...
    @Nullable
    public static RsFile from(@Nonnull PsiFile file) {
        return file instanceof RsFile ? (RsFile) file : null;
    }

    public static boolean isRustFile(@Nonnull VirtualFile file) {
        return file.getFileType() == RsFileType.INSTANCE;
    }

    public static boolean isNotRustFile(@Nonnull VirtualFile file) {
        return !isRustFile(file);
    }

    public static boolean shouldIndexFile(@Nonnull Project project, @Nonnull VirtualFile file) {
    ...
    private static final class CachedData {
        ...
        @Nonnull final List<Crate> crates;
