...
public class RsPathReferenceImpl extends RsReferenceBase<RsPath> implements RsPathReference {
    ...
    public RsPathReferenceImpl(@Nonnull RsPath element) {
        super(element);
    }
    ...
    public boolean isReferenceTo(@Nonnull PsiElement target) {
        ...
        if (pathParent instanceof RsPathExpr) {
            if (targetAbstractableOwner != null && targetAbstractableOwner.isImplOrTrait()) {
                ...
                consulo.language.psi.PsiManager mgr = target.getManager();
    ...
    private boolean isReferenceToAssocItem(@Nonnull PsiElement target) {
    ...
    private boolean isReferenceToNonAssocItem(@Nonnull PsiElement target) {
    ...
    private static boolean isAssociatedItemOrEnumVariantPath(@Nonnull RsPath path) {
    ...
    @Nonnull
    @Override
    public PsiElement bindToElement(@Nonnull PsiElement target) {
        if (target instanceof RsMod) {
    ...
    @Nullable
    private PsiElement bindToMod(@Nonnull RsMod target) {
    ...
    @Nullable
    public static RsElement getRootCachingElement(@Nonnull RsPath path) {
    ...
    @Nullable
    private static RsElement getRootCachingElementPsi(@Nonnull RsPath path) {
        RsElement root = null;
    ...
    @Nullable
    private static StubElement<?> getRootCachingElementStub(@Nonnull StubElement<?> path) {
    ...
    private static boolean isStepToParentAllowed(@Nullable IElementType child, @Nonnull IElementType parent) {
    ...
    @Nonnull
    public static List<RsPath> collectNestedPathsFromRoot(@Nonnull RsElement root) {
    ...
    @Nonnull
    private static List<RsPath> collectNestedPathsFromRootPsi(@Nonnull RsElement root) {
    ...
    @Nonnull
    private static List<RsPath> collectNestedPathsFromRootStub(@Nonnull StubElement<?> root) {
    ...
    @Nullable
    private static Object resolveNeighborPathsInternal(@Nonnull RsPath path) {
    ...
    @Nonnull
    @SuppressWarnings("unchecked")
    public static Map<RsPath, List<RsPathResolveResult<RsElement>>> resolveNeighborPaths(@Nonnull RsPath path) {
    ...
    private static List<RsPathResolveResult<RsElement>> resolvePathInternal(
        ...
        @Nonnull RsPath path,
        @Nonnull RsPathResolveKind kind
    ) {
    ...
    @Nullable
    public static RsTypeAlias resolveAssocTypeBinding(@Nonnull RsTraitItem trait, @Nonnull RsAssocTypeBinding binding) {
    ...
    @Nullable
    public static RsElement deepResolve(@Nonnull RsPathReference ref) {
    ...
    /** Resolves a reference through type aliases */
    @Nullable
    public static BoundElement<RsElement> advancedDeepResolve(@Nonnull RsPathReference ref) {
    ...
    @Nullable
    private static BoundElement<RsElement> resolveThroughTypeAliases(@Nonnull BoundElement<RsElement> boundElement) {
    ...
    @Nullable
    public static BoundElement<RsElement> advancedResolveTypeAliasToImpl(@Nonnull RsPathReference ref) {
    ...
    /** @see #tryAdvancedResolveTypeAliasToImpl */
    @Nullable
    public static RsElement tryResolveTypeAliasToImpl(@Nonnull RsPathReference ref) {
        BoundElement<RsElement> result = tryAdvancedResolveTypeAliasToImpl(ref);
    ...
    /** @see #tryAdvancedResolveTypeAliasToImpl */
    @Nullable
    public static RsElement resolveTypeAliasToImpl(@Nonnull RsPathReference ref) {
        RsElement result = tryResolveTypeAliasToImpl(ref);
        return result != null ? result : ref.resolve();
    }

    @Nullable
    private static BoundElement<RsElement> tryAdvancedResolveTypeAliasToImpl(@Nonnull RsPathReference ref) {
        ...
        for (org.rust.lang.core.psi.ext.RsAbstractable m :
             org.rust.lang.core.psi.ext.impl.RsTraitOrImplUtil.getExpandedMembers(impl)) {
