...
public class ObligationForest {
    ...
    public static class Node {
        ...
        public Node(@Nonnull PendingPredicateObligation obligation) {
    ...
    public void registerObligationAt(@Nonnull PendingPredicateObligation obligation, @Nullable Node parent) {
    ...
    public ProcessObligationsResult processObligations(
        @Nonnull Function<PendingPredicateObligation, ProcessPredicateResult> processor,
