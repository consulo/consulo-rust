...
public final class RsBooleanExpUtils {
    ...
    @Nonnull
    public static String negateToString(@Nonnull RsBinaryExpr expr) {
    ...
    public static boolean isNegation(@Nonnull PsiElement element) {
        return element instanceof RsUnaryExpr && ((RsUnaryExpr) element).getExcl() != null;
    }

    @Nonnull
    public static PsiElement negate(@Nonnull PsiElement element) {
