...
public final class ConstExprBuilder {
    ...
    @Nullable
    public static ConstExpr<? extends Ty> toConstExpr(@Nonnull RsExpr expr) {
        return toConstExpr(expr, ExtensionsUtil.getType(expr), PathExprResolver.getDefault());
    }

    @Nullable
    public static ConstExpr<? extends Ty> toConstExpr(@Nonnull RsExpr expr, @Nonnull Ty expectedTy) {
    ...
    private static abstract class BaseBuilder<T extends Ty> {
        ...
        BaseBuilder(@Nonnull T expectedTy, @Nullable PathExprResolver resolver) {
        ...
        @Nullable
        protected ConstExpr<T> makeLeafParameter(@Nonnull RsConstParameter parameter) {
        ...
        @Nullable
        protected abstract ConstExpr<T> makeLeafValue(@Nonnull RsLitExpr expr);

        @Nullable
        private ConstExpr<T> buildPathExpr(@Nonnull RsPathExpr expr, int depth) {
    ...
    private static class IntegerBuilder extends BaseBuilder<TyInteger> {
        IntegerBuilder(@Nonnull TyInteger expectedTy, @Nullable PathExprResolver resolver) {
        ...
        @Nullable
        @Override
        protected ConstExpr<TyInteger> makeLeafValue(@Nonnull RsLitExpr expr) {
    ...
    private static class BoolBuilder extends BaseBuilder<TyBool> {
        ...
        @Nullable
        @Override
        protected ConstExpr<TyBool> makeLeafValue(@Nonnull RsLitExpr expr) {
    ...
    private static class FloatBuilder extends BaseBuilder<TyFloat> {
        FloatBuilder(@Nonnull TyFloat expectedTy, @Nullable PathExprResolver resolver) {
            super(expectedTy, resolver);
        }
        ...
        @Nullable
        @Override
        protected ConstExpr<TyFloat> makeLeafValue(@Nonnull RsLitExpr expr) {
    ...
    private static class CharBuilder extends BaseBuilder<TyChar> {
        ...
        @Nullable
        @Override
        protected ConstExpr<TyChar> makeLeafValue(@Nonnull RsLitExpr expr) {
    ...
    private static class StrBuilder extends BaseBuilder<TyReference> {
        ...
        @Nullable
        @Override
        protected ConstExpr<TyReference> makeLeafValue(@Nonnull RsLitExpr expr) {
