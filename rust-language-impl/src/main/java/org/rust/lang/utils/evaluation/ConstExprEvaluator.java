...
public final class ConstExprEvaluator {
    ...
    @Nonnull
    public static Const evaluate(@Nonnull RsExpr expr) {
    ...
    @Nonnull
    public static Const evaluate(@Nonnull RsExpr expr, @Nonnull Ty expectedTy, @Nullable PathExprResolver resolver) {
    ...
    @Nonnull
    public static Const toConst(@Nonnull RsElement element, @Nonnull Ty expectedTy) {
        return toConst(element, expectedTy, PathExprResolver.getDefault());
    }

    @Nonnull
    public static Const toConst(@Nonnull RsElement element, @Nonnull Ty expectedTy, @Nullable PathExprResolver resolver) {
    ...
    @Nonnull
    private static <T extends Ty> ConstExpr<T> evaluateExpr(@Nonnull ConstExpr<T> expr) {
    ...
    public static <T> T tryEvaluate(@Nonnull TypeFoldable<T> foldable) {
        return foldable.foldWith(new TypeFolder() {
            ...
            @Nonnull
            @Override
            public Const foldConst(@Nonnull Const constValue) {
    ...
    @SuppressWarnings("unchecked")
    @Nonnull
    private static <T extends Ty> ConstExpr<T> simplifyToBool(@Nonnull ConstExpr<T> expr) {
        boolean value;
    ...
    @SuppressWarnings("unchecked")
    @Nonnull
    private static <T extends Ty> ConstExpr<T> simplifyToInteger(@Nonnull ConstExpr<T> expr) {
        Ty expectedTy = expr.getExpectedTy();
    ...
    public static long[] getValidValuesRange(@Nonnull TyInteger ty) {
    ...
    private static boolean isValidValue(long value, @Nonnull TyInteger ty) {
