...
public final class RustcInfo {
    ...
    public RustcInfo(@Nonnull String sysroot, @Nullable RustcVersion version, @Nullable String rustupActiveToolchain, @Nullable List<String> targets, @Nullable RustcVersion realVersion) {
    ...
    public RustcInfo(@Nonnull String sysroot, @Nullable RustcVersion version, @Nullable String rustupActiveToolchain, @Nullable List<String> targets) {
        this(sysroot, version, rustupActiveToolchain, targets, version);
    }

    public RustcInfo(@Nonnull String sysroot, @Nullable RustcVersion version) {
    ...
    public RustcInfo copy(@Nonnull String sysroot, @Nullable RustcVersion version, @Nullable String rustupActiveToolchain, @Nullable List<String> targets, @Nullable RustcVersion realVersion) {
