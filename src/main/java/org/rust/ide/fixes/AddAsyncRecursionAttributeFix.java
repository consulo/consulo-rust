...
public class AddAsyncRecursionAttributeFix extends RsQuickFixBase<RsFunction> {

    public AddAsyncRecursionAttributeFix(@NotNull RsFunction function) {
        super(function);
    }
    ...
    @Nullable
    public static AddAsyncRecursionAttributeFix createIfCompatible(@NotNull RsFunction function) {
        if (!hasAsyncRecursionDependency(function)) return null;
        return new AddAsyncRecursionAttributeFix(function);
    }
