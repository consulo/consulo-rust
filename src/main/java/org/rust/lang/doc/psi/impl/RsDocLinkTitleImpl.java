...
import org.rust.lang.doc.psi.RsDocLinkTitle;

public class RsDocLinkTitleImpl extends RsDocElementImpl implements RsDocLinkTitle {

    public RsDocLinkTitleImpl(@NotNull IElementType type) {
        super(type);
    }
