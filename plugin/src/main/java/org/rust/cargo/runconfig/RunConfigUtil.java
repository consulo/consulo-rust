...
public final class RunConfigUtil {
    ...
    public static void buildProject(@Nonnull Project project) {
        ...
        project.getInstance(consulo.execution.ui.RunContentManager.class);
    ...
    public static DefaultExecutionResult executeCommandLine(
        ...
        Object targetEnvironment = TargetUtil.getTargetEnvironment(runConfiguration);
        ...
        consulo.process.ProcessHandler handler = TargetUtil.startProcess(
        ...
        consulo.execution.ui.console.ConsoleView console = state.getConsoleBuilder().getConsole();
     ...
     */
    public static boolean hasRemoteTarget(@Nonnull RsCommandConfiguration config) {
