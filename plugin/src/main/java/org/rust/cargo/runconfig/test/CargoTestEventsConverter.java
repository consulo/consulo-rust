...
public class CargoTestEventsConverter extends OutputToGeneralTestEventsConverter {
    ...
    @Override
    public boolean processServiceMessages(@Nonnull String text, @Nonnull Key outputType, @Nonnull ServiceMessageVisitor visitor) throws java.text.ParseException {
    ...
    private void handleStartMessage(@Nonnull String text) {
    ...
    private boolean handleTestMessage(
        ...
        @Nonnull ServiceMessageVisitor visitor
    ...
    @Nullable
    private List<ServiceMessageBuilder> createServiceMessagesForTest(@Nonnull LibtestTestMessage testMessage) {
    ...
    @Nonnull
    private List<ServiceMessageBuilder> createServiceMessagesForBench(@Nonnull LibtestBenchMessage benchMessage) {
        List<ServiceMessageBuilder> messages = new ArrayList<>();
    ...
    @Nullable
    private List<ServiceMessageBuilder> createServiceMessagesForSuite(@Nonnull LibtestSuiteMessage suiteMessage) {
        List<ServiceMessageBuilder> messages = new ArrayList<>();
    ...
    private void recordTestStartTime(@Nonnull String test) {
        testsStartTimes.put(test, System.currentTimeMillis());
    }

    private void recordSuiteChildStarted(@Nonnull String node) {
        String parent = getParent(node);
        suitesToNotFinishedChildren.computeIfAbsent(parent, k -> new HashSet<>()).add(node);
    }

    private void recordSuiteChildFinished(@Nonnull String node) {
        String parent = getParent(node);
    ...
    @Nonnull
    private String getTestDuration(@Nonnull String test) {
    ...
    private void processFinishedSuites(@Nonnull List<ServiceMessageBuilder> messages) {
    ...
    private void recursivelyInitContainingSuite(@Nonnull String node, @Nonnull List<ServiceMessageBuilder> messages) {
    ...
    @Nonnull
    private static String getNodeName(@Nonnull String nodeId) {
    ...
    @Nonnull
    private static String getParent(@Nonnull String nodeId) {
    ...
    @Nonnull
    private static ServiceMessageBuilder createTestSuiteStartedMessage(@Nonnull String suite) {
    ...
    @Nonnull
    private static ServiceMessageBuilder createTestSuiteFinishedMessage(@Nonnull String suite) {
        return ServiceMessageBuilder.testSuiteFinished(getNodeName(suite))
            .addAttribute("nodeId", suite);
    }

    @Nonnull
    private static ServiceMessageBuilder createTestStartedMessage(@Nonnull String test) {
    ...
    @Nonnull
    private static ServiceMessageBuilder createTestFailedMessage(@Nonnull String test, @Nonnull String failedMessage, @Nullable SemVer rustcVersion) {
    ...
    @Nonnull
    private static ServiceMessageBuilder createTestFinishedMessage(@Nonnull String test, @Nonnull String duration) {
    ...
    @Nonnull
    private static ServiceMessageBuilder createTestIgnoredMessage(@Nonnull String test) {
        return ServiceMessageBuilder.testIgnored(getNodeName(test))
            .addAttribute("nodeId", test);
    }

    @Nonnull
    private static ServiceMessageBuilder createTestStdOutMessage(@Nonnull String test, @Nonnull String stdout) {
    ...
    @Nonnull
    private static ServiceMessageBuilder createTestCountMessage(@Nonnull String testCount) {
        return new ServiceMessageBuilder("testCount")
            .addAttribute("count", testCount);
    }

    @Nonnull
    private static FailedTestOutput parseFailedTestOutput(@Nonnull String output) {
    ...
    @Nullable
    private static ErrorMessage parseErrorMessage(@Nonnull String failedMessage, @Nullable SemVer rustcVersion) {
    ...
    @Nullable
    private static CargoWorkspace.Target findLibTargetForPackageName(@Nonnull Project project, @Nonnull String packageName) {
    ...
    private static final class FailedTestOutput {
        ...
        @Nonnull final String failedMessage;

        FailedTestOutput(@Nonnull String stdout, @Nonnull String failedMessage) {
            this.stdout = stdout;
    ...
    private static final class ErrorMessage {
        ...
        ErrorMessage(@Nonnull String message, @Nullable DiffResult diff, @Nullable String backtrace) {
    ...
    private static final class DiffResult {
        ...
        DiffResult(@Nonnull String left, @Nonnull String right) {
            this.left = left;
            this.right = right;
        }
    }
    ...
    static final class LibtestSuiteMessage {
        ...
        @Nonnull final String testCount;

        LibtestSuiteMessage(@Nonnull String type, @Nonnull String event, @Nonnull String testCount) {
            this.type = type;
            this.event = event;
        ...
        @Nullable
        static LibtestSuiteMessage fromJson(@Nonnull JsonObject json) {
    ...
    static final class LibtestTestMessage {
        ...
        LibtestTestMessage(@Nonnull String type, @Nonnull String event, @Nonnull String name, @Nullable String stdout) {
            this.type = type;
            this.event = event;
            this.name = name;
            this.stdout = stdout;
        ...
        @Nullable
        static LibtestTestMessage fromJson(@Nonnull JsonObject json) {
            var typePrim = json.getAsJsonPrimitive("type");
    ...
    static final class LibtestBenchMessage {
        @Nonnull final String type;
        @Nonnull final String name;
        @Nonnull final String median;
        @Nonnull final String deviation;

        LibtestBenchMessage(@Nonnull String type, @Nonnull String name, @Nonnull String median, @Nonnull String deviation) {
            this.type = type;
            this.name = name;
            this.median = median;
        ...
        @Nullable
        static LibtestBenchMessage fromJson(@Nonnull JsonObject json) {
            var typePrim = json.getAsJsonPrimitive("type");
