...
public class RsAnsiEscapeDecoder extends AnsiEscapeDecoder {
     ...
     */
    @Nonnull
    public static String quantizeAnsiColors(@Nonnull String text) {
    ...
    @Nullable
    private static Integer parseAttribute(@Nonnull Iterator<String> iterator) {
    ...
    @Nullable
    private static Color parseColor(@Nonnull Iterator<String> rawAttributes) {
    ...
    @Nullable
    private static Color parse24BitColor(@Nonnull Iterator<String> rawAttributes) {
    ...
    @Nullable
    private static Color parse8BitColor(@Nonnull Iterator<String> rawAttributes) {
        Integer attribute = parseAttribute(rawAttributes);
    ...
    @Nullable
    private static Ansi4BitColor getNearestAnsiColor(@Nonnull Color color) {
        Ansi4BitColor[] values = Ansi4BitColor.values();
    ...
    private static int calcEuclideanDistance(@Nonnull Color from, @Nonnull Color to) {
    ...
    private static int getColorAttribute(@Nonnull Ansi4BitColor realAnsiColor, boolean isForeground) {
        ...
        boolean isForcedWhiteFontUnderLightTheme = realAnsiColor == Ansi4BitColor.BRIGHT_WHITE &&
            isForeground && consulo.platform.Platform.current().os().isWindows() && !OpenApiUtil.isUnderDarkTheme();
     ...
     */
    @Nonnull
    public static String removeEscapeSequences(@Nonnull AnsiEscapeDecoder decoder, @Nonnull String text) {
    ...
    private enum Ansi4BitColor {
        ...
        Ansi4BitColor(@Nonnull Color value) {
            myValue = value;
        }
