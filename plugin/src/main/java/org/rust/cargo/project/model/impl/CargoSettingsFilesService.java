...
public final class CargoSettingsFilesService {
    ...
    private void collectCargoProjectSettingsFiles(@Nonnull CargoProject cargoProject, @Nonnull Map<String, SettingFileType> out) {
    ...
    private void collectPackageSettingsFiles(@Nonnull CargoWorkspace.Package pkg, @Nonnull Map<String, SettingFileType> out) {
    ...
    @Nonnull
    public static CargoSettingsFilesService getInstance(@Nonnull Project project) {
    ...
    @Nonnull
    public static Set<VirtualFile> collectImplicitTargets(@Nonnull CargoWorkspace.Package pkg) {
        VirtualFile root = pkg.getContentRoot();
