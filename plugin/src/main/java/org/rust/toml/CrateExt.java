...
public final class CrateExt {
    ...
    @Nullable
    public static TomlFile getTomlFile(@Nonnull Crate crate) {
        if (crate.getCargoTarget() == null) return null;
        return Util.getPackageCargoTomlFile(crate.getCargoTarget().getPkg(), crate.getProject());
    }

    public static void addCargoDependency(@Nonnull Crate crate, @Nonnull String name, @Nonnull String version) {
        addCargoDependency(crate, name, version, Collections.emptyList());
    }

    public static void addCargoDependency(@Nonnull Crate crate, @Nonnull String name, @Nonnull String version, @Nonnull List<String> features) {
    ...
    private static void updateDependencyFeatures(@Nonnull TomlPsiFactory factory,
                                                   @Nonnull TomlKeyValueOwner table,
