...
class CargoTomlKeysCompletionProvider implements CompletionProvider {
    ...
    @Nullable
    private static TomlKeyValueOwner getTopLevelTable(@Nonnull TomlKeySegment key) {
    ...
    @Nullable
    private static String getHeaderOwnerName(@Nonnull TomlHeaderOwner owner) {
