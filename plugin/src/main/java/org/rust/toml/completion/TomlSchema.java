...
public class TomlSchema {
    ...
    private TomlSchema(@Nonnull List<TomlTableSchema> tables) {
        myTables = tables;
    }
    ...
    @Nonnull
    public Collection<String> keysForTable(@Nonnull String tableName) {
    ...
    @Nonnull
    public static TomlSchema parse(@Nonnull Project project, @Nonnull String example) {
    ...
    @Nullable
    private static TomlTableSchema getSchema(@Nonnull TomlKeyValueOwner owner) {
        String name;
        boolean isArray;
    ...
    private static class TomlTableSchema {
        ...
        TomlTableSchema(@Nonnull String name, boolean isArray, @Nonnull Collection<String> keys) {
            myName = name;
            myIsArray = isArray;
            myKeys = keys;
        }
