...
public class CratesLocalIndexServiceImpl implements CratesLocalIndexService, Disposable {
    ...
    @Nonnull
    private <T> RsResult<T, Error> handleErrors(@Nonnull ThrowingFunction<CratesLocalIndexServiceImplInner, T> action) {
        if (isUpdating()) {
    ...
    @Nonnull
    private Error.InternalError onPersistentHashMapError(@Nonnull InnerState.Loaded lastInnerState, @Nonnull IOException e) {
    ...
    public boolean hasInterestingEvent(@Nonnull List<? extends VFileEvent> events) {
        InnerState state = myInnerState;
    ...
    private void updateIndex(@Nonnull CratesLocalIndexServiceImplInner inner) {
    ...
    private void updateTaskFailed(@Nonnull CratesLocalIndexServiceImplInner inner, @Nonnull Error.InternalError err) {
        synchronized (myInnerStateLock) {
    ...
    private static abstract class InnerState {
        ...
        static class Loaded extends InnerState {
            ...
            Loaded(@Nonnull CratesLocalIndexServiceImplInner inner) { myInner = inner; }
        }
        static class Err extends InnerState {
            final Error.InternalError myErr;
            Err(@Nonnull Error.InternalError err) { myErr = err; }
        }
    ...
    static class CratesLocalIndexServiceImplInner {
        ...
        CratesLocalIndexServiceImplInner(@Nonnull Path cargoRegistryIndexPath,
                                          @Nonnull PersistentHashMap<String, CratesLocalIndexService.CargoRegistryCrate> crates,
                                          @Nonnull String cargoRegistryIndexRefsLocation,
                                          @Nullable LocalFileSystem.WatchRequest watchRequest,
                                          @Nonnull Path indexedCommitHashFile,
                                          @Nonnull String indexedCommitHash) {
        ...
        @Nullable
        CratesLocalIndexService.CargoRegistryCrate getCrate(@Nonnull String crateName) throws IOException {
        ...
        void writeCratesUpdate(@Nonnull List<Map.Entry<String, CratesLocalIndexService.CargoRegistryCrate>> updatedCrates,
                               @Nonnull String newHeadHash) throws IOException {
        ...
        Task.Backgroundable createUpdateTask(
            @Nonnull java.util.function.BiConsumer<CratesLocalIndexServiceImplInner, Error.InternalError> onError,
        ...
        static RsResult<CratesLocalIndexServiceImplInner, Error.InternalError> tryCreate(
            @Nonnull Path cargoRegistryIndexPath,
            @Nonnull Path baseCratesLocalRegistryDir) {
            ...
            VirtualFileUtil.processFilesRecursively(cargoRegistryIndexRefsVFile, f -> true);
        ...
        @Nonnull
        private static String readCommitHash(@Nonnull Path indexedCommitHashFile) {
        ...
        private static void writeCommitHash(@Nonnull Path file, @Nonnull String hash) throws IOException {
    ...
    static class CrateExternalizer implements DataExternalizer<CratesLocalIndexService.CargoRegistryCrate> {
        ...
        @Override
        public void save(@Nonnull DataOutput out, @Nonnull CratesLocalIndexService.CargoRegistryCrate value) throws IOException {
        ...
        @Nonnull
        @Override
        public CratesLocalIndexService.CargoRegistryCrate read(@Nonnull DataInput inp) throws IOException {
    ...
    private static class CratesLocalIndexUpdateTask extends Task.Backgroundable {
        ...
        CratesLocalIndexUpdateTask(@Nonnull Path cargoRegistryIndexPath,
                                    @Nonnull java.util.function.Supplier<String> indexedCommitHashGetter,
                                    @Nonnull CratesUpdateWriter writeCratesUpdate,
                                    @Nonnull java.util.function.Consumer<Error.InternalError> onError,
                                    @Nonnull Runnable onFinish) {
        ...
        @Nonnull
        private String readRegistryHeadCommitHash(@Nonnull Repository repository) throws IOException {
        ...
        private List<Map.Entry<String, CratesLocalIndexService.CargoRegistryCrate>> readNewCrates(
            ...
            @Nonnull String newHeadHash,
            @Nonnull String prevHeadHash) throws IOException {
        ...
        @Nullable
        private ObjectId resolveTreeObject(@Nonnull Repository repository, @Nonnull String hash) throws IOException {
            try {
        ...
        @Nonnull
        private static CratesLocalIndexService.CargoRegistryCrateVersion crateFromJson(@Nonnull String json, @Nonnull ObjectMapper mapper) throws IOException {
