...
public final class RsPolyboundUtil {
     ...
     */
    public static boolean getHasQ(@Nonnull RsPolybound polybound) {
     ...
     */
    public static boolean getHasConst(@Nonnull RsPolybound polybound) {
        Object stub = RsPsiJavaUtil.getGreenStub(polybound);
        if (stub instanceof RsPolyboundStub) {
     ...
     */
    public static void deleteWithSurroundingPlus(@Nonnull RsPolybound polybound) {
