...
public final class RsTraitItemUtil {
    ...
    public static Collection<BoundElement<RsTraitItem>> getFlattenHierarchy(
        @Nonnull BoundElement<RsTraitItem> boundTrait,
        @Nullable Ty selfTy
    ) {
    ...
    private static void dfs(
        @Nonnull BoundElement<RsTraitItem> boundTrait,
        @Nullable Ty selfTy,
        @Nonnull List<BoundElement<RsTraitItem>> result,
        @Nonnull Set<RsTraitItem> visited
    ) {
     ...
     */
    @Nonnull
    private static List<BoundElement<RsTraitItem>> getSuperTraits(@Nonnull RsTraitItem trait) {
        List<BoundElement<RsTraitItem>> result = new ArrayList<>();
