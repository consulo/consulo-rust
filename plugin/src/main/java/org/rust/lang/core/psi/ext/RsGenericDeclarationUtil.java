...
public final class RsGenericDeclarationUtil {
     ...
     */
    @Nonnull
    public static List<TraitRef> getBounds(@Nonnull RsGenericDeclaration decl) {
    ...
    @Nonnull
    public static List<Predicate> getPredicates(@Nonnull RsGenericDeclaration decl) {
        return CachedValuesManager.getManager(decl.getProject()).getCachedValue(decl, () -> CachedValueProvider.Result.create(
    ...
    @Nonnull
    private static List<Predicate> doGetPredicates(@Nonnull RsGenericDeclaration decl) {
     ...
     */
    private static void toPredicates(@Nonnull List<RsPolybound> polybounds,
                                     @Nonnull Ty selfTy,
                                     @Nonnull List<PsiPredicate> out) {
    ...
    private abstract static class PsiPredicate {
        ...
        static final class Bound extends PsiPredicate {
            ...
            Bound(@Nonnull Predicate predicate) {
                this.predicate = predicate;
            }
        }

        static final class Unbound extends PsiPredicate {
            @Nonnull final Ty selfTy;

            Unbound(@Nonnull Ty selfTy) {
                this.selfTy = selfTy;
            }
        }
    }
    ...
    @Nonnull
    public static <T extends RsGenericDeclaration> BoundElement<T> withSubst(@Nonnull T decl, @Nonnull Ty... subst) {
        return new BoundElement<>(decl).withSubst(subst);
    }

    @Nonnull
    public static <T extends RsGenericDeclaration> BoundElement<T> withDefaultSubst(@Nonnull T decl) {
