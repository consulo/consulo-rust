...
public final class RsPatRangeUtil {
    ...
    public static boolean isInclusive(@Nonnull RsPatRange range) {
        return range.getDotdotdot() != null || range.getDotdoteq() != null;
    }

    public static boolean isExclusive(@Nonnull RsPatRange range) {
        return range.getDotdot() != null;
    }

    @Nullable
    public static PsiElement getOp(@Nonnull RsPatRange range) {
    ...
    @Nullable
    public static RsPatConst getStart(@Nonnull RsPatRange range) {
    ...
    @Nullable
    public static RsPatConst getEnd(@Nonnull RsPatRange range) {
        PsiElement op = getOp(range);
        if (op == null) return null;
        List<RsPatConst> list = range.getPatConstList();
        if (list.isEmpty()) return null;
