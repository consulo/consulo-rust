...
public abstract class THashMapBase<K, V> extends THashBase<K> implements Map<K, V> {

    @Nullable
    protected abstract V getValueAtIndex(int index);

    protected abstract void setValueAtIndex(int index, @Nonnull V value);
    ...
    protected void rehashTemplate(int newCapacity, @Nonnull MoveValueAction moveValue) {
    ...
    @Override
    public void putAll(@Nonnull Map<? extends K, ? extends V> from) {
