...
public class FlatTree {
    ...
    public FlatTree(
        @Nonnull IntArrayList subtree,
        @Nonnull IntArrayList literal,
        @Nonnull IntArrayList punct,
        @Nonnull IntArrayList ident,
        @Nonnull IntArrayList tokenTree,
    ...
    @Nonnull
    public TokenTree.Subtree toTokenTree(@Nonnull ProMacroExpanderVersion version) {
    ...
    @Nonnull
    public static FlatTree fromSubtree(@Nonnull TokenTree.Subtree root, @Nonnull ProMacroExpanderVersion version) {
    ...
    private static class FlatTreeBuilder {
        ...
        void write(@Nonnull TokenTree.Subtree root) {
            enqueue(root);
        ...
        private void processSubtree(int subtreeId, @Nonnull TokenTree.Subtree sub) {
        ...
        private int enqueue(@Nonnull TokenTree.Subtree sub) {
            int stepSize = myEncodeCloseSpan ? 5 : 4;
        ...
        private int intern(@Nonnull String t) {
