...
public abstract class ArithmeticAssignmentOp extends AssignmentOp implements OverloadableBinaryOperator {
    ...
    @Nonnull @Override public String getTraitName() { return traitName; }
    @Nonnull @Override public String getItemName() { return itemName; }
    @Nonnull @Override public String getFnName() { return itemName; }
