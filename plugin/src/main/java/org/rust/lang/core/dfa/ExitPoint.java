...
public abstract class ExitPoint {
    ...
    public static class Return extends ExitPoint {
        ...
        public Return(@Nonnull RsRetExpr e) {
            this.e = e;
        }
    }
    ...
    public static class TryExpr extends ExitPoint {
        ...
        public TryExpr(@Nonnull RsExpr e) {
            this.e = e;
        }
    }
    ...
    public static class DivergingExpr extends ExitPoint {
        ...
        public DivergingExpr(@Nonnull RsExpr e) {
            this.e = e;
        }
    }
    ...
    public static class TailExpr extends ExitPoint {
        ...
        public TailExpr(@Nonnull RsExpr e) {
            this.e = e;
        }
    }
    ...
    public static class InvalidTailStatement extends ExitPoint {
        ...
        public InvalidTailStatement(@Nonnull RsExprStmt stmt) {
            this.stmt = stmt;
        }
    }

    public static void process(@Nonnull RsFunctionOrLambda fn, @Nonnull Consumer<ExitPoint> sink) {
    ...
    public static void process(@Nonnull RsBlock block, @Nonnull Consumer<ExitPoint> sink) {
        block.acceptChildren(new ExitPointVisitor(sink));
        processBlockTailExprs(block, sink);
    }

    private static void processBlockTailExprs(@Nonnull RsBlock block, @Nonnull Consumer<ExitPoint> sink) {
    ...
    private static void processTailExpr(@Nonnull RsExpr expr, @Nonnull Consumer<ExitPoint> sink) {
        if (expr instanceof RsBlockExpr) {
    ...
    private static void markNeverTypeAsExit(@Nonnull RsExpr expr, @Nonnull Consumer<ExitPoint> sink) {
    ...
    private static class ExitPointVisitor extends RsRecursiveVisitor {
        ...
        ExitPointVisitor(@Nonnull Consumer<ExitPoint> sink) {
            this.sink = sink;
        }
        ...
        @Override
        public void visitFunction(@Nonnull RsFunction function) {
