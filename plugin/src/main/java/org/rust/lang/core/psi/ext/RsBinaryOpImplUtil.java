...
public final class RsBinaryOpImplUtil {
    ...
    @Nonnull
    public static PsiElement getOperator(@Nonnull RsBinaryOp binaryOp) {
    ...
    @Nullable
    private static BinaryOperator operatorTypeFromElementType(@Nonnull IElementType elementType) {
