...
public class TyTypeParameter extends Ty {
    ...
    private TyTypeParameter(@Nonnull TypeParameter parameter) {
    ...
    @Nonnull
    public static TyTypeParameter named(@Nonnull RsTypeParameter parameter) {
        return new TyTypeParameter(new Named(CompletionUtilCore.getOriginalOrSelf(parameter)));
    }
    ...
    @Nonnull
    public static TyTypeParameter self(@Nonnull RsTraitOrImpl traitOrImpl) {
    ...
    public static class Named implements TypeParameter {
        ...
        public Named(@Nonnull RsTypeParameter parameter) {
            myParameter = parameter;
        }
