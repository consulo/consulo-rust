...
public abstract class MacroMatchingError {
    ...
    public static final class UnmatchedToken extends MacroMatchingError {
        ...
        public UnmatchedToken(
            ...
            @Nonnull String expectedTokenType,
            @Nonnull String expectedTokenText,
            @Nonnull String actualTokenType,
            @Nonnull String actualTokenText
        ) {
            super(offsetInCallBody);
    ...
    public static final class FragmentIsNotParsed extends MacroMatchingError {
        ...
        public FragmentIsNotParsed(int offsetInCallBody, @Nonnull String variableName, @Nonnull FragmentKind kind) {
            super(offsetInCallBody);
    ...
    public static final class Nesting extends MacroMatchingError {
        ...
        public Nesting(int offsetInCallBody, @Nonnull String variableName) {
            super(offsetInCallBody);
            myVariableName = variableName;
        }
