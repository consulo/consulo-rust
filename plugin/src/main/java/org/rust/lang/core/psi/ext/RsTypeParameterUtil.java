...
public final class RsTypeParameterUtil {
    ...
    @Nullable
    public static RsGenericDeclaration getOwner(@Nonnull RsTypeParameter param) {
     ...
     */
    @Nonnull
    public static List<RsPolybound> getBounds(@Nonnull RsTypeParameter param) {
    ...
    public static boolean isSized(@Nonnull RsTypeParameter param) {
        RsGenericDeclaration owner = getOwner(param);
        List<RsPolybound> whereBounds = new ArrayList<>();
        if (owner != null) {
            for (RsWherePred pred : RsGenericDeclarationUtil.getWherePreds(owner)) {
