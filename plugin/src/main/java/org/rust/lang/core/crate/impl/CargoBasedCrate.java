...
public class CargoBasedCrate extends UserDataHolderBase implements Crate {
    ...
    public CargoBasedCrate(
        ...
        @Nonnull CargoWorkspace.Target cargoTarget,
        @Nonnull Collection<Crate.Dependency> dependencies,
        @Nonnull LinkedHashSet<Crate> flatDependencies,
    ...
    public void setCyclicDevDeps(@Nonnull List<Dependency> cyclicDevDeps) {
    ...
    public void setCargoProject(@Nonnull CargoProject cargoProject) {
        this.cargoProject = cargoProject;
    }
    ...
    public void setCargoTarget(@Nonnull CargoWorkspace.Target cargoTarget) {
        this.cargoTarget = cargoTarget;
    }
    ...
    public void setFeatures(@Nonnull Map<String, FeatureState> features) {
    ...
    public RsFile getRootMod() {
        ...
        consulo.language.psi.PsiFile psiFile = org.rust.openapiext.OpenApiUtil.toPsiFile(rootModFile, getProject());
    ...
    private static boolean isDoctestable(@Nonnull CargoWorkspace.Target target) {
