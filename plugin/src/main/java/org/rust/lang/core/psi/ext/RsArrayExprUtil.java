...
public final class RsArrayExprUtil {
     ...
     */
    @Nullable
    public static RsExpr getInitializer(@Nonnull RsArrayExpr expr) {
     ...
     */
    @Nullable
    public static RsExpr getSizeExpr(@Nonnull RsArrayExpr expr) {
        if (expr.getSemicolon() != null && expr.getExprList().size() == 2) {
     ...
     */
    @Nullable
    public static List<RsExpr> getArrayElements(@Nonnull RsArrayExpr expr) {
