...
public class RsEscapesLexer extends LexerBaseEx {
    ...
    private RsEscapesLexer(@Nonnull IElementType defaultToken, boolean unicode, boolean eol, boolean extendedByte) {
    ...
    private static boolean charSequenceStartsWith(@Nonnull CharSequence seq, @Nonnull String prefix, int offset) {
     ...
     */
    @Nonnull
    public static RsEscapesLexer of(@Nonnull IElementType tokenType) {
