...
public final class RsInnerAttributeOwnerRegistry {
    ...
    @Nonnull
    public static Stream<RsMetaItem> rawMetaItems(@Nonnull RsDocAndAttributeOwner psi) {
        return allAttrs(psi).map(RsAttr::getMetaItem);
    }

    @Nonnull
    @SuppressWarnings({"unchecked", "rawtypes"})
    public static <S extends StubElement<?> & RsAttributeOwnerStub> Stream<StubElement<?>> allAttrsStub(@Nonnull S stub) {
    ...
    @Nonnull
    public static <S extends StubElement<?> & RsAttributeOwnerStub> Stream<RsMetaItemStub> rawMetaItemsStub(@Nonnull S stub) {
        return allAttrsStub(stub).map(s -> s.findChildStubByType(RsMetaItemStub.Type)).filter(Objects::nonNull);
    }

    @Nonnull
    public static <S extends StubElement<?> & RsAttributeOwnerStub> Stream<RsMetaItemStub> rawOuterMetaItemsStub(@Nonnull S stub) {
    ...
    @Nonnull
    @SuppressWarnings({"unchecked", "rawtypes"})
    private static Stream<StubElement<?>> filterOuterAttrs(@Nonnull List childrenStubs) {
    ...
    private static abstract class AttrInfo {
        ...
        static final class Nested extends AttrInfo {
            ...
            Nested(@Nonnull IElementType elementType) {
