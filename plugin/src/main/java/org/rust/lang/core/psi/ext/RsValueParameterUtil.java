...
public final class RsValueParameterUtil {
    ...
    @Nullable
    public static String getPatText(@Nonnull RsValueParameter param) {
    ...
    @Nonnull
    private static String presentableText(@Nonnull RsPat pat) {
    ...
    @Nonnull
    private static String patFieldPresentableText(@Nonnull RsPatField field) {
