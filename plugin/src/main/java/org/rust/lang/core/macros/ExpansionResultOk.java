...
public class ExpansionResultOk {
    ...
    public ExpansionResultOk(@Nonnull String text, @Nonnull RangeMap ranges, @Nonnull int[] dollarCrateOccurrences) {
        myText = text;
        myRanges = ranges;
        myDollarCrateOccurrences = dollarCrateOccurrences;
    }

    public ExpansionResultOk(@Nonnull String text, @Nonnull RangeMap ranges) {
        myText = text;
        myRanges = ranges;
    ...
    private static int[] findDollarCrateOccurrences(@Nonnull String text) {
