...
public class MacroGraphBuilder {
    ...
    public MacroGraphBuilder(@Nonnull RsMacroDefinitionBase macro) {
        myMacro = macro;
    ...
    @Nonnull
    private Node<MGNodeData, Void> process(@Nonnull Matcher matcher, @Nonnull Node<MGNodeData, Void> pred) {
        myResult = null;
    ...
    @Nonnull
    private Node<MGNodeData, Void> addNode(@Nonnull MGNodeData nodeData, @Nonnull Node<MGNodeData, Void>... preds) {
    ...
    private void addEdge(@Nonnull Node<MGNodeData, Void> source, @Nonnull Node<MGNodeData, Void> target) {
        myGraph.addEdge(source, target, null);
    }

    private void processMatcher(@Nonnull Matcher matcher) {
