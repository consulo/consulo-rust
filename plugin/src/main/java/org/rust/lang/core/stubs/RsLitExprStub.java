...
public final class RsLitExprStub extends RsPlaceholderStub<RsLitExpr> {
    ...
    public RsLitExprStub(@Nullable StubElement parent, @Nonnull IStubElementType elementType, @Nullable RsStubLiteralKind kind) {
    ...
    public static final RsStubElementType<RsLitExprStub, RsLitExpr> Type =
        new RsStubElementType<RsLitExprStub, RsLitExpr>("LIT_EXPR") {
            ...
            @Override
            public void serialize(@Nonnull RsLitExprStub stub, @Nonnull StubOutputStream dataStream) throws IOException {
            ...
            @Nonnull
            @Override
            public RsLitExprStub deserialize(@Nonnull StubInputStream dataStream, StubElement parentStub) throws IOException {
            ...
            @Nonnull
            @Override
            public RsLitExpr createPsi(@Nonnull RsLitExprStub stub) {
                return new RsLitExprImpl(stub, this);
            }

            @Nonnull
            @Override
            public RsLitExprStub createStub(@Nonnull RsLitExpr psi, @Nullable StubElement parentStub) {
                RsStubLiteralKind kind = RsLitExprUtil.getStubKind(psi);
                return new RsLitExprStub(parentStub, this, kind);
            }
        };

    private static void serializeKind(@Nonnull StubOutputStream ds, @Nullable RsStubLiteralKind kind) throws IOException {
    ...
    @Nullable
    private static RsStubLiteralKind deserializeKind(@Nonnull StubInputStream ds) throws IOException {
