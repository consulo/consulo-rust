...
public class FlatTreeJsonDeserializer extends RsJacksonDeserializer<FlatTree> {
    ...
    @Nonnull
    @Override
    public FlatTree deserialize(@Nonnull JsonParser parser, @Nonnull DeserializationContext context) throws IOException {
    ...
    private static void readIntArray(@Nonnull JsonParser parser, @Nonnull IntArrayList out) throws IOException {
        while (parser.nextToken() != JsonToken.END_ARRAY) {
