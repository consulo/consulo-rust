...
public class Thir {
    ...
    public Thir(@Nonnull ThirExpr expr, @Nonnull List<ThirParam> params) {
        this.expr = expr;
        this.params = params;
    }
    ...
    @Nonnull
    public static Thir from(@Nonnull RsConstant constant) {
    ...
    @Nonnull
    public static Thir from(@Nonnull RsFunction function) {
    ...
    @Nonnull
    private static List<ThirParam> explicitParams(@Nonnull RsFunction function) {
