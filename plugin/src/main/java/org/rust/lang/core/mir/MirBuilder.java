...
public class MirBuilder {
    ...
    private MirBuilder(
        ...
        @Nonnull MirrorContext mirrorContext,
        boolean checkOverflow,
        @Nonnull MirSpan span,
        int argCount,
        @Nonnull Ty returnTy,
        @Nonnull MirSpan returnSpan
    ) {
    ...
    @Nonnull
    public MirBody buildFunction(@Nonnull Thir thir, @Nonnull RsElement body) {
    ...
    @Nonnull
    public MirBody buildConstant(@Nonnull Thir thir) {
        exprIntoPlace(
            basicBlocks.startBlock().andUnit(),
            thir.getExpr(),
    ...
    private BlockAnd<Void> argsAndBody(
        @Nonnull BlockAnd<?> blockAnd,
        @Nonnull ThirExpr expr,
        @Nonnull List<ThirParam> arguments,
        @Nonnull Scope argumentScope
    ) {
    ...
    @Nonnull
    private BlockAnd<Void> exprIntoPlace(@Nonnull BlockAnd<?> blockAndIn, @Nonnull ThirExpr expr, @Nonnull MirPlace place) {
    ...
    @Nonnull
    public MirPlace temp(@Nonnull Ty ty, @Nonnull MirSpan span) {
        MirLocal temp = localDecls.newLocal(true, ty, outermostSourceInfo(span));
        return new MirPlace(temp);
    }

    @Nonnull
    private MirOperand consumeByCopyOrMove(@Nonnull MirPlace place) {
    ...
    @Nonnull
    private BlockAnd<MirPlace> toReadOnlyPlace(@Nonnull BlockAnd<?> blockAnd, @Nonnull ThirExpr expr) {
    ...
    @Nonnull
    private BlockAnd<MirPlace> toPlace(@Nonnull BlockAnd<?> blockAnd, @Nonnull ThirExpr expr) {
        BlockAnd<PlaceBuilder> result = toPlaceBuilder(blockAnd, expr);
        return new BlockAnd<>(result.getBlock(), result.getElem().toPlace());
    }

    @Nonnull
    private BlockAnd<PlaceBuilder> toReadOnlyPlaceBuilder(@Nonnull BlockAnd<?> blockAnd, @Nonnull ThirExpr expr) {
        return exprToPlace(blockAnd, expr, Mutability.IMMUTABLE, null);
    }

    @Nonnull
    private BlockAnd<PlaceBuilder> toPlaceBuilder(@Nonnull BlockAnd<?> blockAnd, @Nonnull ThirExpr expr) {
    ...
    private BlockAnd<PlaceBuilder> lowerIndexExpression(
        @Nonnull BlockAnd<?> blockAnd,
        @Nonnull ThirExpr base,
        @Nonnull ThirExpr index,
        @Nonnull Mutability mutability,
        @Nullable List<MirLocal> fakeBorrowTemps,
        @Nullable Scope tempLifetime,
        @Nonnull MirSpan span,
        @Nonnull MirSourceInfo sourceInfo
    ) {
    ...
    private MirBasicBlockImpl boundsCheck(
        ...
        @Nonnull PlaceBuilder slice,
        @Nonnull MirLocal index,
        @Nonnull MirSpan span,
        @Nonnull MirSourceInfo sourceInfo
    ) {
    ...
    private void addFakeBorrowsOfBase(@Nonnull MirPlace basePlace) {
    ...
    private MirBasicBlockImpl readFakeBorrows(
        @Nonnull MirBasicBlockImpl block,
        @Nonnull List<MirLocal> fakeBorrowTemps,
        @Nonnull MirSourceInfo sourceInfo
    ) {
    ...
    private BlockAnd<Void> thenElseBreak(
        @Nonnull BlockAnd<?> blockAnd,
        @Nonnull ThirExpr cond,
        @Nullable Scope tempScopeOverride,
        @Nonnull Scope breakScope,
        @Nonnull MirSourceInfo variableSource
    ) {
    ...
    private void breakForElse(@Nonnull MirBasicBlockImpl block, @Nonnull Scope breakScope, @Nonnull MirSourceInfo source) {
    ...
    @Nonnull
    private BlockAnd<PlaceBuilder> lowerScrutinee(@Nonnull BlockAnd<?> blockAnd, @Nonnull ThirExpr scrutinee) {
    ...
    private void lowerMatchTree(
        ...
        @Nonnull List<MirMatch.MirCandidate> candidates
    ) {
    ...
    private BlockAnd<Void> matchExpr(
        ...
        @Nonnull MirSpan span,
        @Nonnull ThirExpr scrutinee,
        @Nonnull List<MirMatch.MirArm> arms
    ) {
    ...
    private BlockAnd<Void> lowerMatchArms(
        @Nonnull MirPlace destination,
        @Nonnull PlaceBuilder scrutineePlaceBuilder,
        @Nonnull MirSpan scrutineeSpan,
        @Nonnull List<Pair<MirMatch.MirArm, MirMatch.MirCandidate>> armCandidates,
        @Nonnull MirSourceInfo outerSourceInfo
    ) {
    ...
    private MirBasicBlockImpl bindPattern(
        @Nonnull MirSourceInfo outerSourceInfo,
        @Nonnull MirMatch.MirCandidate candidate,
        @Nonnull MirSpan scrutineeSpan,
    ...
    private MirBasicBlockImpl bindAndGuardMatchedCandidate(
        @Nonnull MirMatch.MirCandidate candidate,
        @Nonnull List<MirMatch.MirBinding> parentBindings,
        @Nonnull MirSpan scrutineeSpan,
        @Nullable Pair<MirMatch.MirArm, Scope> armMatchScope,
    ...
    private void bindMatchedCandidateForArmBody(
        @Nonnull MirBasicBlockImpl block,
        boolean scheduleDrops,
        @Nonnull List<MirMatch.MirBinding> bindings,
        boolean storagesAlive
    ) {
    ...
    private void matchCandidates(
        @Nonnull MirSpan span,
        @Nonnull MirSpan scrutineeSpan,
        @Nonnull MirBasicBlockImpl startBlock,
        @Nonnull Ref<MirBasicBlockImpl> otherwiseBlock,
        @Nonnull List<MirMatch.MirCandidate> candidates
    ) {
    ...
    private boolean simplifyCandidate(@Nonnull MirMatch.MirCandidate candidate) {
    ...
    private boolean simplifyMatchPair(@Nonnull MirMatch.MirMatchPair matchPair, @Nonnull MirMatch.MirCandidate candidate) {
    ...
    @Nonnull
    private List<MirMatch.MirMatchPair> fieldMatchPairs(@Nonnull PlaceBuilder place, @Nonnull List<ThirFieldPat> subpatterns) {
    ...
    private MirBasicBlockImpl selectMatchedCandidates(
        @Nonnull List<MirMatch.MirCandidate> matchedCandidates,
        @Nonnull MirBasicBlockImpl startBlock
    ) {
    ...
    private void testCandidates(
        @Nonnull MirSpan span,
        @Nonnull MirSpan scrutineeSpan,
        @Nonnull List<MirMatch.MirCandidate> candidates1,
        @Nonnull MirBasicBlockImpl block,
        @Nonnull Ref<MirBasicBlockImpl> otherwiseBlock
    ) {
    ...
    private void performTest(
        ...
        @Nonnull MirSpan scrutineeSpan,
        @Nonnull MirBasicBlockImpl block,
        @Nonnull PlaceBuilder matchPlace,
    ...
    private boolean addVariantsToSwitch(@Nonnull PlaceBuilder matchPlace, @Nonnull MirMatch.MirCandidate candidate, @Nonnull BitSet variants) {
        // Stub - delegated to MirTest infrastructure
        return MirTestUtil.addVariantsToSwitch(matchPlace, candidate, variants);
    }

    @Nullable
    private Integer sortCandidate(@Nonnull PlaceBuilder matchPlace, @Nonnull MirTest test, @Nonnull MirMatch.MirCandidate candidate) {
        return MirTestUtil.sortCandidate(matchPlace, test, candidate);
    }

    @Nonnull
    private BlockAnd<Void> astBlockIntoPlace(@Nonnull BlockAnd<?> blockAnd, @Nonnull ThirBlock block, @Nonnull MirPlace place, @Nonnull MirSpan span) {
    ...
    @Nonnull
    private BlockAnd<Void> astBlockStmtsIntoPlace(@Nonnull BlockAnd<?> blockAndIn, @Nonnull ThirBlock block, @Nonnull MirPlace place, @Nonnull MirSpan span) {
    ...
    @Nonnull
    private BlockAnd<Void> exprIntoPattern(@Nonnull BlockAnd<?> blockAnd, @Nonnull ThirPat pattern, @Nonnull ThirExpr initializer) {
    ...
    private void scheduleDropForBinding(@Nonnull LocalVar variable, @Nonnull MirSpan span) {
    ...
    @Nonnull
    private MirLocal varLocal(@Nonnull LocalVar variable) {
    ...
    private void declareBinding(
        ...
        @Nonnull MirSourceScope visibilityScope,
        @Nonnull Mutability mutability,
        @Nonnull String name,
        @Nonnull ThirBindingMode mode,
        @Nonnull LocalVar variable,
        @Nonnull Ty variableTy,
        @Nullable Pair<MirPlace, MirSpan> matchPlace,
    ...
    private void visitPrimaryBindings(@Nonnull ThirPat pattern, @Nonnull PrimaryBindingVisitor action) {
        if (pattern instanceof ThirPat.Binding) {
            ThirPat.Binding binding = (ThirPat.Binding) pattern;
    ...
    private interface PrimaryBindingVisitor {
        void visit(@Nonnull Mutability mutability, @Nonnull String name, @Nonnull ThirBindingMode mode, @Nonnull LocalVar variable, @Nonnull MirSpan span, @Nonnull Ty ty);
    }

    @Nonnull
    private BlockAnd<MirRvalue> toLocalRvalue(@Nonnull BlockAnd<?> blockAnd, @Nonnull ThirExpr expr) {
        return toRvalue(blockAnd, expr, scopes.topmost());
    }

    @Nonnull
    private BlockAnd<MirOperand> toLocalOperand(@Nonnull BlockAnd<?> blockAnd, @Nonnull ThirExpr expr) {
        return toOperand(blockAnd, expr, scopes.topmost(), NeedsTemporary.Maybe);
    }

    @Nonnull
    private BlockAnd<MirOperand> toLocalCallOperand(@Nonnull BlockAnd<?> blockAnd, @Nonnull ThirExpr expr) {
        return toCallOperand(blockAnd, expr, scopes.topmost());
    }

    @Nonnull
    private BlockAnd<MirOperand> toCallOperand(@Nonnull BlockAnd<?> blockAnd, @Nonnull ThirExpr expr, @Nonnull Scope scope) {
        if (expr instanceof ThirExpr.ScopeExpr) {
            ThirExpr.ScopeExpr scopeExpr = (ThirExpr.ScopeExpr) expr;
    ...
    @Nonnull
    private BlockAnd<MirRvalue> toRvalue(@Nonnull BlockAnd<?> blockAnd, @Nonnull ThirExpr expr, @Nonnull Scope scope) {
        if (expr instanceof ThirExpr.ScopeExpr) {
            ThirExpr.ScopeExpr scopeExpr = (ThirExpr.ScopeExpr) expr;
    ...
    @Nonnull
    private BlockAnd<MirRvalue> buildZeroRepeat(@Nonnull BlockAnd<?> blockAnd, @Nonnull ThirExpr value, @Nullable Scope scope, @Nonnull MirSourceInfo outerSourceInfo) {
    ...
    @Nonnull
    private BlockAnd<Void> statementExpr(@Nonnull BlockAnd<?> blockAnd, @Nonnull ThirExpr expr, @Nullable Scope statementScope) {
        MirSourceInfo source = sourceInfo(expr.getSpan());
        if (expr instanceof ThirExpr.ScopeExpr) {
            ThirExpr.ScopeExpr scopeExpr = (ThirExpr.ScopeExpr) expr;
    ...
    @Nonnull
    private BlockAnd<Void> breakScope(@Nonnull BlockAnd<?> blockAnd, @Nullable ThirExpr value, @Nonnull BreakableTarget target, @Nonnull MirSourceInfo source) {
    ...
    private void pushAssignUnit(@Nonnull MirBasicBlockImpl block, @Nonnull MirPlace place, @Nonnull MirSourceInfo source) {
        block.pushAssign(
            place,
    ...
    private BlockAnd<MirRvalue> buildBinaryOp(
        @Nonnull MirBasicBlockImpl block,
        @Nonnull MirOperand left,
        @Nonnull MirOperand right,
    ...
    private MirBasicBlockImpl assertDivOverflow(
        ...
        @Nonnull MirOperand right,
        @Nonnull Ty ty,
        @Nonnull MirAssertKind assertKind,
        @Nonnull MirSourceInfo source
    ) {
    ...
    private BlockAnd<MirOperand> assertNoNegOverflow(
        @Nonnull BlockAnd<MirOperand> blockAnd,
        @Nonnull ThirExpr.Unary kind,
        @Nonnull Ty type,
        @Nonnull MirSourceInfo source
    ) {
    ...
    @Nonnull
    private <R> BlockAnd<R> inScope(@Nullable Scope scope, @Nonnull Supplier<BlockAnd<R>> body) {
    ...
    @Nonnull
    private BlockAnd<MirBasicBlockImpl> inIfThenScope(@Nonnull Scope scope, @Nonnull MirSpan source, @Nonnull Supplier<BlockAnd<?>> body) {
    ...
    private <R> BlockAnd<R> inBreakableScope(
        ...
        @Nonnull MirSpan span,
        @Nonnull Supplier<BlockAnd<R>> action
    ) {
    ...
    private BlockAnd<Void> buildExitTree(
        @Nonnull DropTree drops,
        @Nonnull Scope elseScope,
        @Nonnull MirSpan source,
    ...
    private void pushScope(@Nonnull Scope regionScope) {
        scopes.push(new MirScope(sourceScopes.getSourceScope(), regionScope));
    }

    @Nonnull
    private <T> BlockAnd<T> popScope(@Nonnull BlockAnd<T> blockAnd) {
    ...
    @Nonnull
    private <T> BlockAnd<T> buildDrops(@Nonnull BlockAnd<T> blockAnd, @Nonnull MirScope scope) {
    ...
    private void divergeFrom(@Nonnull MirBasicBlockImpl block) {
    ...
    @Nonnull
    private DropTree.DropNode divergeCleanup(@Nonnull Scope target) {
    ...
    private BlockAnd<MirOperand> toOperand(
        ...
        @Nonnull NeedsTemporary needsTemporary
    ) {
        if (expr instanceof ThirExpr.ScopeExpr) {
            ThirExpr.ScopeExpr scopeExpr = (ThirExpr.ScopeExpr) expr;
    ...
    @Nonnull
    private BlockAnd<MirLocal> toTemp(@Nonnull BlockAnd<?> blockAnd, @Nonnull ThirExpr expr, @Nullable Scope tempLifetime, @Nonnull Mutability mutability) {
        if (expr instanceof ThirExpr.ScopeExpr) {
            ThirExpr.ScopeExpr scopeExpr = (ThirExpr.ScopeExpr) expr;
    ...
    private void scheduleDrop(@Nonnull Scope regionScope, @Nonnull MirLocal local, @Nonnull Drop.Kind dropKind) {
        boolean needsDrop;
    ...
    @Nonnull
    private MirConstant toConstant(@Nonnull ThirExpr expr) {
    ...
    @Nonnull
    private MirConstant toConstant(boolean bool, @Nonnull Ty ty, @Nonnull MirSpan source) {
        return toConstant(bool ? 1L : 0L, ty, source);
    }

    @Nonnull
    private MirConstant toConstant(long value, @Nonnull Ty ty, @Nonnull MirSpan source) {
    ...
    @Nonnull
    private MirSourceInfo outermostSourceInfo(@Nonnull MirSpan span) {
        return new MirSourceInfo(span, sourceScopes.getOutermost());
    }

    @Nonnull
    public MirSourceInfo sourceInfo(@Nonnull MirSpan span) {
        return new MirSourceInfo(span, sourceScopes.getSourceScope());
    }

    private boolean isLet(@Nonnull ThirExpr expr) {
    ...
    @Nonnull
    public static MirBody build(@Nonnull RsConstant constant) {
    ...
    @Nonnull
    public static MirBody build(@Nonnull RsFunction function) {
        MirSpan returnSpan;
