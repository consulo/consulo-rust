...
public final class FileModificationTracker {
    ...
    public interface Writeable {
        void writeTo(@Nonnull DataOutput data);
    }
     ...
     */
    public static long getModificationStampForResolve(@Nonnull RsFile file) {
     ...
     */
    public static boolean isFileChanged(@Nonnull RsFile file, @Nonnull CrateDefMap defMap, @Nonnull Crate crate) {
     ...
     */
    @Nonnull
    private static HashCode calculateModHash(@Nonnull ModDataLight modData, @Nullable RsFile.Attributes stdlibAttributes) {
    ...
    private static void writeElements(@Nonnull DataOutput data, @Nonnull List<? extends Writeable> elements) throws java.io.IOException {
    ...
    private static void writeItemLights(@Nonnull DataOutput data, @Nonnull List<ItemLight> items) throws java.io.IOException {
    ...
    private static void writeEnumLights(@Nonnull DataOutput data, @Nonnull List<EnumLight> enums) throws java.io.IOException {
    ...
    private static void writeImportLights(@Nonnull DataOutput data, @Nonnull List<ImportLight> imports) throws java.io.IOException {
    ...
    private static void writeMacro2DefLights(@Nonnull DataOutput data, @Nonnull List<Macro2DefLight> defs) throws java.io.IOException {
    ...
    private static void writeCount(@Nonnull DataOutput data, int count) throws java.io.IOException {
    ...
    static class ModDataLight {
        @Nonnull final List<ItemLight> items = new ArrayList<>();
        @Nonnull final List<EnumLight> enums = new ArrayList<>();
        @Nonnull final List<ImportLight> imports = new ArrayList<>();
        @Nonnull final List<MacroCallLight> macroCalls = new ArrayList<>();
        @Nonnull final List<ProcMacroCallLight> procMacroCalls = new ArrayList<>();
        @Nonnull final List<MacroDefLight> macroDefs = new ArrayList<>();
        @Nonnull final List<Macro2DefLight> macro2Defs = new ArrayList<>();
    ...
    public static class HashCalculator {
        ...
        public void onCollectMod(@Nonnull String fileRelativePath, @Nonnull HashCode hash) {
        ...
        private static class ModHash {
            @Nonnull final String fileRelativePath;
            @Nonnull final HashCode hash;

            ModHash(@Nonnull String fileRelativePath, @Nonnull HashCode hash) {
    ...
    private static class ModLightCollector implements ModVisitor {
        ...
        @Nonnull private final HashCalculator hashCalculator;
        @Nonnull private final String fileRelativePath;
        private final boolean collectChildModules;
        @Nullable private final RsFile.Attributes stdlibAttributes;
        @Nonnull final ModDataLight modData = new ModDataLight();

        ModLightCollector(
            @Nonnull Crate crate,
            @Nonnull HashCalculator hashCalculator,
            @Nonnull String fileRelativePath,
        ...
        @Override
        public void collectSimpleItem(@Nonnull SimpleItemLight item) {
            modData.items.add(item);
        }

        @Override
        public void collectModOrEnumItem(@Nonnull ModOrEnumItemLight item, @Nonnull RsNamedStub stub) {
        ...
        private void collectEnum(@Nonnull ModOrEnumItemLight enumItem, @Nonnull RsEnumItemStub enumStub) {
        ...
        @Override
        public void collectImport(@Nonnull ImportLight importItem) {
            modData.imports.add(importItem);
        }

        @Override
        public void collectMacroCall(@Nonnull MacroCallLight call, @Nonnull RsMacroCallStub stub) {
            modData.macroCalls.add(call);
        }

        @Override
        public void collectProcMacroCall(@Nonnull ProcMacroCallLight call) {
            modData.procMacroCalls.add(call);
        }

        @Override
        public void collectMacroDef(@Nonnull MacroDefLight def) {
            modData.macroDefs.add(def);
        }

        @Override
        public void collectMacro2Def(@Nonnull Macro2DefLight def) {
        ...
        private void collectMod(@Nonnull RsModItemStub mod, @Nonnull String modName, boolean isDeeplyEnabledByCfg) {
    ...
    private static class EnumVariantLight implements Writeable {
        ...
        EnumVariantLight(@Nonnull String name, boolean isDeeplyEnabledByCfg, boolean hasBlockFields) {
            this.name = name;
        ...
        @Override
        public void writeTo(@Nonnull DataOutput data) {
            try {
    ...
    private static class EnumLight implements Writeable {
        @Nonnull final ModOrEnumItemLight item;
        @Nonnull final List<EnumVariantLight> variants;

        EnumLight(@Nonnull ModOrEnumItemLight item, @Nonnull List<EnumVariantLight> variants) {
            this.item = item;
