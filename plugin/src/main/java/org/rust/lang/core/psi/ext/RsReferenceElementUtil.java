...
public final class RsReferenceElementUtil {
     ...
     */
    @Nullable
    public static String getReferenceName(@Nonnull RsReferenceElementBase element) {
     ...
     */
    @Nonnull
    public static String getMandatoryReferenceName(@Nonnull RsMandatoryReferenceElement element) {
