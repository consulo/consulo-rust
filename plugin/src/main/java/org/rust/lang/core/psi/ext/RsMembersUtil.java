...
public final class RsMembersUtil {
     ...
     */
    @Nonnull
    public static List<RsAbstractable> getExpandedMembers(@Nonnull RsMembers members) {
    ...
    private static List<PsiElement> reversedChildren(@Nonnull RsMembers members) {
    ...
    @Nonnull
    public static List<RsFunction> getFunctions(@Nonnull List<RsAbstractable> members) {
    ...
    @Nonnull
    public static List<RsConstant> getConstants(@Nonnull List<RsAbstractable> members) {
    ...
    @Nonnull
    public static List<RsTypeAlias> getTypes(@Nonnull List<RsAbstractable> members) {
