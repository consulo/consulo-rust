...
public final class RsQualifiedNamedElementUtil {
     ...
     */
    @Nullable
    public static String getQualifiedName(@Nonnull RsQualifiedNamedElement element) {
     ...
     */
    @Nullable
    public static String qualifiedNameInCrate(@Nonnull RsQualifiedNamedElement element, @Nonnull RsElement context) {
    ...
    @Nonnull
    public static String convertPathToRelativeIfPossible(@Nonnull RsMod context, @Nonnull String absolutePath) {
