...
public class Borrows implements GenKillAnalysis {
    ...
    public Borrows(
        ...
        @Nonnull Map<MirLocation, List<BorrowData>> borrowsOutOfScopeAtLocation
    ) {
    ...
    @Override
    public void applyBeforeStatementEffect(@Nonnull BitSet state, @Nonnull MirStatement statement, @Nonnull MirLocation location) {
    ...
    @Override
    public void applyBeforeTerminatorEffect(@Nonnull BitSet state, @Nonnull MirTerminator<MirBasicBlock> terminator, @Nonnull MirLocation location) {
        killLoansOutOfScopeAtLocation(state, location);
    }
     ...
     */
    private void killLoansOutOfScopeAtLocation(@Nonnull BitSet state, @Nonnull MirLocation location) {
    ...
    private void killBorrowsOnPlace(@Nonnull BitSet state, @Nonnull MirPlace place) {
