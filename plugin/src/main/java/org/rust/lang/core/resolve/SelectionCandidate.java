...
public abstract class SelectionCandidate {
    ...
    public boolean isEquivalentTo(@Nonnull SelectionCandidate other) {
    ...
    public static final class ParamCandidate extends SelectionCandidate {
        ...
        public ParamCandidate(@Nonnull BoundElement<RsTraitItem> bound) {
            this.bound = bound;
        }
    ...
    public static abstract class ImplCandidate extends SelectionCandidate {
        ...
        public static final class ExplicitImpl extends ImplCandidate {
            ...
            public ExplicitImpl(
                ...
                @Nonnull BoundElement<RsTraitItem> formalTrait,
            ...
            public Triple<Substitution, TraitRef, List<Obligation>> prepareSubstAndTraitRef(
                @Nonnull RsInferenceContext ctx,
                int recursionDepth
            ) {
        ...
        public static final class DerivedTrait extends ImplCandidate {
            ...
            public DerivedTrait(@Nonnull RsTraitItem item) {
                this.item = item;
            }
    ...
    public static final class ProjectionCandidate extends SelectionCandidate {
        ...
        public ProjectionCandidate(@Nonnull BoundElement<RsTraitItem> bound) {
            this.bound = bound;
        }
    ...
    public static final class Triple<A, B, C> {
        ...
        @Nonnull private final C third;

        public Triple(@Nonnull A first, @Nonnull B second, @Nonnull C third) {
            this.first = first;
            this.second = second;
            this.third = third;
        }
