...
public abstract class RsResult<T, E> {
    ...
    @Nonnull
    public abstract <U> RsResult<U, E> map(@Nonnull Function<T, U> mapper);

    @Nonnull
    public abstract <U> RsResult<T, U> mapErr(@Nonnull Function<E, U> mapper);

    @Nonnull
    public abstract T unwrap();

    @Nonnull
    public abstract <U> RsResult<U, E> andThen(@Nonnull Function<T, RsResult<U, E>> action);

    @Nonnull
    public abstract T unwrapOrElse(@Nonnull Function<E, T> op);

    public static final class Ok<T, E> extends RsResult<T, E> {
        private final T myOk;

        public Ok(@Nonnull T ok) {
            this.myOk = ok;
        }
        ...
        @Nonnull
        @Override
        public <U> RsResult<U, E> map(@Nonnull Function<T, U> mapper) {
        ...
        public <U> RsResult<T, U> mapErr(@Nonnull Function<E, U> mapper) {
        ...
        @Nonnull
        @Override
        public <U> RsResult<U, E> andThen(@Nonnull Function<T, RsResult<U, E>> action) {
            return action.apply(myOk);
        }

        @Nonnull
        @Override
        public T unwrapOrElse(@Nonnull Function<E, T> op) {
            return myOk;
        }
     ...
     */
    public static <T, E> T unwrapOrThrow(@Nonnull RsResult<T, E> result) {
