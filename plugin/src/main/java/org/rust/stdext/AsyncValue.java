...
public class AsyncValue<T> {
    ...
    public AsyncValue(@Nonnull T initial) {
    ...
    @Nonnull
    public CompletableFuture<T> updateAsync(@Nonnull Function<T, CompletableFuture<T>> updater) {
    ...
    @Nonnull
    public CompletableFuture<T> updateSync(@Nonnull Function<T, T> updater) {
