...
public class RsConsoleCodeFragmentContext {
    ...
    private void addItemsNamesFromPrelude(@Nonnull RsReplCodeFragment codeFragment) {
    ...
    public void updateContextAsync(@Nonnull Project project, @Nonnull RsReplCodeFragment codeFragment) {
    ...
    public void updateContext(@Nonnull Project project, @Nonnull RsReplCodeFragment codeFragment) {
    ...
    @Nonnull
    public static RsBlock createContext(@Nonnull Project project, @Nullable RsFile originalCrateRoot, @Nonnull List<String> commands) {
    ...
    @Nonnull
    public static RsBlock createContext(@Nonnull Project project, @Nullable RsFile originalCrateRoot) {
        return createContext(project, originalCrateRoot, Collections.singletonList(""));
    }

    @Nullable
    private static RsFile findAnyCrateRoot(@Nonnull Project project) {
