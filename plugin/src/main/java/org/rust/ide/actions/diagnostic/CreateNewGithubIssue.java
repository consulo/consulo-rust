...
public class CreateNewGithubIssue extends LegacyDumbAwareAction {
    ...
    public void actionPerformed(AnActionEvent e) {
        ...
        String os = consulo.application.util.SystemInfo.OS_NAME + " " + consulo.application.util.SystemInfo.OS_VERSION;
    ...
    private static String getIdeNameAndVersion() {
        Application appInfo = Application.get();
        String appName = appInfo.getName().get();
        String editionName = ApplicationNamesInfo.getInstance().getEditionName();
        String ideVersion = appInfo.getBuildNumber().toString();
        StringBuilder sb = new StringBuilder();
        sb.append(appName);
        if (editionName != null) {
