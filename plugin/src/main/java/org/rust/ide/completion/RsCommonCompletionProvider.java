...
import org.rust.lang.core.completion.RsImportLookupElement;
...
import org.rust.lang.core.completion.ScopedBaseCompletionEntity;
...
public class RsCommonCompletionProvider extends RsCompletionProvider {
    ...
    private static ImportCandidate findTraitImportCandidate(RsMethodOrField methodOrField, MethodResolveVariant resolveVariant) {
        ...
        PsiElement original = consulo.language.editor.completion.CompletionUtilCore.getOriginalElement(ancestor);
