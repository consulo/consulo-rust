...
public class AddAsyncRecursionAttributeFix extends RsQuickFixBase<RsFunction> {
    ...
    public AddAsyncRecursionAttributeFix(@Nonnull RsFunction function) {
        super(function);
    }
    ...
    @Nullable
    public static AddAsyncRecursionAttributeFix createIfCompatible(@Nonnull RsFunction function) {
