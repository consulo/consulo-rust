...
public class AddDefinitionToTraitFix extends RsQuickFixBase<RsAbstractable> {
    ...
    public AddDefinitionToTraitFix(@Nonnull RsAbstractable member) {
        super(member);
    }
    ...
    public consulo.localize.LocalizeValue getText() {
        return consulo.localize.LocalizeValue.of(RsBundle.message("intention.name.add.definition.to.trait"));
    }
    ...
    @Override
    public void invoke(@Nonnull Project project, @Nullable Editor editor, @Nonnull RsAbstractable element) {
    ...
    @Nullable
    private static RsAbstractable findAnchor(@Nonnull RsImplItem impl, @Nonnull RsTraitItem trait, @Nonnull RsAbstractable member) {
    ...
    @Nullable
    public static AddDefinitionToTraitFix createIfCompatible(@Nonnull RsAbstractable member) {
    ...
    private static boolean checkTraitRef(@Nonnull RsTraitRef traitRef) {
    ...
    private static boolean checkMember(@Nonnull RsAbstractable member) {
        if (member instanceof RsTypeAlias) return true;

        java.util.List<consulo.language.psi.PsiElement> elementsToCheck;
    ...
    private static boolean isGeneric(@Nonnull RsPath path) {
