...
public class ReplaceIncDecOperatorFix extends RsQuickFixBase<PsiElement> {
    ...
    private ReplaceIncDecOperatorFix(@Nonnull PsiElement operator, @Nonnull String replacement) {
        super(operator);
    ...
    public consulo.localize.LocalizeValue getText() {
        return consulo.localize.LocalizeValue.of(RsBundle.message("intention.name.replace.inc.dec.operator", replacement));
    }
    ...
    @Nullable
    public static ReplaceIncDecOperatorFix create(@Nonnull PsiElement operator) {
