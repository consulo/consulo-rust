...
public class ChangeRefToMutableFix extends RsQuickFixBase<RsUnaryExpr> {
    ...
    public ChangeRefToMutableFix(@Nonnull RsUnaryExpr expr) {
        super(expr);
    }
    ...
    public consulo.localize.LocalizeValue getText() {
        return consulo.localize.LocalizeValue.of(RsBundle.message("intention.name.change.reference.to.mutable"));
    }
