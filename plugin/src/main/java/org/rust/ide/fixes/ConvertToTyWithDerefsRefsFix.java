...
public class ConvertToTyWithDerefsRefsFix extends ConvertToTyFix {
    ...
    public ConvertToTyWithDerefsRefsFix(@Nonnull RsExpr expr, @Nonnull Ty ty, @Nonnull DerefRefPath path) {
    ...
    private static String formatRefs(@Nonnull DerefRefPath path) {
    ...
    public static class DerefRefPath {
        ...
        public DerefRefPath(int derefs, @Nonnull List<Mutability> refs) {
            this.derefs = derefs;
            this.refs = refs;
        }
