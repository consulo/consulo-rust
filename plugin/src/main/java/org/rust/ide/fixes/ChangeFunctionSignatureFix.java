...
public class ChangeFunctionSignatureFix extends RsQuickFixBase<RsValueArgumentList> implements PriorityAction {
    ...
    private ChangeFunctionSignatureFix(
        @Nonnull RsValueArgumentList argumentList,
    ...
    @Nonnull
        ...
        return consulo.localize.LocalizeValue.of(RsBundle.message("intention.family.name.change.function.signature"));
    }
    ...
    public static List<ChangeFunctionSignatureFix> createIfCompatible(
        @Nonnull RsValueArgumentList arguments,
        @Nonnull RsFunction function
    ) {
    ...
    private static String formatParameter(@Nonnull RsPat pat, int index) {
    ...
    private static String suggestName(@Nonnull RsExpr expr) {
    ...
    private static String generateName(@Nonnull String defaultName, @Nonnull Set<String> usedNames) {
    ...
    private static Signature calculateSignatureWithInsertion(
        @Nonnull RsFunction function,
        @Nonnull RsValueArgumentList argumentList,
        @Nonnull ArgumentScanDirection direction
    ) {
    ...
    private static Signature calculateSignatureWithoutInsertion(
        @Nonnull RsFunction function,
        @Nonnull RsValueArgumentList args,
        @Nonnull Set<PsiElement> errorArguments
    ) {
        List<SignatureAction> actions = new ArrayList<>();
        List<RsValueParameter> parameters = RsValueParameterListUtil.getValueParameterList(function);
    ...
    private static List<RsExpr> getEffectiveArguments(@Nonnull RsValueArgumentList args, @Nonnull RsFunction function) {
    ...
    private static String renderType(@Nonnull Ty ty) {
        return TypeRendering.renderInsertionSafe(ty);
    }

    private static void getExistingParameterNames(@Nonnull Set<String> usedNames, @Nonnull RsFunction function) {
        RsVisitor visitor = new RsVisitor() {
            @Override
            public void visitPatBinding(@Nonnull RsPatBinding o) {
    ...
    private static class Signature {
        ...
        Signature(@Nonnull List<SignatureAction> actions) {
    ...
    private static boolean isMethod(@Nonnull RsFunction function) {
