...
public class RsModuleNamingInspection extends RsSnakeCaseNamingInspection {
    ...
    public RsVisitor buildVisitor(@Nonnull RsProblemsHolder holder, boolean isOnTheFly) {
        return new RsWithMacrosInspectionVisitor() {
            @Override
            public void visitModDeclItem(@Nonnull RsModDeclItem el) {
    ...
    public consulo.localize.LocalizeValue getDisplayName() {
        return consulo.localize.LocalizeValue.of(org.rust.RsBundle.message("inspection.rs.module.naming.display.name"));
    }
