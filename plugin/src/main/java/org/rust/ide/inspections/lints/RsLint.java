...
public abstract class RsLint {
    ...
    protected RsLint(@Nonnull String id, @Nonnull List<String> groupIds, @Nonnull RsLintLevel defaultLevel) {
        myId = id;
        myGroupIds = groupIds;
        myDefaultLevel = defaultLevel;
    }

    protected RsLint(@Nonnull String id, @Nonnull List<String> groupIds) {
        this(id, groupIds, RsLintLevel.WARN);
    }

    protected RsLint(@Nonnull String id) {
     ...
     */
    @Nonnull
    public RsLintLevel levelFor(@Nonnull PsiElement el) {
    ...
    @Nullable
    public RsLintLevel explicitLevel(@Nonnull PsiElement el) {
    ...
    @Nullable
    private RsLintLevel superModsLevel(@Nonnull PsiElement el) {
        RsMod lastMod = null;
        for (PsiElement context : RsElementExtUtil.getContexts(el)) {
    ...
    private static class RsLintImpl extends RsLint {
        RsLintImpl(@Nonnull String id, @Nonnull List<String> groupIds, @Nonnull RsLintLevel defaultLevel) {
            super(id, groupIds, defaultLevel);
        }

        RsLintImpl(@Nonnull String id, @Nonnull List<String> groupIds) {
            super(id, groupIds);
        }

        RsLintImpl(@Nonnull String id) {
            super(id);
        }
    }
    ...
    public static class ExternalLinterLint extends RsLint {
        public ExternalLinterLint(@Nonnull String id) {
            super(id);
        }
