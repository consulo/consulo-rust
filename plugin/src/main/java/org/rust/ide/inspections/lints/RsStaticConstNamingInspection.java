...
import org.rust.lang.core.psi.ext.impl.RsConstantKind;
...
public class RsStaticConstNamingInspection extends RsUpperCaseNamingInspection {
    ...
    public consulo.localize.LocalizeValue getDisplayName() {
        return consulo.localize.LocalizeValue.of(org.rust.RsBundle.message("inspection.rs.static.const.naming.display.name"));
    }
