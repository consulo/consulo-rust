...
public class RsUnnecessaryQualificationsInspection extends RsLintInspection {
     ...
     */
    @Nullable
    private RsPath getUnnecessarilyQualifiedPath(@Nonnull RsPath path) {
    ...
    private static boolean canBeShortened(@Nonnull RsPath path) {
    ...
    public consulo.localize.LocalizeValue getDisplayName() {
        return consulo.localize.LocalizeValue.of(org.rust.RsBundle.message("inspection.rs.unnecessary.qualifications.display.name"));
    }
