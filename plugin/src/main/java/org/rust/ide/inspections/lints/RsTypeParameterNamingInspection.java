...
public class RsTypeParameterNamingInspection extends RsCamelCaseNamingInspection {
    ...
    public RsVisitor buildVisitor(@Nonnull RsProblemsHolder holder, boolean isOnTheFly) {
        return new RsWithMacrosInspectionVisitor() {
            @Override
            public void visitTypeParameter(@Nonnull RsTypeParameter el) {
    ...
    public consulo.localize.LocalizeValue getDisplayName() {
        return consulo.localize.LocalizeValue.of(org.rust.RsBundle.message("inspection.rs.type.parameter.naming.display.name"));
    }
