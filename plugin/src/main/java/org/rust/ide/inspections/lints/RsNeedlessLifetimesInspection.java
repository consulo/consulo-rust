...
public class RsNeedlessLifetimesInspection extends RsLintInspection {
    ...
    private void registerProblem(@Nonnull RsProblemsHolder holder, @Nonnull RsFunction fn) {
     ...
     */
    private static boolean couldUseElision(@Nonnull RsFunction fn) {
     ...
     */
    public static boolean isRefLike(@Nonnull RsSelfParameter self) {
    ...
    public static boolean hasMissingLifetimes(@Nonnull RsFunction fn) {
    ...
    private static boolean collectLifetimesFromFnSignature(
        ...
        @Nonnull LifetimesCollector inputCollector,
        @Nonnull LifetimesCollector outputCollector
    ) {
    ...
    @Nonnull
    private static Set<ReferenceLifetime> allowedLifetimesFrom(@Nonnull List<RsLifetimeParameter> lifetimeParameters) {
    ...
    private static boolean hasNamedReferenceLifetime(@Nonnull RsBound bound) {
        LifetimesCollector collector = new LifetimesCollector(false);
    ...
    private static final class NamedLifetime extends ReferenceLifetime {
        ...
        NamedLifetime(@Nonnull String name) {
            myName = name;
        }
    ...
    @Nonnull
    private static ReferenceLifetime toReferenceLifetime(@Nonnull LifetimeName name) {
    ...
    private static class LifetimesCollector extends RsRecursiveVisitor {
        ...
        @Override
        public void visitTypeReference(@Nonnull RsTypeReference ref) {
        ...
        @Override
        public void visitTraitType(@Nonnull RsTraitType trait) {
        ...
        @Override
        public void visitLifetime(@Nonnull RsLifetime lifetime) {
        ...
        private boolean processFnPointerOrFnTrait(@Nonnull RsElement element) {
        ...
        private void collectAnonymousLifetimes(@Nonnull RsPath path) {
    ...
    public consulo.localize.LocalizeValue getDisplayName() {
        return consulo.localize.LocalizeValue.of(org.rust.RsBundle.message("inspection.rs.needless.lifetimes.display.name"));
    }
