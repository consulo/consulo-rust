...
import org.rust.openapiext.psi.ProcessElementsWithMacrosUtil;
...
public final class RsPathUsageAnalysis {
    ...
    public static PathUsageMap getPathUsage(@Nonnull RsItemsOwner owner) {
        return CachedValuesManager.getManager(owner.getProject()).getCachedValue(owner, PATH_USAGE_KEY, () -> {
    ...
    @Nonnull
    private static PathUsageMap calculatePathUsages(@Nonnull RsItemsOwner owner) {
    ...
    private static void handleSubtree(@Nonnull PsiElement root, @Nonnull PathUsageMapMutable usage, @Nonnull Crate crate) {
    ...
    private static void handleElement(@Nonnull PsiElement element, @Nonnull PathUsageMapMutable usage) {
    ...
    @Nullable
    private static Set<RsTraitItem> getMethodRequiredTraits(@Nonnull RsMethodCall call) {
    ...
    @Nullable
    private static Set<RsTraitItem> getAssociatedItemRequiredTraits(@Nonnull RsPath path) {
     ...
     */
    private static boolean isTopLevel(@Nonnull RsUseSpeck useSpeck) {
