...
public class RsLiteralOutOfRangeInspection extends RsLocalInspectionTool {
    ...
    public RsVisitor buildVisitor(@Nonnull RsProblemsHolder holder, boolean isOnTheFly) {
        return new RsWithMacrosInspectionVisitor() {
            @Override
            public void visitLitExpr(@Nonnull RsLitExpr expr) {
            ...
            @Nullable
            private LocalQuickFix findQuickFix(@Nonnull RsLitExpr expr, @Nonnull TyInteger currentType, long overflownValue) {
            ...
            @Nullable
            private TyInteger findTypeUpgrade(@Nonnull TyInteger currentType, long overflownValue) {
    ...
    public consulo.localize.LocalizeValue getDisplayName() {
        return consulo.localize.LocalizeValue.of(org.rust.RsBundle.message("inspection.rs.literal.out.of.range.display.name"));
    }
