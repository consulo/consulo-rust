...
public class RsSelfConventionInspection extends RsLintInspection {
    ...
    public RsVisitor buildVisitor(@Nonnull RsProblemsHolder holder, boolean isOnTheFly) {
        return new RsWithMacrosInspectionVisitor() {
            ...
            @Override
            public void visitFunction2(@Nonnull RsFunction m) {
    ...
    @Nonnull
    private static SelfSignature getSelfSignature(@Nonnull RsFunction function) {
    ...
    private static void registerConventionProblem(
        ...
        @Nonnull SelfConvention convention
    ) {
    ...
    public consulo.localize.LocalizeValue getDisplayName() {
        return consulo.localize.LocalizeValue.of(org.rust.RsBundle.message("inspection.rs.self.convention.display.name"));
    }
