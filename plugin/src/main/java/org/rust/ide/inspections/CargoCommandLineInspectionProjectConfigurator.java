...
public class CargoCommandLineInspectionProjectConfigurator implements CommandLineInspectionProjectConfigurator {
    ...
    @Override
    public boolean isApplicable(@Nonnull ConfiguratorContext context) {
        // TODO: find all Cargo.toml in the project
        return Files.exists(context.getProjectPath().resolve(CargoConstants.MANIFEST_FILE));
    }

    @Override
    public void configureEnvironment(@Nonnull ConfiguratorContext context) {
    ...
    @Override
    public void preConfigureProject(@Nonnull Project project, @Nonnull ConfiguratorContext context) {
        RsProjectSettingsServiceUtil.getRustSettings(project).modify(it -> {
        });
    }

    @Override
    public void configureProject(@Nonnull Project project, @Nonnull ConfiguratorContext context) {
