...
public class RsSortImplTraitMembersInspection extends RsLocalInspectionTool {
    ...
    @Nullable
    private static List<RsAbstractable> sortedImplItems(@Nonnull List<RsAbstractable> implItems, @Nonnull List<RsAbstractable> traitItems) {
    ...
    private static Pair<String, IElementType> key(@Nonnull RsAbstractable item) {
    ...
    private static class SortImplTraitMembersFix extends RsQuickFixBase<RsImplItem> {
        ...
        SortImplTraitMembersFix(@Nonnull RsImplItem element) {
            super(element);
        }
        ...
        public consulo.localize.LocalizeValue getText() {
            return consulo.localize.LocalizeValue.of(RsBundle.message("intention.name.apply.same.member.order"));
            }
    ...
    public consulo.localize.LocalizeValue getDisplayName() {
        return consulo.localize.LocalizeValue.of(org.rust.RsBundle.message("inspection.rs.sort.impl.trait.members.display.name"));
    }
