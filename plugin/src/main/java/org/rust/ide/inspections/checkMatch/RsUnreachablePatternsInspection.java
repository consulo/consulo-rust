...
@Override
    ...
    private void checkUnreachablePatterns(@Nonnull RsMatchExpr match, @Nonnull RsProblemsHolder holder) {
        ...
        for (int i = 0; i < matrix.size(); i++) {
            ...
            if (!useful.isUseful()) {
                ...
                consulo.language.editor.inspection.LocalQuickFix fix;
    ...
    public consulo.localize.LocalizeValue getDisplayName() {
        return consulo.localize.LocalizeValue.of(org.rust.RsBundle.message("inspection.rs.unreachable.patterns.display.name"));
    }
