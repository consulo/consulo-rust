...
public class RsLifetimeNamingInspection extends RsSnakeCaseNamingInspection {
    ...
    public RsVisitor buildVisitor(@Nonnull RsProblemsHolder holder, boolean isOnTheFly) {
        return new RsWithMacrosInspectionVisitor() {
            @Override
            public void visitLifetimeParameter(@Nonnull RsLifetimeParameter el) {
    ...
    public consulo.localize.LocalizeValue getDisplayName() {
        return consulo.localize.LocalizeValue.of(org.rust.RsBundle.message("inspection.rs.lifetime.naming.display.name"));
    }
