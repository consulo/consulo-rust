...
public class RsBreadcrumbsInfoProvider implements BreadcrumbsProvider {
    ...
    private interface ElementHandler<T extends RsElement> {
        boolean accepts(@Nonnull PsiElement e);

        @Nonnull
        String elementInfo(@Nonnull T e);
    }

    private static final ElementHandler<RsNamedElement> NAMED_HANDLER = new ElementHandler<>() {
        @Override
        public boolean accepts(@Nonnull PsiElement e) {
        ...
        @Override
        @Nonnull
        public String elementInfo(@Nonnull RsNamedElement e) {
    ...
    private static final ElementHandler<RsImplItem> IMPL_HANDLER = new ElementHandler<>() {
        ...
        @Override
        @Nonnull
        public String elementInfo(@Nonnull RsImplItem e) {
    ...
    private static final ElementHandler<RsBlockExpr> BLOCK_EXPR_HANDLER = new ElementHandler<>() {
        ...
        @Override
        @Nonnull
        public String elementInfo(@Nonnull RsBlockExpr e) {
    ...
    private static final ElementHandler<RsMacroDefinitionBase> MACRO_HANDLER = new ElementHandler<>() {
        ...
        @Override
        @Nonnull
        public String elementInfo(@Nonnull RsMacroDefinitionBase e) {
            String name = e.getName();
            return name != null ? name + "!" : "!";
        }
    };
    ...
    private static final ElementHandler<RsFunction> FUNCTION_HANDLER = new ElementHandler<>() {
        ...
        @Override
        @Nonnull
        public String elementInfo(@Nonnull RsFunction e) {
            String name = e.getName();
            return name != null ? name + "()" : "()";
        }
    };
    ...
    private static final ElementHandler<RsIfExpr> IF_HANDLER = new ElementHandler<>() {
        ...
        @Override
        @Nonnull
        public String elementInfo(@Nonnull RsIfExpr e) {
            StringBuilder sb = new StringBuilder();
            sb.append("if");
    ...
    private static final ElementHandler<RsElseBranch> ELSE_HANDLER = new ElementHandler<>() {
        ...
        @Override
        @Nonnull
        public String elementInfo(@Nonnull RsElseBranch e) {
            return "else";
        }
    };
    ...
    private static final ElementHandler<RsLoopExpr> LOOP_HANDLER = new ElementHandler<>() {
        ...
        @Override
        @Nonnull
        public String elementInfo(@Nonnull RsLoopExpr e) {
            StringBuilder sb = new StringBuilder();
    ...
    private static final ElementHandler<RsForExpr> FOR_HANDLER = new ElementHandler<>() {
        ...
        @Override
        @Nonnull
        public String elementInfo(@Nonnull RsForExpr e) {
            StringBuilder sb = new StringBuilder();
            appendLabelInfo(sb, e.getLabelDecl());
            sb.append("for");
            if (e.getBlock() != null) {
    ...
    private static final ElementHandler<RsWhileExpr> WHILE_HANDLER = new ElementHandler<>() {
        ...
        @Override
        @Nonnull
        public String elementInfo(@Nonnull RsWhileExpr e) {
            StringBuilder sb = new StringBuilder();
            appendLabelInfo(sb, e.getLabelDecl());
            sb.append("while");
            RsCondition condition = e.getCondition();
    ...
    private static final ElementHandler<RsMatchExpr> MATCH_HANDLER = new ElementHandler<>() {
        ...
        @Override
        @Nonnull
        public String elementInfo(@Nonnull RsMatchExpr e) {
            StringBuilder sb = new StringBuilder();
            sb.append("match");
            RsExpr expr = e.getExpr();
            if (expr != null) {
    ...
    private static final ElementHandler<RsMatchArm> MATCH_ARM_HANDLER = new ElementHandler<>() {
        ...
        @Override
        @Nonnull
        public String elementInfo(@Nonnull RsMatchArm e) {
    ...
    private static final ElementHandler<RsLambdaExpr> LAMBDA_HANDLER = new ElementHandler<>() {
        ...
        @Override
        @Nonnull
        public String elementInfo(@Nonnull RsLambdaExpr e) {
    ...
    @Nullable
    private static ElementHandler<RsElement> handler(@Nonnull PsiElement e) {
    ...
    @Override
    public consulo.language.Language[] getLanguages() {
        return LANGUAGES;
    }
    ...
    @Nullable
    public String getBreadcrumb(@Nonnull RsElement e) {
        ElementHandler<RsElement> h = handler(e);
    ...
    private static void appendLabelInfo(@Nonnull StringBuilder sb, @Nullable RsLabelDecl labelDecl) {
        if (labelDecl != null) {
