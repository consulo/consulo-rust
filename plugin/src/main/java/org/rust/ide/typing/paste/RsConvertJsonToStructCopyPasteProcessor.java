...
public class RsConvertJsonToStructCopyPasteProcessor extends CopyPastePostProcessor<TextBlockTransferableData> {
    ...
    public void processTransferableData(
        ...
        String text = String.valueOf(((PotentialJsonTransferableData) value).getText());
        ...
        ApplicationManager.getApplication().runWriteAction(() -> {
            ...
            for (Struct struct : structs) {
                ...
                anchor = inserted;
                insertedItems.add(consulo.language.psi.SmartPointerManager.createPointer(inserted));
            }
        });
