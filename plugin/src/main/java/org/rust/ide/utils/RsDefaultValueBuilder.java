...
import org.rust.lang.core.psi.ext.impl.RsFieldDeclUtil;
...
public class RsDefaultValueBuilder {
    ...
    public RsDefaultValueBuilder(@Nonnull KnownItems items, @Nonnull RsMod mod,
                                 @Nonnull RsPsiFactory psiFactory) {
        this(items, mod, psiFactory, false);
    }

    public RsDefaultValueBuilder(@Nonnull KnownItems items, @Nonnull RsMod mod,
                                 @Nonnull RsPsiFactory psiFactory, boolean recursive) {
        myItems = items;
        myMod = mod;
    ...
    @Nonnull
    private RsExpr buildForSmartPtr(@Nonnull TyAdt ty, @Nonnull Map<String, RsPatBinding> bindings) {
    ...
    @Nonnull
    public RsExpr buildFor(@Nonnull Ty ty, @Nonnull Map<String, RsPatBinding> bindings) {
    ...
    public List<RsStructLiteralField> fillStruct(
        @Nonnull RsStructLiteralBody structLiteral,
        @Nonnull List<RsFieldDecl> declaredFields,
        @Nonnull List<RsFieldDecl> fieldsToAdd,
        @Nonnull Map<String, RsPatBinding> bindings
    ) {
    ...
    @Nullable
    private RsStructLiteralField findLocalBinding(@Nonnull RsFieldDecl fieldDecl,
                                                   @Nonnull Map<String, RsPatBinding> bindings) {
    ...
    private boolean isRefContainer(@Nonnull Ty container, @Nonnull Ty type) {
    ...
    @Nonnull
    private RsExpr buildReference(@Nonnull Ty type, @Nonnull RsExpr expr) {
    ...
    private RsStructLiteralField findPlaceToAdd(
        @Nonnull RsStructLiteralField fieldToAdd,
        @Nonnull List<RsStructLiteralField> existingFields,
        @Nonnull List<RsFieldDecl> declaredFields
    ) {
