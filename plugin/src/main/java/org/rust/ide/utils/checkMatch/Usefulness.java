...
final class Witness {
    ...
    public Witness(@Nonnull List<Pattern> patterns) {
    ...
    @Nonnull
    public Witness pushWildConstructor(@Nonnull Constructor constructor, @Nonnull Ty type) {
    ...
    @Nonnull
    public Witness applyConstructor(@Nonnull Constructor constructor, @Nonnull Ty type) {
