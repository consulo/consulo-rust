...
public final class ExprUtil {
     ...
     */
    @Nullable
    public static Boolean isPure(@Nonnull RsExpr expr) {
     ...
     */
    @Nonnull
    public static RsExpr skipParenExprUp(@Nonnull RsExpr expr) {
        RsExpr element = expr;
     ...
     */
    @Nullable
    public static RsExpr skipParenExprDown(@Nonnull RsCondition condition) {
    ...
    @Nullable
    private static Boolean allMaybe(@Nonnull java.util.List<RsExpr> exprs) {
