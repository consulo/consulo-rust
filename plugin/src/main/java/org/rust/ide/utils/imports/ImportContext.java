...
public class ImportContext {
    ...
    private ImportContext(
        @Nonnull RsModInfo rootInfo,
        @Nonnull RsMod rootMod,
        @Nonnull Type type,
    ...
    @Nullable
    public static ImportContext from(@Nonnull RsPath path, @Nonnull Type type) {
        return from(path, type, PathInfo.from(path, type == Type.COMPLETION));
    }

    @Nullable
    public static ImportContext from(@Nonnull RsPath path) {
        return from(path, Type.AUTO_IMPORT);
    }

    @Nullable
    public static ImportContext from(@Nonnull RsElement context, @Nonnull Type type, @Nullable PathInfo pathInfo) {
    ...
    @Nullable
    public static ImportContext from(@Nonnull RsElement context, @Nonnull Type type) {
        return from(context, type, null);
    }

    @Nullable
    public static ImportContext from(@Nonnull RsElement context) {
    ...
    public static class PathInfo {
        ...
        private PathInfo(
            ...
            @Nonnull Predicate<RsQualifiedNamedElement> namespaceFilter,
        ...
        @Nonnull
        public static PathInfo from(@Nonnull RsPath path, boolean isCompletion) {
        ...
        @Nullable
        private static List<String> getNextSegments(@Nonnull RsPath path) {
    ...
    @Nonnull
    public static RustParserUtil.PathParsingMode getPathParsingMode(@Nonnull RsPath path) {
    ...
    @Nonnull
    private static Predicate<RsQualifiedNamedElement> createNamespaceFilter(@Nonnull RsPath path, boolean isCompletion) {
