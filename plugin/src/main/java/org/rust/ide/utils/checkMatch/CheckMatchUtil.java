...
public final class CheckMatchUtil {
    ...
    @Nullable
    private static List<Pattern> doCheckExhaustive(@Nonnull RsMatchExpr match) {
    ...
    @Nonnull
    public static List<List<Pattern>> calculateMatrix(@Nonnull List<RsMatchArm> arms) {
    ...
    @Nullable
    public static Ty getFirstColumnType(@Nonnull List<List<Pattern>> matrix) {
