...
public class RsExpressionTypeProvider extends ExpressionTypeProvider<PsiElement> {
    ...
    @Nonnull
    @Override
    public List<PsiElement> getExpressionsAt(@Nonnull PsiElement pivot) {
    ...
    @Nonnull
    @Override
    public String getInformationHint(@Nonnull PsiElement element) {
    ...
    @Nonnull
    private TypeAndAdjusted getType(@Nonnull PsiElement element) {
    ...
    @Nonnull
    private TypeAndAdjustments getTypeAndAdjustments(@Nonnull PsiElement element) {
    ...
    @Nonnull
    private String renderTy(@Nonnull Ty ty) {
    ...
    @Nullable
    private static PsiElement wrapExpandedElements(@Nonnull PsiElement element) {
    ...
    private static class TypeAndAdjusted {
        ...
        TypeAndAdjusted(@Nonnull Ty type, @Nullable AdjustedType adjustedType) {
            myType = type;
    ...
    private static class AdjustedType {
        ...
        AdjustedType(@Nonnull Ty derefTy, @Nonnull Ty finalTy) {
            myDerefTy = derefTy;
            myFinalTy = finalTy;
        }
    }
    ...
    private static class TypeAndAdjustments {
        ...
        TypeAndAdjustments(@Nonnull Ty type, @Nonnull List<Adjustment> adjustments) {
            myType = type;
    ...
    private static class MyFakePsiElement extends FakePsiElement {
        ...
        MyFakePsiElement(@Nonnull PsiElement elementInMacroExpansion, @Nonnull TextRange textRangeInMacroCall) {
