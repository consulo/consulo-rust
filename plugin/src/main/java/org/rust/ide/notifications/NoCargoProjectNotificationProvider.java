...
public class NoCargoProjectNotificationProvider extends RsNotificationProvider {
    ...
    @Nonnull
    private RsEditorNotificationPanel createNoCargoProjectsPanel(@Nonnull VirtualFile file) {
        return createAttachCargoProjectPanel(NO_CARGO_PROJECTS, file, RsBundle.message("notification.no.cargo.projects.found"));
    }

    @Nonnull
    private RsEditorNotificationPanel createNoCargoProjectForFilePanel(@Nonnull VirtualFile file) {
    ...
    @Nonnull
    private RsEditorNotificationPanel createAttachCargoProjectPanel(@Nonnull String debugId, @Nonnull VirtualFile file, @Nonnull String message) {
