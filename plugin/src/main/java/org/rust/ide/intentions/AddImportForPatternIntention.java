...
public class AddImportForPatternIntention extends RsElementBaseIntentionAction<AddImportForPatternIntention.Context> {
    ...
    public consulo.localize.LocalizeValue getText() {
        return consulo.localize.LocalizeValue.of(RsBundle.message("intention.name.import"));
        }

    public consulo.localize.LocalizeValue getFamilyName() {
        return consulo.localize.LocalizeValue.of(RsBundle.message("intention.family.name.add.import.for.path.in.pattern"));
        }
    ...
    public Context findApplicableContext(Project project, Editor editor, PsiElement element) {
        ...
        if (!consulo.language.psi.util.PsiTreeUtil.isAncestor(matchArm.getPat(), patIdent, false)) return null;
