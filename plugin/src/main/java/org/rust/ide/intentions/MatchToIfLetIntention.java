...
public class MatchToIfLetIntention extends RsElementBaseIntentionAction<MatchToIfLetIntention.Context> {
    ...
    public consulo.localize.LocalizeValue getText() {
        return consulo.localize.LocalizeValue.of(RsBundle.message("intention.name.convert.match.statement.to.if.let"));
        }
    ...
    public static class Context {
        ...
        public Context(@Nonnull RsMatchExpr match, @Nonnull RsExpr matchTarget, @Nonnull RsMatchBody matchBody) {
            myMatch = match;
