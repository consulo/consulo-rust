...
public abstract class RsElementBaseIntentionAction<Ctx> extends BaseElementAtCaretIntentionAction {
     ...
     */
    @Nullable
    public abstract Ctx findApplicableContext(@Nonnull Project project, @Nonnull Editor editor, @Nonnull PsiElement element);

    public abstract void invoke(@Nonnull Project project, @Nonnull Editor editor, @Nonnull Ctx ctx);
    ...
    @Nullable
    private PsiElement findTargetElement(@Nonnull PsiElement element) {
    ...
    private void invokeInner(@Nonnull Project project, @Nonnull Editor editor, @Nonnull PsiElement element) {
    ...
    @Override
    public final boolean isAvailable(@Nonnull Project project, Editor editor, @Nonnull PsiElement element) {
