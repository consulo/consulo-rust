...
public class MoveTypeConstraintToParameterListIntention extends RsElementBaseIntentionAction<RsWhereClause> {
    ...
    public consulo.localize.LocalizeValue getText() {
        return consulo.localize.LocalizeValue.of(RsBundle.message("intention.name.move.type.constraint.to.parameter.list"));
        }
    ...
    @Nullable
    @Override
    public RsWhereClause findApplicableContext(@Nonnull Project project, @Nonnull Editor editor, @Nonnull PsiElement element) {
    ...
    @Override
    public void invoke(@Nonnull Project project, @Nonnull Editor editor, @Nonnull RsWhereClause ctx) {
    ...
    @Nonnull
    private String typeParameterText(@Nonnull RsTypeParameter param) {
    ...
    @Nonnull
    private String lifetimeParameterText(@Nonnull RsLifetimeParameter param) {
        StringBuilder sb = new StringBuilder();
        sb.append(param.getName());
    ...
    @Nonnull
    private String constParameterText(@Nonnull RsConstParameter param) {
        StringBuilder sb = new StringBuilder();
        sb.append("const ");
        sb.append(param.getName());
        RsTypeReference typeRef = param.getTypeReference();
