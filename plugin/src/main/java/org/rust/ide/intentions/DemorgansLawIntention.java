...
public class DemorgansLawIntention extends RsElementBaseIntentionAction<DemorgansLawIntention.Context> {
    ...
    public consulo.localize.LocalizeValue getFamilyName() {
        return consulo.localize.LocalizeValue.of(RsBundle.message("intention.family.name.demorgan.s.law"));
        }
    ...
    private void setTextForElement(RsBinaryExpr element) {
        ...
        if (opType == LogicOp.AND) {
            setText(consulo.localize.LocalizeValue.of(RsBundle.message("intention.name.demorgan.s.law.replace.with2")));
        } else if (opType == LogicOp.OR) {
            setText(consulo.localize.LocalizeValue.of(RsBundle.message("intention.name.demorgan.s.law.replace.with")));
        } else {
            setText(consulo.localize.LocalizeValue.of(""));
        }
    }
