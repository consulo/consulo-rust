...
public abstract class ChangeVisibilityIntention extends RsElementBaseIntentionAction<ChangeVisibilityIntention.Context> {
    ...
    public consulo.localize.LocalizeValue getFamilyName() {
        return consulo.localize.LocalizeValue.of(RsBundle.message("intention.family.name.change.item.visibility"));
        }
    ...
    public abstract boolean isApplicable(@Nonnull RsVisibilityOwner element);

    public static class Context {
        private final RsVisibilityOwner myElement;

        public Context(@Nonnull RsVisibilityOwner element) {
    ...
    public Context findApplicableContext(@Nonnull Project project, @Nonnull Editor editor, @Nonnull PsiElement element) {
        ...
        setText(consulo.localize.LocalizeValue.of(RsBundle.message("intention.name.make", name, getVisibility())));
    ...
    public static boolean isValidVisibilityOwner(@Nonnull RsVisibilityOwner visible) {
    ...
    public static void makePrivate(@Nonnull RsVisibilityOwner element) {
    ...
    @Nullable
    public static PsiElement findInsertionAnchor(@Nonnull RsVisibilityOwner element) {
    ...
    public static void makePublic(@Nonnull RsVisibilityOwner element, boolean crateRestricted) {
    ...
    @Nullable
    private static PsiElement getAnchor(@Nonnull PsiElement element) {
    ...
    private static boolean isValidPlace(@Nonnull RsVisibilityOwner visibleElement, @Nonnull PsiElement element) {
        PsiElement anchor;
