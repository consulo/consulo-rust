...
public class RemoveCurlyBracesIntention extends RsElementBaseIntentionAction<RemoveCurlyBracesIntention.Context> {
    ...
    public consulo.localize.LocalizeValue getText() {
        return consulo.localize.LocalizeValue.of(RsBundle.message("intention.name.remove.curly.braces"));
        }
    ...
    public static class Context {
        ...
        public Context(@Nonnull RsPath path, @Nonnull RsUseGroup useGroup, @Nonnull String name) {
            myPath = path;
            myUseGroup = useGroup;
            myName = name;
        }
    ...
    @Nullable
    public static Context createContextIfCompatible(@Nonnull RsUseSpeck useSpeck) {
    ...
    public static void removeCurlyBracesFromUseSpeck(@Nonnull Context ctx) {
