...
public class MoveTypeConstraintToWhereClauseIntention extends RsElementBaseIntentionAction<RsTypeParameterList> {
    ...
    public consulo.localize.LocalizeValue getText() {
        return consulo.localize.LocalizeValue.of(RsBundle.message("intention.name.move.type.constraint.to.where.clause"));
        }
    ...
    @Nullable
    @Override
    public RsTypeParameterList findApplicableContext(@Nonnull Project project, @Nonnull Editor editor, @Nonnull PsiElement element) {
    ...
    @Override
    public void invoke(@Nonnull Project project, @Nonnull Editor editor, @Nonnull RsTypeParameterList ctx) {
    ...
    @Nullable
    private static PsiElement addWhereClause(@Nonnull RsGenericDeclaration declaration, @Nonnull RsWhereClause whereClause) {
