...
public final class TypeRendering {
    ...
    @Nonnull
    public static String render(@Nonnull Ty ty) {
    ...
    @Nonnull
    public static String render(@Nonnull Ty ty, boolean includeTypeArguments) {
        return render(ty, null, Integer.MAX_VALUE, "<unknown>", "<anonymous>",
            "'<unknown>", "<unknown>", "{integer}", "{float}",
    ...
    @Nonnull
    public static String render(@Nonnull Ty ty, @Nonnull Set<RsQualifiedNamedElement> useQualifiedName) {
        return render(ty, null, Integer.MAX_VALUE, "<unknown>", "<anonymous>",
            "'<unknown>", "<unknown>", "{integer}", "{float}",
    ...
    @Nonnull
    public static String render(@Nonnull Ty ty, @Nonnull RsElement context, @Nonnull Set<RsQualifiedNamedElement> useQualifiedName) {
    ...
    public static String render(
        ...
        @Nonnull String anonymous,
        @Nonnull String unknownLifetime,
        @Nonnull String unknownConst,
        @Nonnull String integer,
        @Nonnull String floatStr,
        @Nonnull Set<RsQualifiedNamedElement> useQualifiedName,
    ...
    @Nonnull
    public static String renderInsertionSafe(@Nonnull Ty ty) {
    ...
    @Nonnull
    public static String renderInsertionSafe(@Nonnull Ty ty, @Nonnull RsElement context) {
        return renderInsertionSafe(ty, context, Integer.MAX_VALUE,
            Collections.emptySet(), true, false, true, true);
    }

    @Nonnull
    public static String renderInsertionSafe(@Nonnull Ty ty, boolean includeTypeArguments, boolean includeLifetimeArguments) {
        return renderInsertionSafe(ty, null, Integer.MAX_VALUE,
            Collections.emptySet(), includeTypeArguments, includeLifetimeArguments, true, true);
    }

    @Nonnull
    public static String renderInsertionSafe(@Nonnull Ty ty, boolean includeTypeArguments, boolean includeLifetimeArguments, boolean useAliasNames) {
        return renderInsertionSafe(ty, null, Integer.MAX_VALUE,
            Collections.emptySet(), includeTypeArguments, includeLifetimeArguments, useAliasNames, true);
    }

    @Nonnull
    public static String getShortPresentableText(@Nonnull Ty ty) {
        String prev = null;
    ...
    private static final class TypeRenderer {
        ...
        final @Nonnull String anonymous;
        final @Nonnull String unknownLifetime;
        final @Nonnull String unknownConst;
        final @Nonnull String integer;
        final @Nonnull String floatStr;
        final @Nonnull Set<RsQualifiedNamedElement> useQualifiedName;
        ...
        @Nonnull
        String render(@Nonnull Ty ty, int level) {
        ...
        @Nonnull
        private String renderRegion(@Nonnull Region region) {
            return region instanceof ReUnknown ? unknownLifetime : region.toString();
        }

        @Nonnull
        private String renderConst(@Nonnull Const c) {
            return renderConst(c, false);
        }

        @Nonnull
        private String renderConst(@Nonnull Const c, boolean wrapParameterInBraces) {
        ...
        private String formatFnLike(
            @Nonnull String fnType,
            @Nonnull Unsafety unsafety,
            @Nonnull List<Ty> paramTypes,
            @Nonnull Ty retType,
            @Nonnull Function<Ty, String> renderSub
        ) {
            StringBuilder sb = new StringBuilder();
        ...
        @Nonnull
        private String formatTrait(@Nonnull BoundElement<RsTraitItem> trait, @Nonnull Function<Ty, String> renderSub) {
        ...
        @Nonnull
        private String formatAdtGenerics(@Nonnull TyAdt adt, @Nonnull Function<Ty, String> renderSub) {
        ...
        @Nonnull
        private String formatProjectionGenerics(@Nonnull TyProjection projection, @Nonnull Function<Ty, String> renderSub) {
            List<String> visibleTypes = formatGenerics(projection.getTarget().getTypedElement(), projection.getTypeParameterValues(), renderSub);
            return visibleTypes.isEmpty() ? "" : "<" + String.join(", ", visibleTypes) + ">";
        }

        @Nonnull
        private String formatTraitGenerics(@Nonnull BoundElement<RsTraitItem> trait, @Nonnull Function<Ty, String> renderSub) {
            return formatTraitGenerics(trait, renderSub, true);
        }

        @Nonnull
        private String formatTraitGenerics(@Nonnull BoundElement<RsTraitItem> trait, @Nonnull Function<Ty, String> renderSub, boolean includeAssoc) {
            List<String> assoc;
            if (includeAssoc) {
                assoc = new ArrayList<>();
        ...
        private <T extends RsGenericDeclaration & RsNamedElement> String formatBoundElement(
            @Nonnull BoundElement<T> boundElement,
            @Nonnull Function<Ty, String> renderSub
        ) {
        ...
        private List<String> formatBoundElementGenerics(
            @Nonnull BoundElement<? extends RsGenericDeclaration> boundElement,
            @Nonnull Function<Ty, String> renderSub
        ) {
        ...
        @Nullable
        private String getName(@Nonnull RsNamedElement element) {
