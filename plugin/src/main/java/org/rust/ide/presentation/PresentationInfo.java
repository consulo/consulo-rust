...
public class PresentationInfo {
    ...
    public PresentationInfo(@Nonnull RsNamedElement element, @Nullable String type, @Nonnull String name, @Nonnull DeclarationInfo declaration) {
        myType = type;
        myName = name;
    ...
    @Nullable
    public static PresentationInfo getPresentationInfo(@Nonnull RsNamedElement element) {
    ...
    private static DeclarationInfo createDeclarationInfo(
        @Nonnull RsElement decl,
        @Nullable PsiElement name,
        boolean isAmbiguous,
        @Nonnull List<PsiElement> stopAt,
    ...
    private static int offsetIn(@Nonnull PsiElement element, @Nonnull PsiElement owner) {
        int offset = 0;
