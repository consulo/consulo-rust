...
public final class InlineValueUtils {
    ...
    private static boolean isBlockLikeExpr(@Nonnull PsiElement element) {
    ...
    private static boolean requiresSingleExpr(@Nonnull PsiElement element) {
