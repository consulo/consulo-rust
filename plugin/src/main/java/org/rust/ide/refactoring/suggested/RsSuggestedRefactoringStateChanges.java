...
public class RsSuggestedRefactoringStateChanges extends SuggestedRefactoringStateChanges {
    ...
    public RsSuggestedRefactoringStateChanges(@Nonnull RsSuggestedRefactoringSupport support) {
        super(support);
    }

    @Nonnull
    public List<TextRange> parameterMarkerRanges(@Nonnull PsiElement anchor) {
    ...
    @Nullable
    private static PsiElement findChildWithElementType(@Nonnull PsiElement parent, @Nonnull IElementType type) {
