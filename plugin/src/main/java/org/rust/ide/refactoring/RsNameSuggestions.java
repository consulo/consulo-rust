...
public final class RsNameSuggestions {
    ...
    @Nonnull
    public static SuggestedNames suggestedNames(@Nonnull RsExpr expr) {
    ...
    @Nonnull
    public static SuggestedNames suggestedNames(@Nonnull Ty ty, @Nonnull PsiElement context, @Nonnull Set<String> additionalNamesInScope) {
        LinkedHashSet<String> names = suggestedNamesForTy(ty);
        return finalizeNameSelection(context, names, additionalNamesInScope);
    }

    @Nonnull
    public static SuggestedNames suggestedNames(@Nonnull Ty ty, @Nonnull PsiElement context) {
        return suggestedNames(ty, context, Collections.emptySet());
    }

    @Nonnull
    public static String freshenName(@Nonnull String name, @Nonnull Set<String> usedNames) {
    ...
    private static SuggestedNames finalizeNameSelection(
        ...
        @Nonnull LinkedHashSet<String> names,
        @Nonnull Set<String> additionalNamesInScope
    ) {
    ...
    @Nonnull
    private static LinkedHashSet<String> suggestedNamesForTy(@Nonnull Ty ty) {
    ...
    private static void addName(@Nonnull LinkedHashSet<String> names, @org.jetbrains.annotations.Nullable String name) {
    ...
    @Nonnull
    private static List<String> nameForCall(@Nonnull RsCallExpr expr) {
    ...
    @Nonnull
    private static Set<String> findNamesInLocalScope(@Nonnull PsiElement expr) {
