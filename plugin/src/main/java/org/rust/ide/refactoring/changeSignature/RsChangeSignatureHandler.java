...
public class RsChangeSignatureHandler implements ChangeSignatureHandler {
    ...
    @Nullable
    @Override
    public PsiElement findTargetMember(@Nonnull consulo.language.psi.PsiFile file, @Nonnull consulo.codeEditor.Editor editor) {
        PsiElement element = file.findElementAt(editor.getCaretModel().getOffset());
        return element == null ? null : findTargetMember(element);
    }

    @Nullable
    @Override
    public RsFunction findTargetMember(@Nonnull PsiElement element) {
    ...
    private void invokeOnFunction(@Nonnull RsFunction function, @Nullable Editor editor) {
    ...
    private void showRefactoringDialog(@Nonnull RsFunction function, @Nullable Editor editor) {
    ...
    public static boolean isChangeSignatureAvailable(@Nonnull RsFunction function) {
    ...
    @Nullable
    private static String checkFunction(@Nonnull RsFunction function) {
    ...
    @Nullable
    private static RsFunction getSuperMethod(@Nonnull RsFunction function) {
