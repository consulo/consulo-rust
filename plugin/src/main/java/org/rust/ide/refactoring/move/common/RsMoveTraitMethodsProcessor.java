...
public class RsMoveTraitMethodsProcessor {
    ...
    public RsMoveTraitMethodsProcessor(
        ...
        @Nonnull RsMovePathHelper pathHelper
    ) {
    ...
    private void preprocessReferencesToTraitAssocItems(
        @Nonnull List<RsReferenceElement> references,
        @Nonnull MultiMap<PsiElement, consulo.localize.LocalizeValue> conflicts,
        @Nonnull java.util.function.Function<RsTraitItem, String> findTraitUsePath,
        @Nonnull java.util.function.Predicate<RsTraitItem> shouldProcessTrait
    ) {
    ...
    public void addTraitImportsForOutsideReferences(@Nonnull List<ElementToMove> elementsToMove) {
    ...
    private void addTraitImportsForReferences(@Nonnull Collection<RsReferenceElement> references) {
        for (RsReferenceElement reference : references) {
    ...
    @Nonnull
    private static List<RsReferenceElement> getReferencesToTraitAssocItems(@Nonnull List<ElementToMove> elementsToMove) {
    ...
    private static boolean isMethodOrPath(@Nonnull RsReferenceElement element) {
        return element instanceof RsMethodCall || element instanceof RsPath;
    }

    @Nullable
    private static RsTraitItem getTrait(@Nonnull RsAbstractable abstractable) {
