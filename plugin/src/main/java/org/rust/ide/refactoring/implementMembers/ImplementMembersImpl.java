...
public final class ImplementMembersImpl {
    ...
    public static void generateTraitMembers(@Nonnull RsImplItem impl, @Nullable Editor editor) {
    ...
    public static void generateMissingTraitMembers(@Nonnull RsImplItem impl, @Nonnull RsTraitRef traitRef, @Nullable Editor editor) {
    ...
    private static void insertNewTraitMembers(
        @Nonnull Collection<RsAbstractable> selected,
    ...
    @Nullable
    private static PsiElement findAbstractableSibling(@Nonnull PsiElement element, boolean left) {
    ...
    private static void simplifyConstExprs(@Nonnull List<RsAbstractable> insertedMembers) {
    ...
    @Nonnull
    private static PsiElement createExtraWhitespacesAroundFunction(@Nonnull PsiElement left, @Nonnull PsiElement right) {
        int lineCount = 0;
