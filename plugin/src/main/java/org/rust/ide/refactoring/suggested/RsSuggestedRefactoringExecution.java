...
public class RsSuggestedRefactoringExecution extends SuggestedRefactoringExecution {
    ...
    public RsSuggestedRefactoringExecution(@Nonnull RsSuggestedRefactoringSupport support) {
        super(support);
    }

    @Nullable
    @Override
    public Object prepareChangeSignature(@Nonnull SuggestedChangeSignatureData data) {
    ...
    public void performChangeSignature(
        @Nonnull SuggestedChangeSignatureData data,
        @Nonnull List<NewParameterValue> newParameterValues,
