...
public abstract class BaseGenerateHandler implements LanguageCodeInsightActionHandler {
    ...
    @Nullable
    private GenerateContext getContext(@Nonnull Editor editor, @Nonnull PsiFile file) {
    ...
    private void selectMembers(@Nonnull GenerateContext context, @Nonnull Editor editor) {
    ...
    @Nullable
    private static RsImplItem findSiblingImplItem(@Nonnull RsStructItem struct) {
