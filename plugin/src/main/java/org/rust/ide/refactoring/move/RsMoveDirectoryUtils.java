...
public final class RsMoveDirectoryUtils {
    ...
    @Nullable
    public static RsMod getOwningMod(@Nonnull PsiDirectory directory, @Nullable RsMod crateRoot) {
    ...
    @Nullable
    public static RsFile getOwningModAtDefaultLocation(@Nonnull PsiDirectory directory) {
    ...
    @Nullable
    private static RsMod getOwningModWalkingFromCrateRoot(@Nonnull PsiDirectory directory, @Nonnull RsMod crateRoot) {
    ...
    @Nullable
    private static RsMod getOwningModWalkingFromAllCrateRoots(@Nonnull PsiDirectory directory, @Nonnull CargoWorkspace cargoWorkspace) {
