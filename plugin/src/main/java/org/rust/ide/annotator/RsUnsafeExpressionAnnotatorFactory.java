...
/**
 * Registers {@link RsUnsafeExpressionAnnotator}.
 * <p>
 ...
 */
@ExtensionImpl
public class RsUnsafeExpressionAnnotatorFactory implements AnnotatorFactory {

    @Nullable
    @Override
    public Annotator createAnnotator() {
        return new RsUnsafeExpressionAnnotator();
    }
