...
/**
 * Registers {@link RsHighlightingMutableAnnotator}.
 * <p>
 ...
 */
@ExtensionImpl
public class RsHighlightingMutableAnnotatorFactory implements AnnotatorFactory {

    @Nullable
    @Override
    public Annotator createAnnotator() {
        return new RsHighlightingMutableAnnotator();
    }
