...
public enum FormatTraitType {
    ...
    public interface TraitResolver {
        @Nullable
        RsTraitItem resolve(@Nonnull KnownItems knownItems);
    }
    ...
    FormatTraitType(@Nonnull TraitResolver resolver, @Nullable String name1, @Nullable String name2, @Nullable String name3) {
    ...
    @Nullable
    public RsTraitItem resolveTrait(@Nonnull KnownItems knownItems) {
    ...
    @Nullable
    public static FormatTraitType forString(@Nonnull String name) {
