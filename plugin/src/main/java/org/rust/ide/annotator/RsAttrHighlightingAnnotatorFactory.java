...
/**
 * Registers {@link RsAttrHighlightingAnnotator}.
 * <p>
 ...
 */
@ExtensionImpl
public class RsAttrHighlightingAnnotatorFactory implements AnnotatorFactory {

    @Nullable
    @Override
    public Annotator createAnnotator() {
        return new RsAttrHighlightingAnnotator();
    }
