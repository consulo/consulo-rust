...
public class RsAttrErrorAnnotator extends AnnotatorBase {
    ...
    private static void checkDeprecatedAttr(@Nonnull RsMetaItem element, @Nonnull AnnotationHolder holder) {
    ...
    private static void checkRsDocAndAttributeOwner(@Nonnull RsDocAndAttributeOwner element, @Nonnull AnnotationHolder holder) {
    ...
    @Nonnull
    private static RemoveElementFix getFix(@Nonnull RsMetaItem item) {
    ...
    private static void checkLiteralSuffix(@Nonnull RsMetaItem metaItem, @Nonnull AnnotationHolder holder) {
        String name = metaItem.getName();
        if (name == null) return;
    ...
    private static void checkAttrTemplateCompatible(@Nonnull RsMetaItem metaItem, @Nonnull AnnotationHolder holder) {
        String name = metaItem.getName();
        if (name == null) return;
        Object attrInfoObj = BuiltinAttributes.RS_BUILTIN_ATTRIBUTES.get(name);
    ...
    private static void emitMalformedAttribute(@Nonnull RsMetaItem metaItem, @Nonnull String name, @Nonnull AttributeTemplate template, @Nonnull AnnotationHolder holder) {
    ...
    @Nonnull
    private static String setParen(@Nonnull String text) {
    ...
    private static void checkMetaBadDelim(@Nonnull RsMetaItem element, @Nonnull AnnotationHolder holder) {
    ...
    private static void checkFeatureAttribute(@Nonnull RsMetaItem item, @Nonnull RsAnnotationHolder holder, @Nonnull ProcessingContext context) {
    ...
    private static void checkRootCfgPredicate(@Nonnull RsMetaItem element, @Nonnull RsAnnotationHolder holder) {
    ...
    private static void checkCfgPredicate(@Nonnull RsAnnotationHolder holder, @Nonnull RsMetaItem item) {
    ...
    private static void checkDeriveAttr(@Nonnull RsMetaItem element, @Nonnull RsAnnotationHolder holder) {
    ...
    private static void checkReprAttr(@Nonnull RsMetaItem element, @Nonnull RsAnnotationHolder holder, @Nonnull ProcessingContext context) {
        RsMetaItemArgs metaItemArgs = element.getMetaItemArgs();
        if (metaItemArgs == null) return;
    ...
    private static void checkReprArg(@Nonnull RsMetaItem reprArg, @Nonnull RsDocAndAttributeOwner owner, @Nonnull RsAnnotationHolder holder) {
    ...
    private static void checkReprArgIsCorrectlyApplied(@Nonnull String reprName, @Nonnull RsDocAndAttributeOwner owner, @Nonnull RsMetaItem reprArg, @Nonnull RsAnnotationHolder holder) {
        String errorText;
        switch (reprName) {
            case "C":
            case "transparent":
    ...
    private static void checkReprAlign(@Nonnull RsMetaItem align, @Nonnull RsAnnotationHolder holder) {
    ...
    private static void checkReprAlignArgs(@Nonnull List<RsLitExpr> args, @Nonnull RsMetaItem align, @Nonnull RsAnnotationHolder holder) {
        if (args.size() != 1) {
            RsDiagnostic.addToHolder(new RsDiagnostic.IncorrectlyDeclaredAlignRepresentationHint(
                align,
