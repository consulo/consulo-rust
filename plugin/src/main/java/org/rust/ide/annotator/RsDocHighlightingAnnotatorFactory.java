...
/**
 * Registers {@link RsDocHighlightingAnnotator}.
 * <p>
 ...
 */
@ExtensionImpl
public class RsDocHighlightingAnnotatorFactory implements AnnotatorFactory {

    @Nullable
    @Override
    public Annotator createAnnotator() {
        return new RsDocHighlightingAnnotator();
    }
