...
public final class Utils {
    ...
    public static void openFiles(@Nonnull Project project, @Nonnull GeneratedFilesHolder files) {
    ...
    private static RunnerAndConfigurationSettings createCargoRunConfiguration(
        ...
        @Nonnull Project project,
        @Nonnull String cargoProjectName
    ) {
        RunnerAndConfigurationSettings settings =
            runManager.createRunConfiguration("Run", CargoCommandConfigurationType.getInstance().getFactory());
    ...
    private static RunnerAndConfigurationSettings createCargoTestConfiguration(
        ...
        RunnerAndConfigurationSettings settings =
            runManager.createRunConfiguration("Test", CargoCommandConfigurationType.getInstance().getFactory());
        if (settings.getConfiguration() instanceof CargoCommandConfiguration cargoConfig) {
    ...
    private static RunnerAndConfigurationSettings createWasmPackBuildConfiguration(
        ...
        RunnerAndConfigurationSettings settings =
            runManager.createRunConfiguration("Build", WasmPackCommandConfigurationType.getInstance().getFactory());
