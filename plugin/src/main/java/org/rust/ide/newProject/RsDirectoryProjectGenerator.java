...
public class RsDirectoryProjectGenerator extends DirectoryProjectGeneratorBase<ConfigurationData>
    ...
    @Nonnull
    @Override
    public consulo.ui.image.Image getLogo() {
        return RsIcons.RUST;
    }
    ...
    @Nonnull
    @Override
    public ValidationResult validate(@Nonnull String baseDirPath) {
    ...
    public void generateProject(
        ...
        @Nonnull ConfigurationData data,
    ...
    public AbstractActionWithPanel createStep(
        @Nonnull DirectoryProjectGenerator<ConfigurationData> projectGenerator,
        @Nonnull AbstractNewProjectStep.AbstractCallback<ConfigurationData> callback
    ) {
