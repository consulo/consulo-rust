...
public class RsDocumentationProvider extends AbstractDocumentationProvider {
    ...
    public void collectDocComments(@Nonnull PsiFile file, @Nonnull Consumer<? super PsiDocCommentBase> sink) {
    ...
    @SuppressWarnings("UnstableApiUsage")
    @Nullable
    public String generateRenderedDoc(@Nonnull PsiDocCommentBase comment) {
