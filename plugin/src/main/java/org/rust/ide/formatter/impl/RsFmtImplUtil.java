...
public final class RsFmtImplUtil {
    ...
    public static boolean isTopLevelItem(@Nonnull PsiElement element) {
        return (element instanceof RsItemElement || element instanceof RsAttr) && element.getParent() instanceof RsMod;
    }

    public static boolean isStmtOrExpr(@Nonnull PsiElement element) {
    ...
    public static boolean isStmtOrMacro(@Nonnull PsiElement element) {
        return element instanceof RsStmt || (element instanceof RsMacroCall && element.getParent() instanceof RsBlock);
    }

    public static boolean isDelimitedBlock(@Nonnull ASTNode node) {
        return DELIMITED_BLOCKS.contains(node.getElementType());
    }

    public static boolean isFlatBraceBlock(@Nonnull ASTNode node) {
     ...
     */
    public static boolean isFlatBlock(@Nonnull ASTNode node) {
        return isFlatBraceBlock(node) || node.getElementType() == PAT_TUPLE_STRUCT;
    }

    public static boolean isBlockDelim(@Nonnull ASTNode node, @Nullable ASTNode parent) {
    ...
    @Nullable
    public static ASTNode treeNonWSPrev(@Nonnull ASTNode node) {
    ...
    @Nullable
    public static ASTNode treeNonWSNext(@Nonnull ASTNode node) {
    ...
    public static final class CommaList {
        ...
        public CommaList(@Nonnull IElementType list, @Nonnull IElementType closingBrace, @Nonnull Predicate<PsiElement> isElement) {
            myList = list;
        ...
        public boolean isElement(@Nonnull PsiElement element) {
        ...
        @Nullable
        public static RsFmtImplUtil.CommaList forElement(@Nonnull IElementType elementType) {
