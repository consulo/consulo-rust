...
public final class RsIndentUtil {
    ...
    @Nullable
    public static Indent computeIndent(@Nonnull RsFmtBlock block, @Nonnull ASTNode child, @Nonnull RsFmtContext childCtx) {
    ...
    @Nonnull
    private static Indent getIndentIfNotDelim(@Nonnull ASTNode child, @Nonnull ASTNode parent) {
