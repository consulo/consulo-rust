...
public final class RsAlignmentUtil {
    ...
    @Nonnull
    public static RsAlignmentStrategy getAlignmentStrategy(@Nonnull RsFmtBlock block) {
    ...
    @Nonnull
    public static RsAlignmentStrategy alignUnlessBlockDelim(@Nonnull RsAlignmentStrategy strategy) {
