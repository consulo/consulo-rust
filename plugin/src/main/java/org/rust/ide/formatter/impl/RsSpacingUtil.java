...
public final class RsSpacingUtil {
    ...
    @Nullable
    public static Spacing computeSpacing(@Nonnull Block parentBlock,
                                         @Nullable Block child1,
                                         @Nonnull Block child2,
    ...
    private static boolean hasLineBreakAfterInSameParent(@Nonnull ASTNode node) {
    ...
    private static boolean hasLineBreakBeforeInSameParent(@Nonnull ASTNode node) {
    ...
    private static final class SpacingContext {
        ...
        SpacingContext(@Nonnull ASTNode node1, @Nonnull ASTNode node2,
                       @Nonnull PsiElement psi1, @Nonnull PsiElement psi2,
                       @Nonnull IElementType elementType1, @Nonnull IElementType elementType2,
                       @Nullable IElementType parentType, @Nullable PsiElement parentPsi,
                       @Nonnull PsiElement ncPsi1, @Nonnull PsiElement ncPsi2,
                       @Nonnull RsFmtContext ctx) {
            myNode1 = node1;
            myNode2 = node2;
            myPsi1 = psi1;
        ...
        @Nullable
        static SpacingContext create(@Nonnull ASTBlock child1, @Nonnull ASTBlock child2, @Nonnull RsFmtContext ctx) {
