...
package org.rust.openapiext.ui;
...
public final class UiUtil {
    ...
    public static TextFieldWithBrowseButton pathToDirectoryTextField(
        ...
        return pathToDirectoryTextField(disposable, title, null);
    }
    ...
    public static TextFieldWithBrowseButton pathToRsFileTextField(
        ...
        return pathToRsFileTextField(disposable, title, project, null);
    }
    ...
    public static TextFieldWithBrowseButton pathTextField(
        ...
        return pathTextField(fileChooserDescriptor, disposable, title, null);
    }
    ...
    @Nonnull
    public static String trimmedText(@Nonnull JBTextField textField) {
        return textField.getText().trim();
    }

    /**
     * Alias for {@link #trimmedText(JBTextField)} following getter convention.
     */
    @Nonnull
