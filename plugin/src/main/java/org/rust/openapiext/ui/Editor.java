...
public final class Editor {
    ...
    public static void moveCaretToOffset(@Nonnull consulo.codeEditor.Editor editor,
                                         @Nonnull PsiElement context,
                                         int absoluteOffsetInFile) {
        consulo.codeEditor.Editor targetEditor;
    ...
    public static void setSelection(@Nonnull consulo.codeEditor.Editor editor,
                                    @Nonnull PsiElement context,
                                    int startOffset,
                                    int endOffset) {
        consulo.codeEditor.Editor targetEditor;
    ...
    public static void showErrorHint(@Nonnull consulo.codeEditor.Editor editor,
                                     @Nonnull  String text,
                                     short position) {
        consulo.codeEditor.Editor unwrapped = IntentionInMacroUtil.unwrapEditor(editor);
