...
public enum RsColor {
    ...
    BLOCK_COMMENT(((java.util.function.Supplier<String>) () -> consulo.configurable.OptionsBundle.message("options.language.defaults.block.comment")), DefaultLanguageHighlighterColors.BLOCK_COMMENT),
    EOL_COMMENT(((java.util.function.Supplier<String>) () -> consulo.configurable.OptionsBundle.message("options.language.defaults.line.comment")), DefaultLanguageHighlighterColors.LINE_COMMENT),
    ...
    BRACES(((java.util.function.Supplier<String>) () -> consulo.configurable.OptionsBundle.message("options.language.defaults.braces")), DefaultLanguageHighlighterColors.BRACES),
    BRACKETS(((java.util.function.Supplier<String>) () -> consulo.configurable.OptionsBundle.message("options.language.defaults.brackets")), DefaultLanguageHighlighterColors.BRACKETS),
    ...
    SEMICOLON(((java.util.function.Supplier<String>) () -> consulo.configurable.OptionsBundle.message("options.language.defaults.semicolon")), DefaultLanguageHighlighterColors.SEMICOLON),
    DOT(((java.util.function.Supplier<String>) () -> consulo.configurable.OptionsBundle.message("options.language.defaults.dot")), DefaultLanguageHighlighterColors.DOT),
    COMMA(((java.util.function.Supplier<String>) () -> consulo.configurable.OptionsBundle.message("options.language.defaults.comma")), DefaultLanguageHighlighterColors.COMMA),
    PARENTHESES(((java.util.function.Supplier<String>) () -> consulo.configurable.OptionsBundle.message("options.language.defaults.parentheses")), DefaultLanguageHighlighterColors.PARENTHESES),
    ...
    RsColor(Supplier< String> humanName, TextAttributesKey defaultKey) {
        this.myTextAttributesKey = TextAttributesKey.createTextAttributesKey("org.rust." + name(), defaultKey);
        this.myAttributesDescriptor = new AttributesDescriptor(humanName.get(), myTextAttributesKey);
        this.myTestSeverity = new HighlightSeverity(name(), HighlightSeverity.INFORMATION.myVal);
    }

    RsColor(Supplier< String> humanName) {
        this(humanName, (TextAttributesKey) null);
    }

    RsColor(Supplier< String> humanName, RsColor fallbackColor) {
